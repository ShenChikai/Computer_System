...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	pushl  (%ebx)
  37:	e8 36 03 00 00       	call   372 <open>
  ...
  57:	e8 fe 02 00 00       	call   35a <close>
  if(argc <= 1){
    cat(0);
    exit();
  }
  ...
  69:	50                   	push   %eax
  6a:	ff 33                	pushl  (%ebx)
  6c:	68 f1 07 00 00       	push   $0x7f1
  71:	6a 01                	push   $0x1
  73:	e8 48 04 00 00       	call   4c0 <printf>
      exit();
  78:	e8 b5 02 00 00       	call   332 <exit>
main(int argc, char *argv[])
{
  int fd, i;
  ...
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 a6 02 00 00       	call   332 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
cat(int fd)
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 a2 02 00 00       	call   352 <write>
...
cat(int fd)
{
  ...
  bb:	68 00 0b 00 00       	push   $0xb00
  c0:	53                   	push   %ebx
  c1:	e8 84 02 00 00       	call   34a <read>
  ...
  d8:	68 e0 07 00 00       	push   $0x7e0
  dd:	6a 01                	push   $0x1
  df:	e8 dc 03 00 00       	call   4c0 <printf>
    exit();
  e4:	e8 49 02 00 00       	call   332 <exit>
  e9:	66 90                	xchg   %ax,%ax
  eb:	66 90                	xchg   %ax,%ax
  ed:	66 90                	xchg   %ax,%ax
  ef:	90                   	nop
...
000003e2 <kthread_exit>:
SYSCALL(kthread_exit)
 3e2:	b8 18 00 00 00       	mov    $0x18,%eax
 3e7:	cd 40                	int    $0x40
 3e9:	c3                   	ret    

000003ea <kthread_join>:
SYSCALL(kthread_join)
 3ea:	b8 19 00 00 00       	mov    $0x19,%eax
 3ef:	cd 40                	int    $0x40
 3f1:	c3                   	ret    

000003f2 <kthread_mutex_alloc>:
...
00000402 <kthread_mutex_lock>:
SYSCALL(kthread_mutex_lock)
 402:	b8 1c 00 00 00       	mov    $0x1c,%eax
 407:	cd 40                	int    $0x40
 409:	c3                   	ret    

0000040a <kthread_mutex_unlock>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45f:	f7 f6                	div    %esi
 461:	0f b6 92 10 08 00 00 	movzbl 0x810(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 498:	e8 b5 fe ff ff       	call   352 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 508:	50                   	push   %eax
 509:	57                   	push   %edi
 50a:	e8 43 fe ff ff       	call   352 <write>
...
putc(int fd, char c)
{
 ...
 5d8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5db:	b8 06 08 00 00       	mov    $0x806,%eax
...
putc(int fd, char c)
{
 ...
 64f:	50                   	push   %eax
 650:	57                   	push   %edi
 651:	e8 fc fc ff ff       	call   352 <write>
...
free(void *ap)
{
 ...
 6da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6dd:	a3 e0 0a 00 00       	mov    %eax,0xae0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 e0 0a 00 00    	mov    0xae0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 74f:	76 3f                	jbe    790 <malloc+0xa0>
    ...
    if(p == freep)
 751:	39 05 e0 0a 00 00    	cmp    %eax,0xae0
 ...
 776:	e8 e5 fe ff ff       	call   660 <free>
  return freep;
 77b:	8b 15 e0 0a 00 00    	mov    0xae0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 79c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 79f:	89 15 e0 0a 00 00    	mov    %edx,0xae0
      return (void*)(p + 1);
 ...
 7b4:	eb e9                	jmp    79f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7b6:	c7 05 e0 0a 00 00 e4 	movl   $0xae4,0xae0
 7bd:	0a 00 00 
 7c0:	c7 05 e4 0a 00 00 e4 	movl   $0xae4,0xae4
 7c7:	0a 00 00 
    base.s.size = 0;
 7ca:	b8 e4 0a 00 00       	mov    $0xae4,%eax
 7cf:	c7 05 e8 0a 00 00 00 	movl   $0x0,0xae8
 7d6:	00 00 00 
