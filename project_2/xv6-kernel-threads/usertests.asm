...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    printf(1, "already ran user tests -- rebuild fs.img\n");
      ...
      35:	68 18 54 00 00       	push   $0x5418
      3a:	6a 01                	push   $0x1
      3c:	e8 6f 39 00 00       	call   39b0 <printf>
    exit();
...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
     116:	68 64 3d 00 00       	push   $0x3d64
     11b:	ff 35 18 5d 00 00    	pushl  0x5d18
     121:	e8 8a 38 00 00       	call   39b0 <printf>

  if(mkdir("iputdir") < 0){
     126:	c7 04 24 f7 3c 00 00 	movl   $0x3cf7,(%esp)
  ...
  if(chdir("iputdir") < 0){
     ...
     13c:	68 f7 3c 00 00       	push   $0x3cf7
  ...
  if(unlink("../iputdir") < 0){
     ...
     154:	68 f4 3c 00 00       	push   $0x3cf4
  ...
  if(chdir("/") < 0){
     ...
     168:	68 19 3d 00 00       	push   $0x3d19
  ...
  printf(stdout, "iput test ok\n");
     ...
     17c:	68 9c 3d 00 00       	push   $0x3d9c
     181:	ff 35 18 5d 00 00    	pushl  0x5d18
...
iputtest(void)
{
  ...
  if(mkdir("iputdir") < 0){
    printf(stdout, "mkdir failed\n");
     191:	50                   	push   %eax
     192:	50                   	push   %eax
     193:	68 d0 3c 00 00       	push   $0x3cd0
     198:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(chdir("/") < 0){
    printf(stdout, "chdir / failed\n");
     1a8:	50                   	push   %eax
     1a9:	50                   	push   %eax
     1aa:	68 1b 3d 00 00       	push   $0x3d1b
     1af:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(unlink("../iputdir") < 0){
    printf(stdout, "unlink ../iputdir failed\n");
     1bf:	52                   	push   %edx
     1c0:	52                   	push   %edx
     1c1:	68 ff 3c 00 00       	push   $0x3cff
     1c6:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(chdir("iputdir") < 0){
    printf(stdout, "chdir iputdir failed\n");
     1d6:	51                   	push   %ecx
     1d7:	51                   	push   %ecx
     1d8:	68 de 3c 00 00       	push   $0x3cde
     1dd:	ff 35 18 5d 00 00    	pushl  0x5d18
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
     1f6:	68 2b 3d 00 00       	push   $0x3d2b
     1fb:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     21b:	68 f7 3c 00 00       	push   $0x3cf7
    ...
    if(chdir("iputdir") < 0){
     ...
     233:	68 f7 3c 00 00       	push   $0x3cf7
    ...
    if(unlink("../iputdir") < 0){
     ...
     247:	68 f4 3c 00 00       	push   $0x3cf4
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     268:	68 4e 3d 00 00       	push   $0x3d4e
     26d:	ff 35 18 5d 00 00    	pushl  0x5d18
    ...
    if(unlink("../iputdir") < 0){
     ...
     283:	68 ff 3c 00 00       	push   $0x3cff
     288:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(pid < 0){
    printf(stdout, "fork failed\n");
     298:	51                   	push   %ecx
     299:	51                   	push   %ecx
     29a:	68 11 4c 00 00       	push   $0x4c11
     29f:	ff 35 18 5d 00 00    	pushl  0x5d18
    ...
    if(chdir("iputdir") < 0){
     ...
     2af:	50                   	push   %eax
     2b0:	50                   	push   %eax
     2b1:	68 3a 3d 00 00       	push   $0x3d3a
     2b6:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(pid == 0){
    if(mkdir("iputdir") < 0){
     ...
     2c6:	52                   	push   %edx
     2c7:	52                   	push   %edx
     2c8:	68 d0 3c 00 00       	push   $0x3cd0
     2cd:	ff 35 18 5d 00 00    	pushl  0x5d18
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     2e6:	68 60 3d 00 00       	push   $0x3d60
     2eb:	ff 35 18 5d 00 00    	pushl  0x5d18
     2f1:	e8 ba 36 00 00       	call   39b0 <printf>
  if(mkdir("oidir") < 0){
     2f6:	c7 04 24 6f 3d 00 00 	movl   $0x3d6f,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     31f:	6a 02                	push   $0x2
     321:	68 6f 3d 00 00       	push   $0x3d6f
    ...
    if(fd >= 0){
     ...
     335:	68 d0 4c 00 00       	push   $0x4cd0
     33a:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(unlink("oidir") != 0){
     35a:	c7 04 24 6f 3d 00 00 	movl   $0x3d6f,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     375:	68 98 3d 00 00       	push   $0x3d98
     37a:	ff 35 18 5d 00 00    	pushl  0x5d18
     ...
     390:	e8 8d 34 00 00       	call   3822 <exit>
{
  ...
  if(mkdir("oidir") < 0){
    printf(stdout, "mkdir oidir failed\n");
     395:	51                   	push   %ecx
     396:	51                   	push   %ecx
     397:	68 75 3d 00 00       	push   $0x3d75
     39c:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(pid < 0){
    printf(stdout, "fork failed\n");
     3ac:	52                   	push   %edx
     3ad:	52                   	push   %edx
     3ae:	68 11 4c 00 00       	push   $0x4c11
     3b3:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(unlink("oidir") != 0){
    printf(stdout, "unlink failed\n");
     3c3:	50                   	push   %eax
     3c4:	50                   	push   %eax
     3c5:	68 89 3d 00 00       	push   $0x3d89
     3ca:	ff 35 18 5d 00 00    	pushl  0x5d18
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     3e6:	68 aa 3d 00 00       	push   $0x3daa
     3eb:	ff 35 18 5d 00 00    	pushl  0x5d18
     3f1:	e8 ba 35 00 00       	call   39b0 <printf>
  fd = open("echo", 0);
     3f6:	58                   	pop    %eax
     3f7:	5a                   	pop    %edx
     3f8:	6a 00                	push   $0x0
     3fa:	68 b5 3d 00 00       	push   $0x3db5
  ...
  fd = open("doesnotexist", 0);
     ...
     415:	59                   	pop    %ecx
     416:	6a 00                	push   $0x0
     418:	68 cd 3d 00 00       	push   $0x3dcd
  ...
  printf(stdout, "open test ok\n");
     ...
     42c:	68 f8 3d 00 00       	push   $0x3df8
     431:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(fd < 0){
    printf(stdout, "open echo failed!\n");
     441:	50                   	push   %eax
     442:	50                   	push   %eax
     443:	68 ba 3d 00 00       	push   $0x3dba
     448:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(fd >= 0){
    printf(stdout, "open doesnotexist succeeded!\n");
     458:	50                   	push   %eax
     459:	50                   	push   %eax
     45a:	68 da 3d 00 00       	push   $0x3dda
     45f:	ff 35 18 5d 00 00    	pushl  0x5d18
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     478:	68 06 3e 00 00       	push   $0x3e06
     47d:	ff 35 18 5d 00 00    	pushl  0x5d18
     483:	e8 28 35 00 00       	call   39b0 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     488:	59                   	pop    %ecx
     489:	5b                   	pop    %ebx
     48a:	68 02 02 00 00       	push   $0x202
     48f:	68 17 3e 00 00       	push   $0x3e17
  ...
  if(fd >= 0){
    printf(stdout, "creat small succeeded; ok\n");
     4ab:	68 1d 3e 00 00       	push   $0x3e1d
     4b0:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4c3:	6a 0a                	push   $0xa
     4c5:	68 54 3e 00 00       	push   $0x3e54
     4ca:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     4df:	6a 0a                	push   $0xa
     4e1:	68 5f 3e 00 00       	push   $0x3e5f
     4e6:	56                   	push   %esi
  ...
  printf(stdout, "writes ok\n");
     ...
     503:	68 6a 3e 00 00       	push   $0x3e6a
     508:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  fd = open("small", O_RDONLY);
     ...
     51c:	5a                   	pop    %edx
     51d:	6a 00                	push   $0x0
     51f:	68 17 3e 00 00       	push   $0x3e17
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     539:	68 75 3e 00 00       	push   $0x3e75
     53e:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  i = read(fd, buf, 2000);
     ...
     551:	68 00 85 00 00       	push   $0x8500
     556:	53                   	push   %ebx
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     56d:	68 a9 3e 00 00       	push   $0x3ea9
     572:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(unlink("small") < 0){
     585:	c7 04 24 17 3e 00 00 	movl   $0x3e17,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     59b:	68 d1 3e 00 00       	push   $0x3ed1
     5a0:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     5b8:	53                   	push   %ebx
     5b9:	68 f4 4c 00 00       	push   $0x4cf4
     5be:	ff 35 18 5d 00 00    	pushl  0x5d18
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     5d1:	53                   	push   %ebx
     5d2:	68 18 4d 00 00       	push   $0x4d18
     5d7:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     5ea:	68 8e 3e 00 00       	push   $0x3e8e
     5ef:	ff 35 18 5d 00 00    	pushl  0x5d18
     5f5:	e8 b6 33 00 00       	call   39b0 <printf>
    exit();
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     ...
     602:	68 d5 41 00 00       	push   $0x41d5
     607:	ff 35 18 5d 00 00    	pushl  0x5d18
     60d:	e8 9e 33 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     ...
     61a:	68 bc 3e 00 00       	push   $0x3ebc
     61f:	ff 35 18 5d 00 00    	pushl  0x5d18
     625:	e8 86 33 00 00       	call   39b0 <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     632:	68 38 3e 00 00       	push   $0x3e38
     637:	ff 35 18 5d 00 00    	pushl  0x5d18
     63d:	e8 6e 33 00 00       	call   39b0 <printf>
    exit();
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     658:	68 e5 3e 00 00       	push   $0x3ee5
     65d:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     66f:	68 5f 3f 00 00       	push   $0x3f5f
  ...
  for(i = 0; i < MAXFILE; i++){
    ((int*)buf)[0] = i;
     693:	89 1d 00 85 00 00    	mov    %ebx,0x8500
    if(write(fd, buf, 512) != 512){
     699:	68 00 02 00 00       	push   $0x200
     69e:	68 00 85 00 00       	push   $0x8500
     6a3:	56                   	push   %esi
  ...
  fd = open("big", O_RDONLY);
     ...
     6cc:	5a                   	pop    %edx
     6cd:	6a 00                	push   $0x0
     6cf:	68 5f 3f 00 00       	push   $0x3f5f
  ...
  if(fd < 0){
    ...
    if(((int*)buf)[0] != n){
     6fb:	a1 00 85 00 00       	mov    0x8500,%eax
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     70f:	68 00 85 00 00       	push   $0x8500
     714:	56                   	push   %esi
  ...
  if(unlink("big") < 0){
     736:	c7 04 24 5f 3f 00 00 	movl   $0x3f5f,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     750:	68 86 3f 00 00       	push   $0x3f86
     755:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     76d:	53                   	push   %ebx
     76e:	68 0f 3f 00 00       	push   $0x3f0f
     773:	ff 35 18 5d 00 00    	pushl  0x5d18
    ...
    if(((int*)buf)[0] != n){
     ...
     783:	50                   	push   %eax
     784:	53                   	push   %ebx
     785:	68 3c 4d 00 00       	push   $0x4d3c
     78a:	ff 35 18 5d 00 00    	pushl  0x5d18
     ...
     79d:	50                   	push   %eax
     79e:	68 63 3f 00 00       	push   $0x3f63
     7a3:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     7bb:	68 46 3f 00 00       	push   $0x3f46
     7c0:	ff 35 18 5d 00 00    	pushl  0x5d18
     7c6:	e8 e5 31 00 00       	call   39b0 <printf>
        exit();
  ...
  if(fd < 0){
    printf(stdout, "error: open big failed!\n");
     ...
     7d3:	68 2d 3f 00 00       	push   $0x3f2d
     7d8:	ff 35 18 5d 00 00    	pushl  0x5d18
     7de:	e8 cd 31 00 00       	call   39b0 <printf>
    exit();
  ...
  if(fd < 0){
    printf(stdout, "error: creat big failed!\n");
     ...
     7eb:	68 f5 3e 00 00       	push   $0x3ef5
     7f0:	ff 35 18 5d 00 00    	pushl  0x5d18
     7f6:	e8 b5 31 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     ...
     803:	68 73 3f 00 00       	push   $0x3f73
     808:	ff 35 18 5d 00 00    	pushl  0x5d18
     80e:	e8 9d 31 00 00       	call   39b0 <printf>
    exit();
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     82c:	68 5c 4d 00 00       	push   $0x4d5c
     831:	ff 35 18 5d 00 00    	pushl  0x5d18
     837:	e8 74 31 00 00       	call   39b0 <printf>

  name[0] = 'a';
     83c:	c6 05 00 a5 00 00 61 	movb   $0x61,0xa500
  name[2] = '\0';
     843:	c6 05 02 a5 00 00 00 	movb   $0x0,0xa502
  ...
  for(i = 0; i < 52; i++){
    name[1] = '0' + i;
     853:	88 1d 01 a5 00 00    	mov    %bl,0xa501
     859:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     85c:	68 02 02 00 00       	push   $0x202
     861:	68 00 a5 00 00       	push   $0xa500
  ...
  name[0] = 'a';
     87b:	c6 05 00 a5 00 00 61 	movb   $0x61,0xa500
  name[2] = '\0';
     882:	c6 05 02 a5 00 00 00 	movb   $0x0,0xa502
  ...
  for(i = 0; i < 52; i++){
    name[1] = '0' + i;
     893:	88 1d 01 a5 00 00    	mov    %bl,0xa501
     899:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     89c:	68 00 a5 00 00       	push   $0xa500
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8b1:	68 84 4d 00 00       	push   $0x4d84
     8b6:	ff 35 18 5d 00 00    	pushl  0x5d18
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     8d6:	68 94 3f 00 00       	push   $0x3f94
     8db:	ff 35 18 5d 00 00    	pushl  0x5d18
     8e1:	e8 ca 30 00 00       	call   39b0 <printf>

  if(mkdir("dir0") < 0){
     8e6:	c7 04 24 a0 3f 00 00 	movl   $0x3fa0,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     8fc:	68 a0 3f 00 00       	push   $0x3fa0
  ...
  if(chdir("..") < 0){
     ...
     914:	68 45 45 00 00       	push   $0x4545
  ...
  if(unlink("dir0") < 0){
     ...
     928:	68 a0 3f 00 00       	push   $0x3fa0
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     93c:	68 dd 3f 00 00       	push   $0x3fdd
     941:	ff 35 18 5d 00 00    	pushl  0x5d18
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
    printf(stdout, "mkdir failed\n");
     951:	50                   	push   %eax
     952:	50                   	push   %eax
     953:	68 d0 3c 00 00       	push   $0x3cd0
     958:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(unlink("dir0") < 0){
    printf(stdout, "unlink dir0 failed\n");
     968:	50                   	push   %eax
     969:	50                   	push   %eax
     96a:	68 c9 3f 00 00       	push   $0x3fc9
     96f:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(chdir("..") < 0){
    printf(stdout, "chdir .. failed\n");
     97f:	52                   	push   %edx
     980:	52                   	push   %edx
     981:	68 b8 3f 00 00       	push   $0x3fb8
     986:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  if(chdir("dir0") < 0){
    printf(stdout, "chdir dir0 failed\n");
     996:	51                   	push   %ecx
     997:	51                   	push   %ecx
     998:	68 a5 3f 00 00       	push   $0x3fa5
     99d:	ff 35 18 5d 00 00    	pushl  0x5d18
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     9b6:	68 ec 3f 00 00       	push   $0x3fec
     9bb:	ff 35 18 5d 00 00    	pushl  0x5d18
     9c1:	e8 ea 2f 00 00       	call   39b0 <printf>
  if(exec("echo", echoargv) < 0){
     9c6:	5a                   	pop    %edx
     9c7:	59                   	pop    %ecx
     9c8:	68 1c 5d 00 00       	push   $0x5d1c
     9cd:	68 b5 3d 00 00       	push   $0x3db5
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
    printf(stdout, "exec echo failed\n");
     9e0:	50                   	push   %eax
     9e1:	50                   	push   %eax
     9e2:	68 f7 3f 00 00       	push   $0x3ff7
     9e7:	ff 35 18 5d 00 00    	pushl  0x5d18
...
pipe1(void)
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a50:	57                   	push   %edi
     a51:	68 00 85 00 00       	push   $0x8500
     ...
     a6e:	f7 d9                	neg    %ecx
     a70:	38 9c 0b 00 85 00 00 	cmp    %bl,0x8500(%ebx,%ecx,1)
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a9a:	68 26 40 00 00       	push   $0x4026
     a9f:	6a 01                	push   $0x1
...
pipe1(void)
{
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     ad0:	88 9c 18 00 85 00 00 	mov    %bl,0x8500(%eax,%ebx,1)
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     ae8:	68 00 85 00 00       	push   $0x8500
  ...
  printf(1, "pipe1 ok\n");
     b25:	58                   	pop    %eax
     b26:	5a                   	pop    %edx
     b27:	68 4b 40 00 00       	push   $0x404b
     b2c:	6a 01                	push   $0x1
     b2e:	e8 7d 2e 00 00       	call   39b0 <printf>
    ...
    if(total != 5 * 1033){
     ...
     b41:	68 34 40 00 00       	push   $0x4034
     b46:	6a 01                	push   $0x1
     b48:	e8 63 2e 00 00       	call   39b0 <printf>
      exit();
     b4d:	e8 d0 2c 00 00       	call   3822 <exit>
{
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
     ...
     b55:	68 09 40 00 00       	push   $0x4009
     b5a:	6a 01                	push   $0x1
     b5c:	e8 4f 2e 00 00       	call   39b0 <printf>
    exit();
    ...
    printf(1, "fork() failed\n");
     ...
     b69:	68 55 40 00 00       	push   $0x4055
     b6e:	6a 01                	push   $0x1
     b70:	e8 3b 2e 00 00       	call   39b0 <printf>
    exit();
    ...
    for(n = 0; n < 5; n++){
     ...
     b7d:	68 18 40 00 00       	push   $0x4018
     b82:	6a 01                	push   $0x1
     b84:	e8 27 2e 00 00       	call   39b0 <printf>
        exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b99:	68 64 40 00 00       	push   $0x4064
     b9e:	6a 01                	push   $0x1
     ba0:	e8 0b 2e 00 00       	call   39b0 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bea:	6a 01                	push   $0x1
     bec:	68 29 46 00 00       	push   $0x4629
     ...
     c04:	68 6e 40 00 00       	push   $0x406e
     c09:	6a 01                	push   $0x1
     c0b:	e8 a0 2d 00 00       	call   39b0 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c36:	68 00 85 00 00       	push   $0x8500
    ...
    printf(1, "preempt read error");
     ...
     c4e:	68 82 40 00 00       	push   $0x4082
     c53:	6a 01                	push   $0x1
     c55:	e8 56 2d 00 00       	call   39b0 <printf>
    return;
  ...
  printf(1, "kill... ");
     c70:	58                   	pop    %eax
     c71:	5a                   	pop    %edx
     c72:	68 95 40 00 00       	push   $0x4095
     c77:	6a 01                	push   $0x1
     c79:	e8 32 2d 00 00       	call   39b0 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c96:	59                   	pop    %ecx
     c97:	5b                   	pop    %ebx
     c98:	68 9e 40 00 00       	push   $0x409e
     c9d:	6a 01                	push   $0x1
     c9f:	e8 0c 2d 00 00       	call   39b0 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     cb3:	5e                   	pop    %esi
     cb4:	5f                   	pop    %edi
     cb5:	68 a7 40 00 00       	push   $0x40a7
     cba:	6a 01                	push   $0x1
     cbc:	e8 ef 2c 00 00       	call   39b0 <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cfe:	68 11 4c 00 00       	push   $0x4c11
     d03:	6a 01                	push   $0x1
     d05:	e8 a6 2c 00 00       	call   39b0 <printf>
      return;
  ...
  printf(1, "exitwait ok\n");
    ...
    if(pid){
     ...
     d1b:	68 b3 40 00 00       	push   $0x40b3
     d20:	6a 01                	push   $0x1
     d22:	e8 89 2c 00 00       	call   39b0 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     d3b:	68 c3 40 00 00       	push   $0x40c3
     d40:	6a 01                	push   $0x1
     d42:	e8 69 2c 00 00       	call   39b0 <printf>
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d69:	68 d0 40 00 00       	push   $0x40d0
     d6e:	6a 01                	push   $0x1
     d70:	e8 3b 2c 00 00       	call   39b0 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d9c:	e8 3f 2e 00 00       	call   3be0 <malloc>
    ...
    while(m1){
     ...
     db8:	e8 93 2d 00 00       	call   3b50 <free>
    m1 = 0;
    while((m2 = malloc(10001)) != 0){
      *(char**)m2 = m1;
      m1 = m2;
    ...
    m1 = malloc(1024*20);
     ...
     dcc:	e8 0f 2e 00 00       	call   3be0 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     ddb:	50                   	push   %eax
     ddc:	e8 6f 2d 00 00       	call   3b50 <free>
    printf(1, "mem ok\n");
     de1:	58                   	pop    %eax
     de2:	5a                   	pop    %edx
     de3:	68 f4 40 00 00       	push   $0x40f4
     de8:	6a 01                	push   $0x1
     dea:	e8 c1 2b 00 00       	call   39b0 <printf>
    exit();
    ...
    if(m1 == 0){
     ...
     e0b:	68 da 40 00 00       	push   $0x40da
     e10:	6a 01                	push   $0x1
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e39:	68 fc 40 00 00       	push   $0x40fc
     e3e:	6a 01                	push   $0x1
     e40:	e8 6b 2b 00 00       	call   39b0 <printf>

  unlink("sharedfd");
     e45:	c7 04 24 0b 41 00 00 	movl   $0x410b,(%esp)
     e4c:	e8 21 2a 00 00       	call   3872 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e51:	5b                   	pop    %ebx
     e52:	5e                   	pop    %esi
     e53:	68 02 02 00 00       	push   $0x202
     e58:	68 0b 41 00 00       	push   $0x410b
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ebc:	68 d8 4d 00 00       	push   $0x4dd8
     ec1:	6a 01                	push   $0x1
     ec3:	e8 e8 2a 00 00       	call   39b0 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     eea:	5a                   	pop    %edx
     eeb:	6a 00                	push   $0x0
     eed:	68 0b 41 00 00       	push   $0x410b
  ...
  unlink("sharedfd");
     f5a:	c7 04 24 0b 41 00 00 	movl   $0x410b,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     f7f:	68 14 41 00 00       	push   $0x4114
     f84:	6a 01                	push   $0x1
     f86:	e8 25 2a 00 00       	call   39b0 <printf>
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     f99:	68 ac 4d 00 00       	push   $0x4dac
     f9e:	6a 01                	push   $0x1
     fa0:	e8 0b 2a 00 00       	call   39b0 <printf>
    return;
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fb3:	68 f8 4d 00 00       	push   $0x4df8
     fb8:	6a 01                	push   $0x1
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     fcf:	53                   	push   %ebx
     fd0:	52                   	push   %edx
     fd1:	68 21 41 00 00       	push   $0x4121
     fd6:	6a 01                	push   $0x1
     fd8:	e8 d3 29 00 00       	call   39b0 <printf>
    exit();
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
     ff6:	be 36 41 00 00       	mov    $0x4136,%esi
...
fourfiles(void)
{
  ...
  int fd, pid, i, j, n, total, pi;
  char *names[] = { "f0", "f1", "f2", "f3" };
    1000:	c7 45 d8 36 41 00 00 	movl   $0x4136,-0x28(%ebp)
    1007:	c7 45 dc 7f 42 00 00 	movl   $0x427f,-0x24(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    100e:	68 3c 41 00 00       	push   $0x413c
    1013:	6a 01                	push   $0x1
// time, to test block allocation.
void
fourfiles(void)
{
  int fd, pid, i, j, n, total, pi;
  char *names[] = { "f0", "f1", "f2", "f3" };
    1015:	c7 45 e0 83 42 00 00 	movl   $0x4283,-0x20(%ebp)
    101c:	c7 45 e4 39 41 00 00 	movl   $0x4139,-0x1c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    1023:	e8 88 29 00 00       	call   39b0 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1071:	c7 45 d4 36 41 00 00 	movl   $0x4136,-0x2c(%ebp)
  }
  ...
  for(i = 0; i < 2; i++){
    ...
    1098:	68 00 85 00 00       	push   $0x8500
    109d:	56                   	push   %esi
    ...
    10ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      for(j = 0; j < n; j++){
        if(buf[j] != '0'+i){
    10b0:	0f be 8a 00 85 00 00 	movsbl 0x8500(%edx),%ecx
  ...
  printf(1, "fourfiles ok\n");
    ...
    10f7:	68 7a 41 00 00       	push   $0x417a
    10fc:	6a 01                	push   $0x1
    10fe:	e8 ad 28 00 00       	call   39b0 <printf>
}
    ...
    111c:	68 5d 41 00 00       	push   $0x415d
    1121:	6a 01                	push   $0x1
    1123:	e8 88 28 00 00       	call   39b0 <printf>
          exit();
    ...
    1155:	68 00 85 00 00       	push   $0x8500
    ...
    116a:	68 00 85 00 00       	push   $0x8500
    116f:	56                   	push   %esi
    ...
    118c:	50                   	push   %eax
    118d:	68 4c 41 00 00       	push   $0x414c
    1192:	6a 01                	push   $0x1
    1194:	e8 17 28 00 00       	call   39b0 <printf>
          exit();
    ...
    11a1:	68 d7 43 00 00       	push   $0x43d7
    11a6:	6a 01                	push   $0x1
    11a8:	e8 03 28 00 00       	call   39b0 <printf>
        exit();
    ...
    11b5:	53                   	push   %ebx
    11b6:	68 69 41 00 00       	push   $0x4169
    11bb:	6a 01                	push   $0x1
    11bd:	e8 ee 27 00 00       	call   39b0 <printf>
      exit();
    ...
    11ca:	68 11 4c 00 00       	push   $0x4c11
    11cf:	6a 01                	push   $0x1
    11d1:	e8 da 27 00 00       	call   39b0 <printf>
      exit();
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    11eb:	68 88 41 00 00       	push   $0x4188
    11f0:	6a 01                	push   $0x1
    11f2:	e8 b9 27 00 00       	call   39b0 <printf>
  ...
  printf(1, "createdelete ok\n");
    ...
    12ec:	68 9b 41 00 00       	push   $0x419b
    12f1:	6a 01                	push   $0x1
    12f3:	e8 b8 26 00 00       	call   39b0 <printf>
}
    ...
    1378:	68 89 3d 00 00       	push   $0x3d89
    137d:	6a 01                	push   $0x1
    137f:	e8 2c 26 00 00       	call   39b0 <printf>
            exit();
    ...
    1398:	57                   	push   %edi
    1399:	68 24 4e 00 00       	push   $0x4e24
    139e:	6a 01                	push   $0x1
    13a0:	e8 0b 26 00 00       	call   39b0 <printf>
        exit();
    ...
    13ad:	68 d7 43 00 00       	push   $0x43d7
    13b2:	6a 01                	push   $0x1
    13b4:	e8 f7 25 00 00       	call   39b0 <printf>
          exit();
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    13c1:	68 11 4c 00 00       	push   $0x4c11
    13c6:	6a 01                	push   $0x1
    ...
    13dd:	57                   	push   %edi
    13de:	68 48 4e 00 00       	push   $0x4e48
    13e3:	6a 01                	push   $0x1
    13e5:	e8 c6 25 00 00       	call   39b0 <printf>
        exit();
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    13f8:	68 ac 41 00 00       	push   $0x41ac
    13fd:	6a 01                	push   $0x1
    13ff:	e8 ac 25 00 00       	call   39b0 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1404:	5b                   	pop    %ebx
    1405:	5e                   	pop    %esi
    1406:	68 02 02 00 00       	push   $0x202
    140b:	68 bd 41 00 00       	push   $0x41bd
  ...
  write(fd, "hello", 5);
    ...
    1425:	6a 05                	push   $0x5
    1427:	68 e2 41 00 00       	push   $0x41e2
    142c:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    143b:	5a                   	pop    %edx
    143c:	6a 02                	push   $0x2
    143e:	68 bd 41 00 00       	push   $0x41bd
  ...
  if(unlink("unlinkread") != 0){
    ...
    1458:	68 bd 41 00 00       	push   $0x41bd
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1475:	68 bd 41 00 00       	push   $0x41bd
  ...
  write(fd1, "yyy", 3);
    1484:	6a 03                	push   $0x3
    1486:	68 1a 42 00 00       	push   $0x421a
    148b:	50                   	push   %eax
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14a1:	68 00 85 00 00       	push   $0x8500
    14a6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    14b8:	80 3d 00 85 00 00 68 	cmpb   $0x68,0x8500
  ...
  if(write(fd, buf, 10) != 10){
    ...
    14c4:	6a 0a                	push   $0xa
    14c6:	68 00 85 00 00       	push   $0x8500
    14cb:	53                   	push   %ebx
  ...
  unlink("unlinkread");
    14e2:	c7 04 24 bd 41 00 00 	movl   $0x41bd,(%esp)
    14e9:	e8 84 23 00 00       	call   3872 <unlink>
  printf(1, "unlinkread ok\n");
    14ee:	58                   	pop    %eax
    14ef:	5a                   	pop    %edx
    14f0:	68 65 42 00 00       	push   $0x4265
    14f5:	6a 01                	push   $0x1
    14f7:	e8 b4 24 00 00       	call   39b0 <printf>
}
  ...
  if(fd < 0){
    ...
    1506:	51                   	push   %ecx
    1507:	51                   	push   %ecx
    1508:	68 c8 41 00 00       	push   $0x41c8
    150d:	6a 01                	push   $0x1
    150f:	e8 9c 24 00 00       	call   39b0 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1519:	51                   	push   %ecx
    151a:	51                   	push   %ecx
    151b:	68 4c 42 00 00       	push   $0x424c
    1520:	6a 01                	push   $0x1
    1522:	e8 89 24 00 00       	call   39b0 <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    152c:	53                   	push   %ebx
    152d:	53                   	push   %ebx
    152e:	68 35 42 00 00       	push   $0x4235
    1533:	6a 01                	push   $0x1
    1535:	e8 76 24 00 00       	call   39b0 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    153f:	56                   	push   %esi
    1540:	56                   	push   %esi
    1541:	68 1e 42 00 00       	push   $0x421e
    1546:	6a 01                	push   $0x1
    1548:	e8 63 24 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("unlinkread") != 0){
    ...
    1552:	50                   	push   %eax
    1553:	50                   	push   %eax
    1554:	68 00 42 00 00       	push   $0x4200
    1559:	6a 01                	push   $0x1
    155b:	e8 50 24 00 00       	call   39b0 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    1565:	50                   	push   %eax
    1566:	50                   	push   %eax
    1567:	68 e8 41 00 00       	push   $0x41e8
    156c:	6a 01                	push   $0x1
    156e:	e8 3d 24 00 00       	call   39b0 <printf>
    exit();
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1587:	68 74 42 00 00       	push   $0x4274
    158c:	6a 01                	push   $0x1
    158e:	e8 1d 24 00 00       	call   39b0 <printf>

  unlink("lf1");
    1593:	c7 04 24 7e 42 00 00 	movl   $0x427e,(%esp)
    159a:	e8 d3 22 00 00       	call   3872 <unlink>
  unlink("lf2");
    159f:	c7 04 24 82 42 00 00 	movl   $0x4282,(%esp)
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    15b2:	68 7e 42 00 00       	push   $0x427e
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    15cc:	6a 05                	push   $0x5
    15ce:	68 e2 41 00 00       	push   $0x41e2
    15d3:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    15ee:	5b                   	pop    %ebx
    15ef:	58                   	pop    %eax
    15f0:	68 82 42 00 00       	push   $0x4282
    15f5:	68 7e 42 00 00       	push   $0x427e
  ...
  unlink("lf1");
    ...
    160d:	68 7e 42 00 00       	push   $0x427e
  ...
  if(open("lf1", 0) >= 0){
    ...
    1618:	5a                   	pop    %edx
    1619:	6a 00                	push   $0x0
    161b:	68 7e 42 00 00       	push   $0x427e
  ...
  fd = open("lf2", 0);
    ...
    1633:	6a 00                	push   $0x0
    1635:	68 82 42 00 00       	push   $0x4282
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1654:	68 00 85 00 00       	push   $0x8500
    1659:	50                   	push   %eax
  ...
  if(link("lf2", "lf2") >= 0){
    1674:	58                   	pop    %eax
    1675:	5a                   	pop    %edx
    1676:	68 82 42 00 00       	push   $0x4282
    167b:	68 82 42 00 00       	push   $0x4282
  ...
  unlink("lf2");
    ...
    1693:	68 82 42 00 00       	push   $0x4282
    1698:	e8 d5 21 00 00       	call   3872 <unlink>
  if(link("lf2", "lf1") >= 0){
    169d:	59                   	pop    %ecx
    169e:	5b                   	pop    %ebx
    169f:	68 7e 42 00 00       	push   $0x427e
    16a4:	68 82 42 00 00       	push   $0x4282
  ...
  if(link(".", "lf1") >= 0){
    ...
    16b8:	68 7e 42 00 00       	push   $0x427e
    16bd:	68 46 45 00 00       	push   $0x4546
  ...
  printf(1, "linktest ok\n");
    ...
    16d1:	68 1c 43 00 00       	push   $0x431c
    16d6:	6a 01                	push   $0x1
    16d8:	e8 d3 22 00 00       	call   39b0 <printf>
}
  ...
  if(fd < 0){
    ...
    16e5:	50                   	push   %eax
    16e6:	50                   	push   %eax
    16e7:	68 86 42 00 00       	push   $0x4286
    16ec:	6a 01                	push   $0x1
    16ee:	e8 bd 22 00 00       	call   39b0 <printf>
    exit();
  ...
  if(link(".", "lf1") >= 0){
    ...
    16f8:	50                   	push   %eax
    16f9:	50                   	push   %eax
    16fa:	68 00 43 00 00       	push   $0x4300
    16ff:	6a 01                	push   $0x1
    1701:	e8 aa 22 00 00       	call   39b0 <printf>
    exit();
  ...
  if(link("lf2", "lf1") >= 0){
    ...
    170b:	52                   	push   %edx
    170c:	52                   	push   %edx
    170d:	68 90 4e 00 00       	push   $0x4e90
    1712:	6a 01                	push   $0x1
    1714:	e8 97 22 00 00       	call   39b0 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    171e:	50                   	push   %eax
    171f:	50                   	push   %eax
    1720:	68 e2 42 00 00       	push   $0x42e2
    1725:	6a 01                	push   $0x1
    1727:	e8 84 22 00 00       	call   39b0 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1731:	51                   	push   %ecx
    1732:	51                   	push   %ecx
    1733:	68 d1 42 00 00       	push   $0x42d1
    1738:	6a 01                	push   $0x1
    173a:	e8 71 22 00 00       	call   39b0 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    1744:	53                   	push   %ebx
    1745:	53                   	push   %ebx
    1746:	68 c0 42 00 00       	push   $0x42c0
    174b:	6a 01                	push   $0x1
    174d:	e8 5e 22 00 00       	call   39b0 <printf>
    exit();
  ...
  if(open("lf1", 0) >= 0){
    ...
    1757:	50                   	push   %eax
    1758:	50                   	push   %eax
    1759:	68 68 4e 00 00       	push   $0x4e68
    175e:	6a 01                	push   $0x1
    1760:	e8 4b 22 00 00       	call   39b0 <printf>
    exit();
  ...
  if(link("lf1", "lf2") < 0){
    ...
    176a:	51                   	push   %ecx
    176b:	51                   	push   %ecx
    176c:	68 ab 42 00 00       	push   $0x42ab
    1771:	6a 01                	push   $0x1
    1773:	e8 38 22 00 00       	call   39b0 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    177d:	50                   	push   %eax
    177e:	50                   	push   %eax
    177f:	68 99 42 00 00       	push   $0x4299
    1784:	6a 01                	push   $0x1
    1786:	e8 25 22 00 00       	call   39b0 <printf>
    exit();
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    17a3:	68 29 43 00 00       	push   $0x4329
    17a8:	6a 01                	push   $0x1
    17aa:	e8 01 22 00 00       	call   39b0 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1860:	53                   	push   %ebx
    1861:	68 3c 43 00 00       	push   $0x433c
    1866:	6a 01                	push   $0x1
    1868:	e8 43 21 00 00       	call   39b0 <printf>
        exit();
    ...
    187b:	53                   	push   %ebx
    187c:	68 39 43 00 00       	push   $0x4339
  ...
  for(i = 0; i < 40; i++){
    ...
    if(pid && (i % 3) == 1){
      link("C0", file);
    1896:	53                   	push   %ebx
    1897:	68 39 43 00 00       	push   $0x4339
  ...
  fd = open(".", 0);
    ...
    18cc:	5e                   	pop    %esi
    18cd:	6a 00                	push   $0x0
    18cf:	68 46 45 00 00       	push   $0x4546
  ...
  printf(1, "concreate ok\n");
    ...
    1a23:	68 8e 43 00 00       	push   $0x438e
    1a28:	6a 01                	push   $0x1
    1a2a:	e8 81 1f 00 00       	call   39b0 <printf>
}
  ...
  for(i = 0; i < 40; i++){
    ...
    1a3a:	68 11 4c 00 00       	push   $0x4c11
    1a3f:	6a 01                	push   $0x1
    1a41:	e8 6a 1f 00 00       	call   39b0 <printf>
      exit();
  ...
  if(n != 40){
    ...
    1a4e:	68 b4 4e 00 00       	push   $0x4eb4
    1a53:	6a 01                	push   $0x1
    1a55:	e8 56 1f 00 00       	call   39b0 <printf>
    exit();
    ...
    1a65:	50                   	push   %eax
    1a66:	68 71 43 00 00       	push   $0x4371
    1a6b:	6a 01                	push   $0x1
    1a6d:	e8 3e 1f 00 00       	call   39b0 <printf>
        exit();
    ...
    1a7d:	50                   	push   %eax
    1a7e:	68 58 43 00 00       	push   $0x4358
    1a83:	6a 01                	push   $0x1
    1a85:	e8 26 1f 00 00       	call   39b0 <printf>
        exit();
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1aa9:	68 9c 43 00 00       	push   $0x439c
    1aae:	6a 01                	push   $0x1
    1ab0:	e8 fb 1e 00 00       	call   39b0 <printf>

  unlink("x");
    1ab5:	c7 04 24 29 46 00 00 	movl   $0x4629,(%esp)
  ...
  for(i = 0; i < 100; i++){
    ...
    1af8:	68 29 46 00 00       	push   $0x4629
  ...
  for(i = 0; i < 100; i++){
    ...
    1b2d:	68 29 46 00 00       	push   $0x4629
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b56:	68 b1 43 00 00       	push   $0x43b1
    1b5b:	6a 01                	push   $0x1
    1b5d:	e8 4e 1e 00 00       	call   39b0 <printf>
}
  ...
  for(i = 0; i < 100; i++){
    ...
    1b73:	68 29 46 00 00       	push   $0x4629
    1b78:	68 ad 43 00 00       	push   $0x43ad
  ...
  if(pid < 0){
    ...
    1b8d:	68 11 4c 00 00       	push   $0x4c11
    1b92:	6a 01                	push   $0x1
    1b94:	e8 17 1e 00 00       	call   39b0 <printf>
    exit();
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1bb8:	68 c0 43 00 00       	push   $0x43c0
    1bbd:	6a 01                	push   $0x1
    1bbf:	e8 ec 1d 00 00       	call   39b0 <printf>
  unlink("bd");
    1bc4:	c7 04 24 cd 43 00 00 	movl   $0x43cd,(%esp)
  ...
  fd = open("bd", O_CREATE);
    ...
    1bd7:	68 cd 43 00 00       	push   $0x43cd
  ...
  for(i = 0; i < 500; i++){
    ...
    if(link("bd", name) != 0){
    1c0c:	56                   	push   %esi
    1c0d:	68 cd 43 00 00       	push   $0x43cd
  }
  close(fd);
  ...
  unlink("bd");
    1c43:	68 cd 43 00 00       	push   $0x43cd
  ...
  printf(1, "bigdir ok\n");
    ...
    1c8c:	68 0f 44 00 00       	push   $0x440f
    1c91:	6a 01                	push   $0x1
    1c93:	e8 18 1d 00 00       	call   39b0 <printf>
}
    ...
    1ca5:	68 e6 43 00 00       	push   $0x43e6
    1caa:	6a 01                	push   $0x1
    1cac:	e8 ff 1c 00 00       	call   39b0 <printf>
      exit();
    ...
    1cb9:	68 fa 43 00 00       	push   $0x43fa
    1cbe:	6a 01                	push   $0x1
    1cc0:	e8 eb 1c 00 00       	call   39b0 <printf>
      exit();
  ...
  if(fd < 0){
    ...
    1ccd:	68 d0 43 00 00       	push   $0x43d0
    1cd2:	6a 01                	push   $0x1
    1cd4:	e8 d7 1c 00 00       	call   39b0 <printf>
    exit();
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1ce7:	68 1a 44 00 00       	push   $0x441a
    1cec:	6a 01                	push   $0x1
    1cee:	e8 bd 1c 00 00       	call   39b0 <printf>

  unlink("ff");
    1cf3:	c7 04 24 a3 44 00 00 	movl   $0x44a3,(%esp)
    1cfa:	e8 73 1b 00 00       	call   3872 <unlink>
  if(mkdir("dd") != 0){
    1cff:	c7 04 24 40 45 00 00 	movl   $0x4540,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d1e:	68 79 44 00 00       	push   $0x4479
  ...
  write(fd, "ff", 2);
    ...
    1d38:	6a 02                	push   $0x2
    1d3a:	68 a3 44 00 00       	push   $0x44a3
    1d3f:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1d4d:	c7 04 24 40 45 00 00 	movl   $0x4540,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d67:	68 54 44 00 00       	push   $0x4454
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1d84:	68 76 44 00 00       	push   $0x4476
  ...
  write(fd, "FF", 2);
    ...
    1d9e:	6a 02                	push   $0x2
    1da0:	68 97 44 00 00       	push   $0x4497
    1da5:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1db4:	5a                   	pop    %edx
    1db5:	6a 00                	push   $0x0
    1db7:	68 9a 44 00 00       	push   $0x449a
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1dd6:	68 00 85 00 00       	push   $0x8500
    1ddb:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1ded:	80 3d 00 85 00 00 66 	cmpb   $0x66,0x8500
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e03:	5b                   	pop    %ebx
    1e04:	58                   	pop    %eax
    1e05:	68 da 44 00 00       	push   $0x44da
    1e0a:	68 76 44 00 00       	push   $0x4476
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e22:	68 76 44 00 00       	push   $0x4476
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e3a:	6a 00                	push   $0x0
    1e3c:	68 76 44 00 00       	push   $0x4476
  ...
  if(chdir("dd") != 0){
    ...
    1e54:	68 40 45 00 00       	push   $0x4540
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1e84:	68 34 45 00 00       	push   $0x4534
  ...
  if(chdir("./..") != 0){
    ...
    1e9c:	68 43 45 00 00       	push   $0x4543
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1eb4:	6a 00                	push   $0x0
    1eb6:	68 da 44 00 00       	push   $0x44da
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1ed5:	68 00 85 00 00       	push   $0x8500
    1eda:	50                   	push   %eax
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1ef6:	5b                   	pop    %ebx
    1ef7:	6a 00                	push   $0x0
    1ef9:	68 76 44 00 00       	push   $0x4476
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f16:	68 8e 45 00 00       	push   $0x458e
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f33:	68 b3 45 00 00       	push   $0x45b3
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f50:	68 40 45 00 00       	push   $0x4540
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f68:	6a 02                	push   $0x2
    1f6a:	68 40 45 00 00       	push   $0x4540
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1f82:	6a 01                	push   $0x1
    1f84:	68 40 45 00 00       	push   $0x4540
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1f9c:	68 22 46 00 00       	push   $0x4622
    1fa1:	68 8e 45 00 00       	push   $0x458e
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1fb9:	68 22 46 00 00       	push   $0x4622
    1fbe:	68 b3 45 00 00       	push   $0x45b3
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1fd6:	68 da 44 00 00       	push   $0x44da
    1fdb:	68 79 44 00 00       	push   $0x4479
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    1ff3:	68 8e 45 00 00       	push   $0x458e
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    200b:	68 b3 45 00 00       	push   $0x45b3
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2023:	68 da 44 00 00       	push   $0x44da
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    203b:	68 b3 45 00 00       	push   $0x45b3
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2053:	68 8e 45 00 00       	push   $0x458e
  ...
  if(chdir("dd/ff") == 0){
    ...
    206b:	68 79 44 00 00       	push   $0x4479
  ...
  if(chdir("dd/xx") == 0){
    ...
    2083:	68 25 46 00 00       	push   $0x4625
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    209b:	68 da 44 00 00       	push   $0x44da
  ...
  if(unlink("dd/ff") != 0){
    ...
    20b3:	68 79 44 00 00       	push   $0x4479
  ...
  if(unlink("dd") == 0){
    ...
    20cb:	68 40 45 00 00       	push   $0x4540
  ...
  if(unlink("dd/dd") < 0){
    ...
    20e3:	68 55 44 00 00       	push   $0x4455
  ...
  if(unlink("dd") < 0){
    ...
    20fb:	68 40 45 00 00       	push   $0x4540
  ...
  printf(1, "subdir ok\n");
    ...
    2113:	68 22 47 00 00       	push   $0x4722
    2118:	6a 01                	push   $0x1
    211a:	e8 91 18 00 00       	call   39b0 <printf>
}
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2127:	50                   	push   %eax
    2128:	50                   	push   %eax
    2129:	68 bf 44 00 00       	push   $0x44bf
    212e:	6a 01                	push   $0x1
    2130:	e8 7b 18 00 00       	call   39b0 <printf>
    exit();
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    213a:	50                   	push   %eax
    213b:	50                   	push   %eax
    213c:	68 1a 45 00 00       	push   $0x451a
    2141:	6a 01                	push   $0x1
    2143:	e8 68 18 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    214d:	52                   	push   %edx
    214e:	52                   	push   %edx
    214f:	68 e5 44 00 00       	push   $0x44e5
    2154:	6a 01                	push   $0x1
    2156:	e8 55 18 00 00       	call   39b0 <printf>
    exit();
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2160:	50                   	push   %eax
    2161:	50                   	push   %eax
    2162:	68 97 45 00 00       	push   $0x4597
    2167:	6a 01                	push   $0x1
    2169:	e8 42 18 00 00       	call   39b0 <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2173:	52                   	push   %edx
    2174:	52                   	push   %edx
    2175:	68 58 4f 00 00       	push   $0x4f58
    217a:	6a 01                	push   $0x1
    217c:	e8 2f 18 00 00       	call   39b0 <printf>
    exit();
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2186:	52                   	push   %edx
    2187:	52                   	push   %edx
    2188:	68 2b 46 00 00       	push   $0x462b
    218d:	6a 01                	push   $0x1
    218f:	e8 1c 18 00 00       	call   39b0 <printf>
    exit();
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2199:	51                   	push   %ecx
    219a:	51                   	push   %ecx
    219b:	68 c8 4f 00 00       	push   $0x4fc8
    21a0:	6a 01                	push   $0x1
    21a2:	e8 09 18 00 00       	call   39b0 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    21ac:	50                   	push   %eax
    21ad:	50                   	push   %eax
    21ae:	68 a6 44 00 00       	push   $0x44a6
    21b3:	6a 01                	push   $0x1
    21b5:	e8 f6 17 00 00       	call   39b0 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    21bf:	51                   	push   %ecx
    21c0:	51                   	push   %ecx
    21c1:	68 7f 44 00 00       	push   $0x447f
    21c6:	6a 01                	push   $0x1
    21c8:	e8 e3 17 00 00       	call   39b0 <printf>
    exit();
  ...
  if(chdir("./..") != 0){
    ...
    21d2:	50                   	push   %eax
    21d3:	50                   	push   %eax
    21d4:	68 48 45 00 00       	push   $0x4548
    21d9:	6a 01                	push   $0x1
    21db:	e8 d0 17 00 00       	call   39b0 <printf>
    exit();
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    21e5:	51                   	push   %ecx
    21e6:	51                   	push   %ecx
    21e7:	68 10 4f 00 00       	push   $0x4f10
    21ec:	6a 01                	push   $0x1
    21ee:	e8 bd 17 00 00       	call   39b0 <printf>
    exit();
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    21f8:	53                   	push   %ebx
    21f9:	53                   	push   %ebx
    21fa:	68 a4 4f 00 00       	push   $0x4fa4
    21ff:	6a 01                	push   $0x1
    2201:	e8 aa 17 00 00       	call   39b0 <printf>
    exit();
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    220b:	50                   	push   %eax
    220c:	50                   	push   %eax
    220d:	68 80 4f 00 00       	push   $0x4f80
    2212:	6a 01                	push   $0x1
    2214:	e8 97 17 00 00       	call   39b0 <printf>
    exit();
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2225:	6a 01                	push   $0x1
    2227:	e8 84 17 00 00       	call   39b0 <printf>
    exit();
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2231:	50                   	push   %eax
    2232:	50                   	push   %eax
    2233:	68 ee 45 00 00       	push   $0x45ee
    2238:	6a 01                	push   $0x1
    223a:	e8 71 17 00 00       	call   39b0 <printf>
    exit();
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2244:	50                   	push   %eax
    2245:	50                   	push   %eax
    2246:	68 d8 45 00 00       	push   $0x45d8
    224b:	6a 01                	push   $0x1
    224d:	e8 5e 17 00 00       	call   39b0 <printf>
    exit();
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2257:	50                   	push   %eax
    2258:	50                   	push   %eax
    2259:	68 bc 45 00 00       	push   $0x45bc
    225e:	6a 01                	push   $0x1
    2260:	e8 4b 17 00 00       	call   39b0 <printf>
    exit();
  ...
  if(chdir("dd") != 0){
    ...
    226a:	50                   	push   %eax
    226b:	50                   	push   %eax
    226c:	68 fd 44 00 00       	push   $0x44fd
    2271:	6a 01                	push   $0x1
    2273:	e8 38 17 00 00       	call   39b0 <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    227d:	50                   	push   %eax
    227e:	50                   	push   %eax
    227f:	68 34 4f 00 00       	push   $0x4f34
    2284:	6a 01                	push   $0x1
    2286:	e8 25 17 00 00       	call   39b0 <printf>
    exit();
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2290:	53                   	push   %ebx
    2291:	53                   	push   %ebx
    2292:	68 5b 44 00 00       	push   $0x445b
    2297:	6a 01                	push   $0x1
    2299:	e8 12 17 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("dd") >= 0){
    ...
    22a3:	50                   	push   %eax
    22a4:	50                   	push   %eax
    22a5:	68 e8 4e 00 00       	push   $0x4ee8
    22aa:	6a 01                	push   $0x1
    22ac:	e8 ff 16 00 00       	call   39b0 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    22b6:	50                   	push   %eax
    22b7:	50                   	push   %eax
    22b8:	68 3f 44 00 00       	push   $0x443f
    22bd:	6a 01                	push   $0x1
    22bf:	e8 ec 16 00 00       	call   39b0 <printf>
    exit();
  ...
  if(mkdir("dd") != 0){
    ...
    22c9:	50                   	push   %eax
    22ca:	50                   	push   %eax
    22cb:	68 27 44 00 00       	push   $0x4427
    22d0:	6a 01                	push   $0x1
    22d2:	e8 d9 16 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("dd") < 0){
    ...
    22dc:	50                   	push   %eax
    22dd:	50                   	push   %eax
    22de:	68 10 47 00 00       	push   $0x4710
    22e3:	6a 01                	push   $0x1
    22e5:	e8 c6 16 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("dd/dd") < 0){
    ...
    22ef:	52                   	push   %edx
    22f0:	52                   	push   %edx
    22f1:	68 fb 46 00 00       	push   $0x46fb
    22f6:	6a 01                	push   $0x1
    22f8:	e8 b3 16 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("dd") == 0){
    ...
    2302:	51                   	push   %ecx
    2303:	51                   	push   %ecx
    2304:	68 ec 4f 00 00       	push   $0x4fec
    2309:	6a 01                	push   $0x1
    230b:	e8 a0 16 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("dd/ff") != 0){
    ...
    2315:	53                   	push   %ebx
    2316:	53                   	push   %ebx
    2317:	68 e6 46 00 00       	push   $0x46e6
    231c:	6a 01                	push   $0x1
    231e:	e8 8d 16 00 00       	call   39b0 <printf>
    exit();
  ...
  if(chdir("dd/xx") == 0){
    ...
    2328:	50                   	push   %eax
    2329:	50                   	push   %eax
    232a:	68 ce 46 00 00       	push   $0x46ce
    232f:	6a 01                	push   $0x1
    2331:	e8 7a 16 00 00       	call   39b0 <printf>
    exit();
  ...
  if(chdir("dd/ff") == 0){
    ...
    233b:	50                   	push   %eax
    233c:	50                   	push   %eax
    233d:	68 b6 46 00 00       	push   $0x46b6
    2342:	6a 01                	push   $0x1
    2344:	e8 67 16 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    234e:	50                   	push   %eax
    234f:	50                   	push   %eax
    2350:	68 9a 46 00 00       	push   $0x469a
    2355:	6a 01                	push   $0x1
    2357:	e8 54 16 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2361:	50                   	push   %eax
    2362:	50                   	push   %eax
    2363:	68 7e 46 00 00       	push   $0x467e
    2368:	6a 01                	push   $0x1
    236a:	e8 41 16 00 00       	call   39b0 <printf>
    exit();
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2374:	50                   	push   %eax
    2375:	50                   	push   %eax
    2376:	68 61 46 00 00       	push   $0x4661
    237b:	6a 01                	push   $0x1
    237d:	e8 2e 16 00 00       	call   39b0 <printf>
    exit();
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2387:	50                   	push   %eax
    2388:	50                   	push   %eax
    2389:	68 46 46 00 00       	push   $0x4646
    238e:	6a 01                	push   $0x1
    2390:	e8 1b 16 00 00       	call   39b0 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    239a:	50                   	push   %eax
    239b:	50                   	push   %eax
    239c:	68 73 45 00 00       	push   $0x4573
    23a1:	6a 01                	push   $0x1
    23a3:	e8 08 16 00 00       	call   39b0 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    23ad:	50                   	push   %eax
    23ae:	50                   	push   %eax
    23af:	68 5b 45 00 00       	push   $0x455b
    23b4:	6a 01                	push   $0x1
    23b6:	e8 f5 15 00 00       	call   39b0 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    23cd:	68 2d 47 00 00       	push   $0x472d
    23d2:	6a 01                	push   $0x1
    23d4:	e8 d7 15 00 00       	call   39b0 <printf>

  unlink("bigwrite");
    23d9:	c7 04 24 3c 47 00 00 	movl   $0x473c,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    23f8:	68 3c 47 00 00       	push   $0x473c
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    240e:	53                   	push   %ebx
    240f:	68 00 85 00 00       	push   $0x8500
    2414:	50                   	push   %eax
    ...
    2424:	53                   	push   %ebx
    2425:	68 00 85 00 00       	push   $0x8500
    242a:	56                   	push   %esi
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    2446:	c7 04 24 3c 47 00 00 	movl   $0x473c,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    2460:	68 6f 47 00 00       	push   $0x476f
    2465:	6a 01                	push   $0x1
    2467:	e8 44 15 00 00       	call   39b0 <printf>
}
    ...
    2476:	50                   	push   %eax
    2477:	53                   	push   %ebx
    2478:	68 5d 47 00 00       	push   $0x475d
    247d:	6a 01                	push   $0x1
    247f:	e8 2c 15 00 00       	call   39b0 <printf>
        exit();
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    248c:	68 45 47 00 00       	push   $0x4745
    2491:	6a 01                	push   $0x1
    2493:	e8 18 15 00 00       	call   39b0 <printf>
      exit();
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    24a9:	68 7c 47 00 00       	push   $0x477c
    24ae:	6a 01                	push   $0x1
    24b0:	e8 fb 14 00 00       	call   39b0 <printf>

  unlink("bigfile");
    24b5:	c7 04 24 98 47 00 00 	movl   $0x4798,(%esp)
    24bc:	e8 b1 13 00 00       	call   3872 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24c1:	5e                   	pop    %esi
    24c2:	5f                   	pop    %edi
    24c3:	68 02 02 00 00       	push   $0x202
    24c8:	68 98 47 00 00       	push   $0x4798
  ...
  fd = open("bigfile", 0);
    ...
    252e:	5b                   	pop    %ebx
    252f:	6a 00                	push   $0x0
    2531:	68 98 47 00 00       	push   $0x4798
  ...
  if(fd < 0){
    ...
    255b:	0f be 05 00 85 00 00 	movsbl 0x8500,%eax
    2562:	89 fa                	mov    %edi,%edx
    2564:	d1 fa                	sar    %edx
    2566:	39 d0                	cmp    %edx,%eax
    2568:	75 6e                	jne    25d8 <bigfile+0x138>
    256a:	0f be 15 2b 86 00 00 	movsbl 0x862b,%edx
  ...
  for(i = 0; ; i++){
    ...
    2586:	68 00 85 00 00       	push   $0x8500
    258b:	56                   	push   %esi
  ...
  unlink("bigfile");
    ...
    25b5:	68 98 47 00 00       	push   $0x4798
    25ba:	e8 b3 12 00 00       	call   3872 <unlink>

  printf(1, "bigfile test ok\n");
    25bf:	58                   	pop    %eax
    25c0:	5a                   	pop    %edx
    25c1:	68 27 48 00 00       	push   $0x4827
    25c6:	6a 01                	push   $0x1
    25c8:	e8 e3 13 00 00       	call   39b0 <printf>
}
    ...
    25db:	68 f4 47 00 00       	push   $0x47f4
    25e0:	6a 01                	push   $0x1
    25e2:	e8 c9 13 00 00       	call   39b0 <printf>
      exit();
    ...
    25ef:	68 e0 47 00 00       	push   $0x47e0
    25f4:	6a 01                	push   $0x1
    25f6:	e8 b5 13 00 00       	call   39b0 <printf>
      exit();
  ...
  for(i = 0; ; i++){
    ...
    2603:	68 cb 47 00 00       	push   $0x47cb
    2608:	6a 01                	push   $0x1
    260a:	e8 a1 13 00 00       	call   39b0 <printf>
      exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2617:	68 a0 47 00 00       	push   $0x47a0
    261c:	6a 01                	push   $0x1
    261e:	e8 8d 13 00 00       	call   39b0 <printf>
      exit();
  ...
  if(fd < 0){
    ...
    262b:	68 b6 47 00 00       	push   $0x47b6
    2630:	6a 01                	push   $0x1
    2632:	e8 79 13 00 00       	call   39b0 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    263f:	68 8a 47 00 00       	push   $0x478a
    2644:	6a 01                	push   $0x1
    2646:	e8 65 13 00 00       	call   39b0 <printf>
    exit();
  ...
  if(total != 20*600){
    ...
    2653:	68 0d 48 00 00       	push   $0x480d
    2658:	6a 01                	push   $0x1
    265a:	e8 51 13 00 00       	call   39b0 <printf>
    exit();
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    2676:	68 38 48 00 00       	push   $0x4838
    267b:	6a 01                	push   $0x1
    267d:	e8 2e 13 00 00       	call   39b0 <printf>

  if(mkdir("12345678901234") != 0){
    2682:	c7 04 24 73 48 00 00 	movl   $0x4873,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    269c:	68 0c 50 00 00       	push   $0x500c
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26b9:	68 5c 50 00 00       	push   $0x505c
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26d8:	5a                   	pop    %edx
    26d9:	6a 00                	push   $0x0
    26db:	68 cc 50 00 00       	push   $0x50cc
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    26f5:	c7 04 24 64 48 00 00 	movl   $0x4864,(%esp)
  ...
  printf(1, "fourteen ok\n");
    ...
    271f:	68 82 48 00 00       	push   $0x4882
    2724:	6a 01                	push   $0x1
    2726:	e8 85 12 00 00       	call   39b0 <printf>
}
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2730:	50                   	push   %eax
    2731:	50                   	push   %eax
    2732:	68 47 48 00 00       	push   $0x4847
    2737:	6a 01                	push   $0x1
    2739:	e8 72 12 00 00       	call   39b0 <printf>
    exit();
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2743:	50                   	push   %eax
    2744:	50                   	push   %eax
    2745:	68 88 51 00 00       	push   $0x5188
    274a:	6a 01                	push   $0x1
    274c:	e8 5f 12 00 00       	call   39b0 <printf>
    exit();
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2756:	52                   	push   %edx
    2757:	52                   	push   %edx
    2758:	68 38 51 00 00       	push   $0x5138
    275d:	6a 01                	push   $0x1
    275f:	e8 4c 12 00 00       	call   39b0 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2769:	51                   	push   %ecx
    276a:	51                   	push   %ecx
    276b:	68 fc 50 00 00       	push   $0x50fc
    2770:	6a 01                	push   $0x1
    2772:	e8 39 12 00 00       	call   39b0 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    277c:	51                   	push   %ecx
    277d:	51                   	push   %ecx
    277e:	68 8c 50 00 00       	push   $0x508c
    2783:	6a 01                	push   $0x1
    2785:	e8 26 12 00 00       	call   39b0 <printf>
    exit();
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    278f:	50                   	push   %eax
    2790:	50                   	push   %eax
    2791:	68 2c 50 00 00       	push   $0x502c
    2796:	6a 01                	push   $0x1
    2798:	e8 13 12 00 00       	call   39b0 <printf>
    exit();
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    27b6:	68 8f 48 00 00       	push   $0x488f
    27bb:	6a 01                	push   $0x1
    27bd:	e8 ee 11 00 00       	call   39b0 <printf>
  if(mkdir("dots") != 0){
    27c2:	c7 04 24 9b 48 00 00 	movl   $0x489b,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    27dc:	68 9b 48 00 00       	push   $0x489b
  ...
  if(unlink(".") == 0){
    ...
    27f4:	68 46 45 00 00       	push   $0x4546
  ...
  if(unlink("..") == 0){
    ...
    280c:	68 45 45 00 00       	push   $0x4545
  ...
  if(chdir("/") != 0){
    ...
    2824:	68 19 3d 00 00       	push   $0x3d19
  ...
  if(unlink("dots/.") == 0){
    ...
    283c:	68 e3 48 00 00       	push   $0x48e3
  ...
  if(unlink("dots/..") == 0){
    ...
    2850:	68 01 49 00 00       	push   $0x4901
  ...
  if(unlink("dots") != 0){
    ...
    2864:	68 9b 48 00 00       	push   $0x489b
  ...
  printf(1, "rmdot ok\n");
    ...
    2878:	68 36 49 00 00       	push   $0x4936
    287d:	6a 01                	push   $0x1
    287f:	e8 2c 11 00 00       	call   39b0 <printf>
}
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    ...
    2889:	50                   	push   %eax
    288a:	50                   	push   %eax
    288b:	68 a0 48 00 00       	push   $0x48a0
    2890:	6a 01                	push   $0x1
    2892:	e8 19 11 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("dots") != 0){
    ...
    289c:	50                   	push   %eax
    289d:	50                   	push   %eax
    289e:	68 21 49 00 00       	push   $0x4921
    28a3:	6a 01                	push   $0x1
    28a5:	e8 06 11 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("dots/..") == 0){
    ...
    28af:	52                   	push   %edx
    28b0:	52                   	push   %edx
    28b1:	68 09 49 00 00       	push   $0x4909
    28b6:	6a 01                	push   $0x1
    28b8:	e8 f3 10 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("dots/.") == 0){
    ...
    28c2:	51                   	push   %ecx
    28c3:	51                   	push   %ecx
    28c4:	68 ea 48 00 00       	push   $0x48ea
    28c9:	6a 01                	push   $0x1
    28cb:	e8 e0 10 00 00       	call   39b0 <printf>
    exit();
  ...
  if(chdir("/") != 0){
    ...
    28d5:	50                   	push   %eax
    28d6:	50                   	push   %eax
    28d7:	68 1b 3d 00 00       	push   $0x3d1b
    28dc:	6a 01                	push   $0x1
    28de:	e8 cd 10 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("..") == 0){
    ...
    28e8:	50                   	push   %eax
    28e9:	50                   	push   %eax
    28ea:	68 d4 48 00 00       	push   $0x48d4
    28ef:	6a 01                	push   $0x1
    28f1:	e8 ba 10 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink(".") == 0){
    ...
    28fb:	50                   	push   %eax
    28fc:	50                   	push   %eax
    28fd:	68 c6 48 00 00       	push   $0x48c6
    2902:	6a 01                	push   $0x1
    2904:	e8 a7 10 00 00       	call   39b0 <printf>
    exit();
  ...
  if(chdir("dots") != 0){
    ...
    290e:	50                   	push   %eax
    290f:	50                   	push   %eax
    2910:	68 b3 48 00 00       	push   $0x48b3
    2915:	6a 01                	push   $0x1
    2917:	e8 94 10 00 00       	call   39b0 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2937:	68 40 49 00 00       	push   $0x4940
    293c:	6a 01                	push   $0x1
    293e:	e8 6d 10 00 00       	call   39b0 <printf>

  fd = open("dirfile", O_CREATE);
    2943:	59                   	pop    %ecx
    2944:	5b                   	pop    %ebx
    2945:	68 00 02 00 00       	push   $0x200
    294a:	68 4d 49 00 00       	push   $0x494d
  ...
  if(chdir("dirfile") == 0){
    2968:	c7 04 24 4d 49 00 00 	movl   $0x494d,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    2982:	6a 00                	push   $0x0
    2984:	68 86 49 00 00       	push   $0x4986
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29a1:	68 86 49 00 00       	push   $0x4986
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29b9:	68 86 49 00 00       	push   $0x4986
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    29d1:	68 86 49 00 00       	push   $0x4986
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    29e9:	68 86 49 00 00       	push   $0x4986
    29ee:	68 ea 49 00 00       	push   $0x49ea
  ...
  if(unlink("dirfile") != 0){
    ...
    2a06:	68 4d 49 00 00       	push   $0x494d
  ...
  fd = open(".", O_RDWR);
    ...
    2a1e:	6a 02                	push   $0x2
    2a20:	68 46 45 00 00       	push   $0x4546
  ...
  fd = open(".", 0);
    ...
    2a38:	6a 00                	push   $0x0
    2a3a:	68 46 45 00 00       	push   $0x4546
  ...
  if(write(fd, "x", 1) > 0){
    2a49:	6a 01                	push   $0x1
    2a4b:	68 29 46 00 00       	push   $0x4629
    2a50:	50                   	push   %eax
  ...
  printf(1, "dir vs file OK\n");
    2a66:	58                   	pop    %eax
    2a67:	5a                   	pop    %edx
    2a68:	68 1d 4a 00 00       	push   $0x4a1d
    2a6d:	6a 01                	push   $0x1
    2a6f:	e8 3c 0f 00 00       	call   39b0 <printf>
}
  ...
  if(fd >= 0){
    ...
    2a7c:	50                   	push   %eax
    2a7d:	50                   	push   %eax
    2a7e:	68 91 49 00 00       	push   $0x4991
    2a83:	6a 01                	push   $0x1
    2a85:	e8 26 0f 00 00       	call   39b0 <printf>
    exit();
  ...
  if(chdir("dirfile") == 0){
    ...
    2a8f:	50                   	push   %eax
    2a90:	50                   	push   %eax
    2a91:	68 6c 49 00 00       	push   $0x496c
    2a96:	6a 01                	push   $0x1
    2a98:	e8 13 0f 00 00       	call   39b0 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2aa2:	52                   	push   %edx
    2aa3:	52                   	push   %edx
    2aa4:	68 55 49 00 00       	push   $0x4955
    2aa9:	6a 01                	push   $0x1
    2aab:	e8 00 0f 00 00       	call   39b0 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2ab5:	51                   	push   %ecx
    2ab6:	51                   	push   %ecx
    2ab7:	68 09 4a 00 00       	push   $0x4a09
    2abc:	6a 01                	push   $0x1
    2abe:	e8 ed 0e 00 00       	call   39b0 <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    2ac8:	53                   	push   %ebx
    2ac9:	53                   	push   %ebx
    2aca:	68 dc 51 00 00       	push   $0x51dc
    2acf:	6a 01                	push   $0x1
    2ad1:	e8 da 0e 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("dirfile") != 0){
    ...
    2adb:	50                   	push   %eax
    2adc:	50                   	push   %eax
    2add:	68 f1 49 00 00       	push   $0x49f1
    2ae2:	6a 01                	push   $0x1
    2ae4:	e8 c7 0e 00 00       	call   39b0 <printf>
    exit();
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2aee:	50                   	push   %eax
    2aef:	50                   	push   %eax
    2af0:	68 bc 51 00 00       	push   $0x51bc
    2af5:	6a 01                	push   $0x1
    2af7:	e8 b4 0e 00 00       	call   39b0 <printf>
    exit();
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2b01:	50                   	push   %eax
    2b02:	50                   	push   %eax
    2b03:	68 cc 49 00 00       	push   $0x49cc
    2b08:	6a 01                	push   $0x1
    2b0a:	e8 a1 0e 00 00       	call   39b0 <printf>
    exit();
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2b14:	50                   	push   %eax
    2b15:	50                   	push   %eax
    2b16:	68 af 49 00 00       	push   $0x49af
    2b1b:	6a 01                	push   $0x1
    2b1d:	e8 8e 0e 00 00       	call   39b0 <printf>
    exit();
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2b3c:	68 2d 4a 00 00       	push   $0x4a2d
    2b41:	6a 01                	push   $0x1
    2b43:	e8 68 0e 00 00       	call   39b0 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2b53:	68 3e 4a 00 00       	push   $0x4a3e
    ...
    2b6b:	68 3e 4a 00 00       	push   $0x4a3e
    ...
    2b83:	68 f3 40 00 00       	push   $0x40f3
    2b88:	e8 fd 0c 00 00       	call   388a <mkdir>
    link("README", "");
    2b8d:	59                   	pop    %ecx
    2b8e:	58                   	pop    %eax
    2b8f:	68 f3 40 00 00       	push   $0x40f3
    2b94:	68 ea 49 00 00       	push   $0x49ea
    2b99:	e8 e4 0c 00 00       	call   3882 <link>
    fd = open("", O_CREATE);
    2b9e:	58                   	pop    %eax
    2b9f:	5a                   	pop    %edx
    2ba0:	68 00 02 00 00       	push   $0x200
    2ba5:	68 f3 40 00 00       	push   $0x40f3
    ...
    2bca:	68 28 46 00 00       	push   $0x4628
    ...
    2bea:	68 28 46 00 00       	push   $0x4628
  ...
  chdir("/");
    ...
    2c03:	68 19 3d 00 00       	push   $0x3d19
    2c08:	e8 85 0c 00 00       	call   3892 <chdir>
  printf(1, "empty file name OK\n");
    2c0d:	58                   	pop    %eax
    2c0e:	5a                   	pop    %edx
    2c0f:	68 6c 4a 00 00       	push   $0x4a6c
    2c14:	6a 01                	push   $0x1
    2c16:	e8 95 0d 00 00       	call   39b0 <printf>
}
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2c26:	68 44 4a 00 00       	push   $0x4a44
    2c2b:	6a 01                	push   $0x1
    2c2d:	e8 7e 0d 00 00       	call   39b0 <printf>
      exit();
    ...
    2c3a:	68 58 4a 00 00       	push   $0x4a58
    2c3f:	6a 01                	push   $0x1
    2c41:	e8 6a 0d 00 00       	call   39b0 <printf>
      exit();
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2c59:	68 80 4a 00 00       	push   $0x4a80
    2c5e:	6a 01                	push   $0x1
    2c60:	e8 4b 0d 00 00       	call   39b0 <printf>
    ...
    2c70:	74 62                	je     2cd4 <forktest+0x84>
{
  ...
  printf(1, "fork test OK\n");
    ...
    2cab:	68 b2 4a 00 00       	push   $0x4ab2
    2cb0:	6a 01                	push   $0x1
    2cb2:	e8 f9 0c 00 00       	call   39b0 <printf>
}
  ...
  if(n == 1000){
    ...
    2cc3:	68 fc 51 00 00       	push   $0x51fc
    2cc8:	6a 01                	push   $0x1
    2cca:	e8 e1 0c 00 00       	call   39b0 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2cdc:	68 8b 4a 00 00       	push   $0x4a8b
    2ce1:	6a 01                	push   $0x1
    2ce3:	e8 c8 0c 00 00       	call   39b0 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2cf0:	68 9f 4a 00 00       	push   $0x4a9f
    2cf5:	6a 01                	push   $0x1
    2cf7:	e8 b4 0c 00 00       	call   39b0 <printf>
    exit();
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2d1b:	68 c0 4a 00 00       	push   $0x4ac0
    2d20:	ff 35 18 5d 00 00    	pushl  0x5d18
    2d26:	e8 85 0c 00 00       	call   39b0 <printf>
  oldbrk = sbrk(0);
...
#define BIG (100*1024*1024)
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2f8c:	68 68 4b 00 00       	push   $0x4b68
    2f91:	ff 35 18 5d 00 00    	pushl  0x5d18
    2f97:	e8 14 0a 00 00       	call   39b0 <printf>
}
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2fc0:	6a 01                	push   $0x1
    2fc2:	68 29 46 00 00       	push   $0x4629
  ...
  for(i = 0; i < 5000; i++){
    ...
    2fee:	53                   	push   %ebx
    2fef:	57                   	push   %edi
    2ff0:	68 cb 4a 00 00       	push   $0x4acb
    2ff5:	ff 35 18 5d 00 00    	pushl  0x5d18
    2ffb:	e8 b0 09 00 00       	call   39b0 <printf>
      exit();
  ...
  if(c == (char*)0xffffffff){
    ...
    300b:	68 4d 4b 00 00       	push   $0x4b4d
    3010:	ff 35 18 5d 00 00    	pushl  0x5d18
    3016:	e8 95 09 00 00       	call   39b0 <printf>
    exit();
  ...
  if(pipe(fds) != 0){
    ...
    3023:	68 09 40 00 00       	push   $0x4009
    3028:	6a 01                	push   $0x1
    302a:	e8 81 09 00 00       	call   39b0 <printf>
    exit();
    ...
    3037:	50                   	push   %eax
    3038:	53                   	push   %ebx
    3039:	68 34 4b 00 00       	push   $0x4b34
    303e:	ff 35 18 5d 00 00    	pushl  0x5d18
    3044:	e8 67 09 00 00       	call   39b0 <printf>
      kill(ppid);
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    3059:	68 11 4c 00 00       	push   $0x4c11
    305e:	ff 35 18 5d 00 00    	pushl  0x5d18
    3064:	e8 47 09 00 00       	call   39b0 <printf>
      exit();
  ...
  if(c != a){
    ...
    306e:	50                   	push   %eax
    306f:	53                   	push   %ebx
    3070:	68 f0 52 00 00       	push   $0x52f0
    3075:	ff 35 18 5d 00 00    	pushl  0x5d18
    307b:	e8 30 09 00 00       	call   39b0 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3088:	68 c0 52 00 00       	push   $0x52c0
    308d:	ff 35 18 5d 00 00    	pushl  0x5d18
    3093:	e8 18 09 00 00       	call   39b0 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    309d:	57                   	push   %edi
    309e:	53                   	push   %ebx
    309f:	68 98 52 00 00       	push   $0x5298
    30a4:	ff 35 18 5d 00 00    	pushl  0x5d18
    30aa:	e8 01 09 00 00       	call   39b0 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    30b4:	50                   	push   %eax
    30b5:	53                   	push   %ebx
    30b6:	68 60 52 00 00       	push   $0x5260
    30bb:	ff 35 18 5d 00 00    	pushl  0x5d18
    30c1:	e8 ea 08 00 00       	call   39b0 <printf>
    exit();
  ...
  if(c == (char*)0xffffffff){
    ...
    30ce:	68 19 4b 00 00       	push   $0x4b19
    30d3:	ff 35 18 5d 00 00    	pushl  0x5d18
    30d9:	e8 d2 08 00 00       	call   39b0 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    30e6:	68 20 52 00 00       	push   $0x5220
    30eb:	ff 35 18 5d 00 00    	pushl  0x5d18
    30f1:	e8 ba 08 00 00       	call   39b0 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    3103:	68 fd 4a 00 00       	push   $0x4afd
    3108:	ff 35 18 5d 00 00    	pushl  0x5d18
    310e:	e8 9d 08 00 00       	call   39b0 <printf>
    exit();
  ...
  if(pid < 0){
    ...
    311b:	68 e6 4a 00 00       	push   $0x4ae6
    3120:	ff 35 18 5d 00 00    	pushl  0x5d18
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    314a:	68 76 4b 00 00       	push   $0x4b76
    314f:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    318f:	5a                   	pop    %edx
    3190:	53                   	push   %ebx
    3191:	68 85 4b 00 00       	push   $0x4b85
  ...
  printf(stdout, "validate ok\n");
    ...
    31b4:	68 a9 4b 00 00       	push   $0x4ba9
    31b9:	ff 35 18 5d 00 00    	pushl  0x5d18
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    31d6:	68 90 4b 00 00       	push   $0x4b90
    31db:	ff 35 18 5d 00 00    	pushl  0x5d18
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    31f6:	68 b6 4b 00 00       	push   $0x4bb6
    31fb:	ff 35 18 5d 00 00    	pushl  0x5d18
    3201:	e8 aa 07 00 00       	call   39b0 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    if(uninit[i] != '\0'){
    3206:	83 c4 10             	add    $0x10,%esp
    3209:	80 3d e0 5d 00 00 00 	cmpb   $0x0,0x5de0
    3210:	75 35                	jne    3247 <bsstest+0x57>
    3212:	b8 e1 5d 00 00       	mov    $0x5de1,%eax
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
  for(i = 0; i < sizeof(uninit); i++){
    3228:	3d f0 84 00 00       	cmp    $0x84f0,%eax
  ...
  printf(stdout, "bss test ok\n");
    ...
    3232:	68 d1 4b 00 00       	push   $0x4bd1
    3237:	ff 35 18 5d 00 00    	pushl  0x5d18
    323d:	e8 6e 07 00 00       	call   39b0 <printf>
}
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    324a:	68 c0 4b 00 00       	push   $0x4bc0
    324f:	ff 35 18 5d 00 00    	pushl  0x5d18
    3255:	e8 56 07 00 00       	call   39b0 <printf>
      exit();
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    3266:	68 de 4b 00 00       	push   $0x4bde
  ...
  fd = open("bigarg-ok", 0);
    ...
    328a:	6a 00                	push   $0x0
    328c:	68 de 4b 00 00       	push   $0x4bde
  ...
  unlink("bigarg-ok");
    32aa:	c7 04 24 de 4b 00 00 	movl   $0x4bde,(%esp)
    32b1:	e8 bc 05 00 00       	call   3872 <unlink>
}
    32b6:	83 c4 10             	add    $0x10,%esp
    32b9:	c9                   	leave  
    32ba:	c3                   	ret    
    32bb:	b8 40 5d 00 00       	mov    $0x5d40,%eax
  pid = fork();
  if(pid == 0){
    ...
    32c0:	c7 00 14 53 00 00    	movl   $0x5314,(%eax)
  ...
  if(pid == 0){
    ...
    int i;
    for(i = 0; i < MAXARG-1; i++)
    32c9:	3d bc 5d 00 00       	cmp    $0x5dbc,%eax
    ...
    32d0:	51                   	push   %ecx
    32d1:	51                   	push   %ecx
    32d2:	68 e8 4b 00 00       	push   $0x4be8
    32d7:	ff 35 18 5d 00 00    	pushl  0x5d18
  if(pid == 0){
    static char *args[MAXARG];
    int i;
    for(i = 0; i < MAXARG-1; i++)
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    32dd:	c7 05 bc 5d 00 00 00 	movl   $0x0,0x5dbc
    32e4:	00 00 00 
    printf(stdout, "bigarg test\n");
    32e7:	e8 c4 06 00 00       	call   39b0 <printf>
    exec("echo", args);
    32ec:	58                   	pop    %eax
    32ed:	5a                   	pop    %edx
    32ee:	68 40 5d 00 00       	push   $0x5d40
    32f3:	68 b5 3d 00 00       	push   $0x3db5
    32f8:	e8 5d 05 00 00       	call   385a <exec>
    printf(stdout, "bigarg test ok\n");
    32fd:	59                   	pop    %ecx
    32fe:	58                   	pop    %eax
    32ff:	68 f5 4b 00 00       	push   $0x4bf5
    3304:	ff 35 18 5d 00 00    	pushl  0x5d18
    330a:	e8 a1 06 00 00       	call   39b0 <printf>
    fd = open("bigarg-ok", O_CREATE);
    330f:	58                   	pop    %eax
    3310:	5a                   	pop    %edx
    3311:	68 00 02 00 00       	push   $0x200
    3316:	68 de 4b 00 00       	push   $0x4bde
  ...
  if(fd < 0){
    ...
    332d:	50                   	push   %eax
    332e:	50                   	push   %eax
    332f:	68 1e 4c 00 00       	push   $0x4c1e
    3334:	ff 35 18 5d 00 00    	pushl  0x5d18
    333a:	e8 71 06 00 00       	call   39b0 <printf>
    exit();
    ...
    3344:	52                   	push   %edx
    3345:	52                   	push   %edx
    3346:	68 05 4c 00 00       	push   $0x4c05
    334b:	ff 35 18 5d 00 00    	pushl  0x5d18
    3351:	e8 5a 06 00 00       	call   39b0 <printf>
    exit();
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    336b:	68 33 4c 00 00       	push   $0x4c33
    3370:	6a 01                	push   $0x1
    3372:	e8 39 06 00 00       	call   39b0 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3408:	50                   	push   %eax
    3409:	68 40 4c 00 00       	push   $0x4c40
    340e:	6a 01                	push   $0x1
    3410:	e8 9b 05 00 00       	call   39b0 <printf>
    ...
    3442:	68 00 85 00 00       	push   $0x8500
    3447:	57                   	push   %edi
    ...
    345a:	56                   	push   %esi
    345b:	68 5c 4c 00 00       	push   $0x4c5c
    3460:	6a 01                	push   $0x1
    3462:	e8 49 05 00 00       	call   39b0 <printf>
    close(fd);
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3484:	50                   	push   %eax
    3485:	68 4c 4c 00 00       	push   $0x4c4c
    348a:	6a 01                	push   $0x1
    348c:	e8 1f 05 00 00       	call   39b0 <printf>
      break;
  ...
  printf(1, "fsfull test finished\n");
    ...
    3538:	68 6c 4c 00 00       	push   $0x4c6c
    353d:	6a 01                	push   $0x1
    353f:	e8 6c 04 00 00       	call   39b0 <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    3556:	68 82 4c 00 00       	push   $0x4c82
    355b:	6a 01                	push   $0x1
    355d:	e8 4e 04 00 00       	call   39b0 <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    3578:	68 8c 4c 00 00       	push   $0x4c8c
    357d:	6a 01                	push   $0x1
    357f:	e8 2c 04 00 00       	call   39b0 <printf>
}
  ...
  if(pid == 0){
    ...
    359a:	52                   	push   %edx
    359b:	52                   	push   %edx
    359c:	68 f4 53 00 00       	push   $0x53f4
    35a1:	6a 01                	push   $0x1
    35a3:	e8 08 04 00 00       	call   39b0 <printf>
    exit();
    ...
    35ad:	50                   	push   %eax
    35ae:	50                   	push   %eax
    35af:	68 11 4c 00 00       	push   $0x4c11
    35b4:	6a 01                	push   $0x1
    35b6:	e8 f5 03 00 00       	call   39b0 <printf>
    exit();
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
    35c0:	69 05 14 5d 00 00 0d 	imul   $0x19660d,0x5d14,%eax
    35c7:	66 19 00 
}
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
    ...
    35d3:	a3 14 5d 00 00       	mov    %eax,0x5d14
  return randstate;
}
    35d8:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    3914:	56                   	push   %esi
    3915:	53                   	push   %ebx
    3916:	89 c6                	mov    %eax,%esi
    3918:	83 ec 3c             	sub    $0x3c,%esp
  char buf[16];
  int i, neg;
  uint x;
  ...
  if(sgn && xx < 0){
    ...
    391e:	85 db                	test   %ebx,%ebx
    3920:	74 7e                	je     39a0 <printint+0x90>
    3922:	89 d0                	mov    %edx,%eax
    3924:	c1 e8 1f             	shr    $0x1f,%eax
    3927:	84 c0                	test   %al,%al
    3929:	74 75                	je     39a0 <printint+0x90>
    neg = 1;
    x = -xx;
  ...
  if(sgn && xx < 0){
    neg = 1;
    392d:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
    x = -xx;
    3934:	f7 d8                	neg    %eax
    3936:	89 75 c0             	mov    %esi,-0x40(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    3939:	31 ff                	xor    %edi,%edi
    393b:	8d 5d d7             	lea    -0x29(%ebp),%ebx
    393e:	89 ce                	mov    %ecx,%esi
    3940:	eb 08                	jmp    394a <printint+0x3a>
    3942:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    3948:	89 cf                	mov    %ecx,%edi
    394a:	31 d2                	xor    %edx,%edx
    394c:	8d 4f 01             	lea    0x1(%edi),%ecx
    394f:	f7 f6                	div    %esi
    3951:	0f b6 92 4c 54 00 00 	movzbl 0x544c(%edx),%edx
  }while((x /= base) != 0);
  ...
  do{
    buf[i++] = digits[x % base];
    395a:	88 14 0b             	mov    %dl,(%ebx,%ecx,1)
  }while((x /= base) != 0);
    395d:	75 e9                	jne    3948 <printint+0x38>
  if(neg)
    395f:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    3962:	8b 75 c0             	mov    -0x40(%ebp),%esi
    3965:	85 c0                	test   %eax,%eax
    3967:	74 08                	je     3971 <printint+0x61>
    buf[i++] = '-';
    3969:	c6 44 0d d8 2d       	movb   $0x2d,-0x28(%ebp,%ecx,1)
    396e:	8d 4f 02             	lea    0x2(%edi),%ecx
    3971:	8d 7c 0d d7          	lea    -0x29(%ebp,%ecx,1),%edi
    3975:	8d 76 00             	lea    0x0(%esi),%esi
    3978:	0f b6 07             	movzbl (%edi),%eax
#include "user.h"
...
{
  write(fd, &c, 1);
    397b:	83 ec 04             	sub    $0x4,%esp
    397e:	83 ef 01             	sub    $0x1,%edi
    3981:	6a 01                	push   $0x1
    3983:	53                   	push   %ebx
    3984:	56                   	push   %esi
    3985:	88 45 d7             	mov    %al,-0x29(%ebp)
    3988:	e8 b5 fe ff ff       	call   3842 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    ...
    3990:	39 df                	cmp    %ebx,%edi
    3992:	75 e4                	jne    3978 <printint+0x68>
    putc(fd, buf[i]);
}
    3994:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3997:	5b                   	pop    %ebx
    3998:	5e                   	pop    %esi
    3999:	5f                   	pop    %edi
    399a:	5d                   	pop    %ebp
  ...
  neg = 0;
    39a2:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
    39a9:	eb 8b                	jmp    3936 <printint+0x26>
    39ab:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    39b6:	8d 45 10             	lea    0x10(%ebp),%eax
}
...
printf(int fd, char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    39c2:	89 45 d0             	mov    %eax,-0x30(%ebp)
    39c5:	0f b6 1e             	movzbl (%esi),%ebx
    39c8:	83 c6 01             	add    $0x1,%esi
    39cb:	84 db                	test   %bl,%bl
    39cd:	0f 84 b0 00 00 00    	je     3a83 <printf+0xd3>
    39d3:	31 d2                	xor    %edx,%edx
    39d5:	eb 39                	jmp    3a10 <printf+0x60>
    39d7:	89 f6                	mov    %esi,%esi
    39d9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    39e0:	83 f8 25             	cmp    $0x25,%eax
    39e3:	89 55 d4             	mov    %edx,-0x2c(%ebp)
        state = '%';
    39e6:	ba 25 00 00 00       	mov    $0x25,%edx
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    39eb:	74 18                	je     3a05 <printf+0x55>
#include "user.h"
...
{
  write(fd, &c, 1);
    39ed:	8d 45 e2             	lea    -0x1e(%ebp),%eax
    39f0:	83 ec 04             	sub    $0x4,%esp
    39f3:	88 5d e2             	mov    %bl,-0x1e(%ebp)
    39f6:	6a 01                	push   $0x1
    39f8:	50                   	push   %eax
    39f9:	57                   	push   %edi
    39fa:	e8 43 fe ff ff       	call   3842 <write>
    39ff:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    3a02:	83 c4 10             	add    $0x10,%esp
    3a05:	83 c6 01             	add    $0x1,%esi
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3a08:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
    3a0c:	84 db                	test   %bl,%bl
    3a0e:	74 73                	je     3a83 <printf+0xd3>
    c = fmt[i] & 0xff;
    if(state == 0){
    3a10:	85 d2                	test   %edx,%edx
  uint *ap;
  ...
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    3a12:	0f be cb             	movsbl %bl,%ecx
    3a15:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    3a18:	74 c6                	je     39e0 <printf+0x30>
      if(c == '%'){
        state = '%';
      } else {
        putc(fd, c);
    ...
    3a1a:	83 fa 25             	cmp    $0x25,%edx
    3a1d:	75 e6                	jne    3a05 <printf+0x55>
      if(c == 'd'){
    3a1f:	83 f8 64             	cmp    $0x64,%eax
    3a22:	0f 84 f8 00 00 00    	je     3b20 <printf+0x170>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    3a28:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
    3a2e:	83 f9 70             	cmp    $0x70,%ecx
    3a31:	74 5d                	je     3a90 <printf+0xe0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    3a33:	83 f8 73             	cmp    $0x73,%eax
    3a36:	0f 84 84 00 00 00    	je     3ac0 <printf+0x110>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    3a3c:	83 f8 63             	cmp    $0x63,%eax
    3a3f:	0f 84 ea 00 00 00    	je     3b2f <printf+0x17f>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    3a45:	83 f8 25             	cmp    $0x25,%eax
    3a48:	0f 84 c2 00 00 00    	je     3b10 <printf+0x160>
#include "user.h"
...
{
  write(fd, &c, 1);
    3a4e:	8d 45 e7             	lea    -0x19(%ebp),%eax
    3a51:	83 ec 04             	sub    $0x4,%esp
    3a54:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    3a58:	6a 01                	push   $0x1
    3a5a:	50                   	push   %eax
    3a5b:	57                   	push   %edi
    3a5c:	e8 e1 fd ff ff       	call   3842 <write>
    3a61:	83 c4 0c             	add    $0xc,%esp
    3a64:	8d 45 e6             	lea    -0x1a(%ebp),%eax
    3a67:	88 5d e6             	mov    %bl,-0x1a(%ebp)
    3a6a:	6a 01                	push   $0x1
    3a6c:	50                   	push   %eax
    3a6d:	57                   	push   %edi
    3a6e:	83 c6 01             	add    $0x1,%esi
    3a71:	e8 cc fd ff ff       	call   3842 <write>
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3a76:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
#include "user.h"
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3a81:	75 8d                	jne    3a10 <printf+0x60>
        putc(fd, c);
      }
      state = 0;
    }
    ...
    3a8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      ...
      if(c == 'd'){
        ...
        printint(fd, *ap, 16, 0);
    3a90:	83 ec 0c             	sub    $0xc,%esp
    3a93:	b9 10 00 00 00       	mov    $0x10,%ecx
    3a98:	6a 00                	push   $0x0
    3a9a:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    3a9d:	89 f8                	mov    %edi,%eax
    3a9f:	8b 13                	mov    (%ebx),%edx
    3aa1:	e8 6a fe ff ff       	call   3910 <printint>
        ap++;
    ...
    3aab:	31 d2                	xor    %edx,%edx
      if(c == 'd'){
        ...
        printint(fd, *ap, 16, 0);
        ap++;
    3aad:	83 c0 04             	add    $0x4,%eax
    3ab0:	89 45 d0             	mov    %eax,-0x30(%ebp)
    3ab3:	e9 4d ff ff ff       	jmp    3a05 <printf+0x55>
    3ab8:	90                   	nop
    3ab9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      } else if(c == 's'){
        s = (char*)*ap;
    3ac0:	8b 45 d0             	mov    -0x30(%ebp),%eax
    3ac3:	8b 18                	mov    (%eax),%ebx
        ap++;
    3ac5:	83 c0 04             	add    $0x4,%eax
    3ac8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
    3acb:	b8 44 54 00 00       	mov    $0x5444,%eax
    3ad0:	85 db                	test   %ebx,%ebx
    3ad2:	0f 44 d8             	cmove  %eax,%ebx
        while(*s != 0){
    3ad5:	0f b6 03             	movzbl (%ebx),%eax
    3ad8:	84 c0                	test   %al,%al
    3ada:	74 23                	je     3aff <printf+0x14f>
    3adc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3ae0:	88 45 e3             	mov    %al,-0x1d(%ebp)
#include "user.h"
...
{
  write(fd, &c, 1);
    3ae3:	8d 45 e3             	lea    -0x1d(%ebp),%eax
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    3aee:	50                   	push   %eax
    3aef:	57                   	push   %edi
    3af0:	e8 4d fd ff ff       	call   3842 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    3af5:	0f b6 03             	movzbl (%ebx),%eax
    3af8:	83 c4 10             	add    $0x10,%esp
    3afb:	84 c0                	test   %al,%al
    3afd:	75 e1                	jne    3ae0 <printf+0x130>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
    ...
    3b01:	e9 ff fe ff ff       	jmp    3a05 <printf+0x55>
    3b06:	8d 76 00             	lea    0x0(%esi),%esi
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    3b13:	88 5d e5             	mov    %bl,-0x1b(%ebp)
    3b16:	8d 45 e5             	lea    -0x1b(%ebp),%eax
    3b19:	6a 01                	push   $0x1
    3b1b:	e9 4c ff ff ff       	jmp    3a6c <printf+0xbc>
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
    ...
    3b28:	6a 01                	push   $0x1
    3b2a:	e9 6b ff ff ff       	jmp    3a9a <printf+0xea>
    3b2f:	8b 5d d0             	mov    -0x30(%ebp),%ebx
#include "user.h"
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    3b35:	8b 03                	mov    (%ebx),%eax
    3b37:	6a 01                	push   $0x1
    3b39:	88 45 e4             	mov    %al,-0x1c(%ebp)
    3b3c:	8d 45 e4             	lea    -0x1c(%ebp),%eax
    3b3f:	50                   	push   %eax
    3b40:	57                   	push   %edi
    3b41:	e8 fc fc ff ff       	call   3842 <write>
    3b46:	e9 5b ff ff ff       	jmp    3aa6 <printf+0xf6>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3b51:	a1 c0 5d 00 00       	mov    0x5dc0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    3b60:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3b63:	39 c8                	cmp    %ecx,%eax
    3b65:	73 19                	jae    3b80 <free+0x30>
    3b67:	89 f6                	mov    %esi,%esi
    3b69:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    3b70:	39 d1                	cmp    %edx,%ecx
    3b72:	72 1c                	jb     3b90 <free+0x40>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3b74:	39 d0                	cmp    %edx,%eax
    3b76:	73 18                	jae    3b90 <free+0x40>
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3b7e:	72 f0                	jb     3b70 <free+0x20>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3b80:	39 d0                	cmp    %edx,%eax
    3b82:	72 f4                	jb     3b78 <free+0x28>
    3b84:	39 d1                	cmp    %edx,%ecx
    3b86:	73 f0                	jae    3b78 <free+0x28>
    3b88:	90                   	nop
    3b89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      break;
  if(bp + bp->s.size == p->s.ptr){
    3b90:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3b93:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3b96:	39 d7                	cmp    %edx,%edi
    3b98:	74 19                	je     3bb3 <free+0x63>
  ...
  if(p + p->s.size == bp){
    ...
    3ba5:	74 23                	je     3bca <free+0x7a>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    3ba7:	89 08                	mov    %ecx,(%eax)
  freep = p;
    3ba9:	a3 c0 5d 00 00       	mov    %eax,0x5dc0
}
    3bae:	5b                   	pop    %ebx
    3baf:	5e                   	pop    %esi
    3bb0:	5f                   	pop    %edi
  ...
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    3bb3:	03 72 04             	add    0x4(%edx),%esi
    3bb6:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3bb9:	8b 10                	mov    (%eax),%edx
    3bbb:	8b 12                	mov    (%edx),%edx
    3bbd:	89 53 f8             	mov    %edx,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    3bc0:	8b 50 04             	mov    0x4(%eax),%edx
    3bc3:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3bc6:	39 f1                	cmp    %esi,%ecx
    3bc8:	75 dd                	jne    3ba7 <free+0x57>
    p->s.size += bp->s.size;
    ...
    p->s.ptr = bp;
  freep = p;
    3bcd:	a3 c0 5d 00 00       	mov    %eax,0x5dc0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp->s.ptr;
    3bd5:	8b 53 f8             	mov    -0x8(%ebx),%edx
    3bd8:	89 10                	mov    %edx,(%eax)
  } else
    p->s.ptr = bp;
  freep = p;
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    3bfd:	0f 84 a3 00 00 00    	je     3ca6 <malloc+0xc6>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3c0a:	76 74                	jbe    3c80 <malloc+0xa0>
    3c0c:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
    3c12:	be 00 10 00 00       	mov    $0x1000,%esi
    3c17:	8d 1c fd 00 00 00 00 	lea    0x0(,%edi,8),%ebx
    3c1e:	0f 43 f7             	cmovae %edi,%esi
    3c21:	ba 00 80 00 00       	mov    $0x8000,%edx
    3c26:	81 ff ff 0f 00 00    	cmp    $0xfff,%edi
    3c2c:	0f 46 da             	cmovbe %edx,%ebx
    3c2f:	eb 10                	jmp    3c41 <malloc+0x61>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
    3c3a:	8b 48 04             	mov    0x4(%eax),%ecx
    3c3d:	39 cf                	cmp    %ecx,%edi
    3c3f:	76 3f                	jbe    3c80 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    3c41:	39 05 c0 5d 00 00    	cmp    %eax,0x5dc0
    3c47:	89 c2                	mov    %eax,%edx
    3c49:	75 ed                	jne    3c38 <malloc+0x58>
  char *p;
  Header *hp;
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3c4e:	53                   	push   %ebx
    3c4f:	e8 56 fc ff ff       	call   38aa <sbrk>
  if(p == (char*)-1)
    3c54:	83 c4 10             	add    $0x10,%esp
    3c57:	83 f8 ff             	cmp    $0xffffffff,%eax
    3c5a:	74 1c                	je     3c78 <malloc+0x98>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    3c5c:	89 70 04             	mov    %esi,0x4(%eax)
  free((void*)(hp + 1));
    3c5f:	83 ec 0c             	sub    $0xc,%esp
    3c62:	83 c0 08             	add    $0x8,%eax
    3c65:	50                   	push   %eax
    3c66:	e8 e5 fe ff ff       	call   3b50 <free>
  return freep;
    3c6b:	8b 15 c0 5d 00 00    	mov    0x5dc0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
    ...
    3c76:	75 c0                	jne    3c38 <malloc+0x58>
        return 0;
    3c78:	31 c0                	xor    %eax,%eax
    3c7a:	eb 1c                	jmp    3c98 <malloc+0xb8>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    3c80:	39 cf                	cmp    %ecx,%edi
    3c82:	74 1c                	je     3ca0 <malloc+0xc0>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    3c84:	29 f9                	sub    %edi,%ecx
    3c86:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    3c89:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    3c8c:	89 78 04             	mov    %edi,0x4(%eax)
      }
      freep = prevp;
    3c8f:	89 15 c0 5d 00 00    	mov    %edx,0x5dc0
      return (void*)(p + 1);
    3c95:	83 c0 08             	add    $0x8,%eax
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
        return 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
        prevp->s.ptr = p->s.ptr;
    3ca0:	8b 08                	mov    (%eax),%ecx
    3ca2:	89 0a                	mov    %ecx,(%edx)
    3ca4:	eb e9                	jmp    3c8f <malloc+0xaf>
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    3ca6:	c7 05 c0 5d 00 00 c4 	movl   $0x5dc4,0x5dc0
    3cad:	5d 00 00 
    3cb0:	c7 05 c4 5d 00 00 c4 	movl   $0x5dc4,0x5dc4
    3cb7:	5d 00 00 
    base.s.size = 0;
    3cba:	b8 c4 5d 00 00       	mov    $0x5dc4,%eax
    3cbf:	c7 05 c8 5d 00 00 00 	movl   $0x0,0x5dc8
    3cc6:	00 00 00 
    3cc9:	e9 3e ff ff ff       	jmp    3c0c <malloc+0x2c>
