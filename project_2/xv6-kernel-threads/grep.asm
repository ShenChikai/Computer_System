...
putc(int fd, char c)
{
 ...
 6c8:	e8 b5 fe ff ff       	call   582 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 738:	50                   	push   %eax
 739:	57                   	push   %edi
 73a:	e8 43 fe ff ff       	call   582 <write>
...
putc(int fd, char c)
{
 ...
 79a:	50                   	push   %eax
 79b:	57                   	push   %edi
 79c:	e8 e1 fd ff ff       	call   582 <write>
 ...
 7b1:	e8 cc fd ff ff       	call   582 <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 87f:	50                   	push   %eax
 880:	57                   	push   %edi
 881:	e8 fc fc ff ff       	call   582 <write>
...
malloc(uint nbytes)
{
 ...
 98e:	53                   	push   %ebx
 98f:	e8 56 fc ff ff       	call   5ea <sbrk>
  if(p == (char*)-1)
