...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ef:	f7 f6                	div    %esi
 3f1:	0f b6 92 a4 07 00 00 	movzbl 0x7a4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 568:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 56b:	b8 9d 07 00 00       	mov    $0x79d,%eax
...
free(void *ap)
{
 ...
 647:	89 08                	mov    %ecx,(%eax)
  freep = p;
 649:	a3 48 0a 00 00       	mov    %eax,0xa48
}
 64e:	5b                   	pop    %ebx
 64f:	5e                   	pop    %esi
 650:	5f                   	pop    %edi
 ...
 66a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 66d:	a3 48 0a 00 00       	mov    %eax,0xa48
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6df:	76 3f                	jbe    720 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	39 05 48 0a 00 00    	cmp    %eax,0xa48
 ...
 706:	e8 e5 fe ff ff       	call   5f0 <free>
  return freep;
 70b:	8b 15 48 0a 00 00    	mov    0xa48,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 72c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 72f:	89 15 48 0a 00 00    	mov    %edx,0xa48
      return (void*)(p + 1);
 ...
 744:	eb e9                	jmp    72f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 746:	c7 05 48 0a 00 00 4c 	movl   $0xa4c,0xa48
 74d:	0a 00 00 
 750:	c7 05 4c 0a 00 00 4c 	movl   $0xa4c,0xa4c
 757:	0a 00 00 
    base.s.size = 0;
 75a:	b8 4c 0a 00 00       	mov    $0xa4c,%eax
 75f:	c7 05 50 0a 00 00 00 	movl   $0x0,0xa50
 766:	00 00 00 
