...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     199:	ff 24 85 88 12 00 00 	jmp    *0x1288(,%eax,4)
    runcmd(lcmd->right);
    break;
...
fork1(void)
{
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     236:	68 da 11 00 00       	push   $0x11da
     23b:	6a 02                	push   $0x2
     23d:	e8 6e 0c 00 00       	call   eb0 <printf>
    break;
...
fork1(void)
{
  ...
  default:
    panic("runcmd");
     ...
     292:	68 d3 11 00 00       	push   $0x11d3
     297:	e8 c4 fe ff ff       	call   160 <panic>
{
  ...
  if(pid == -1)
    panic("fork");
     ...
     29f:	68 fa 11 00 00       	push   $0x11fa
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     2ad:	68 ea 11 00 00       	push   $0x11ea
     2b2:	6a 02                	push   $0x2
     2b4:	e8 f7 0b 00 00       	call   eb0 <printf>
      exit();
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     2c1:	68 ff 11 00 00       	push   $0x11ff
     ...
     341:	c3                   	ret    
{
  ...
  if(pid == -1)
    panic("fork");
     ...
     345:	68 fa 11 00 00       	push   $0x11fa
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     357:	6a 54                	push   $0x54
     359:	e8 82 0d 00 00       	call   10e0 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3d7:	6a 0c                	push   $0xc
     3d9:	e8 02 0d 00 00       	call   10e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     4a0:	83 c7 01             	add    $0x1,%edi
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4b1:	50                   	push   %eax
     4b2:	68 78 18 00 00       	push   $0x1878
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     505:	50                   	push   %eax
     506:	68 78 18 00 00       	push   $0x1878
  ...
  *ps = s;
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     556:	50                   	push   %eax
     557:	68 70 18 00 00       	push   $0x1870
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     575:	50                   	push   %eax
     576:	68 78 18 00 00       	push   $0x1878
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     61d:	50                   	push   %eax
     61e:	68 78 18 00 00       	push   $0x1878
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     673:	68 21 12 00 00       	push   $0x1221
     678:	53                   	push   %ebx
     679:	56                   	push   %esi
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     6fe:	68 04 12 00 00       	push   $0x1204
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     71f:	68 24 12 00 00       	push   $0x1224
     724:	57                   	push   %edi
     725:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     776:	68 3b 12 00 00       	push   $0x123b
     77b:	57                   	push   %edi
     77c:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     7c2:	68 2d 12 00 00       	push   $0x122d
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     80d:	68 26 12 00 00       	push   $0x1226
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     83b:	68 40 12 00 00       	push   $0x1240
     840:	56                   	push   %esi
     841:	53                   	push   %ebx
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     8cb:	68 42 12 00 00       	push   $0x1242
     8d0:	56                   	push   %esi
     8d1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8e1:	68 3e 12 00 00       	push   $0x123e
     8e6:	56                   	push   %esi
     8e7:	53                   	push   %ebx
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     93f:	68 24 12 00 00       	push   $0x1224
     944:	56                   	push   %esi
     945:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     96b:	68 60 12 00 00       	push   $0x1260
     970:	56                   	push   %esi
     971:	53                   	push   %ebx
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    panic("parseblock");
     ...
     99f:	68 44 12 00 00       	push   $0x1244
  ...
  if(!peek(ps, es, ")"))
    panic("syntax - missing )");
     ...
     9ac:	68 4f 12 00 00       	push   $0x124f
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9d9:	ff 24 85 a0 12 00 00 	jmp    *0x12a0(,%eax,4)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     a97:	68 e9 11 00 00       	push   $0x11e9
     a9c:	53                   	push   %ebx
     a9d:	50                   	push   %eax
  ...
  if(s != es){
    printf(2, "leftovers: %s\n", s);
     abf:	52                   	push   %edx
     ac0:	50                   	push   %eax
     ac1:	68 62 12 00 00       	push   $0x1262
     ac6:	6a 02                	push   $0x2
     ac8:	e8 e3 03 00 00       	call   eb0 <printf>
    panic("syntax");
     acd:	c7 04 24 26 12 00 00 	movl   $0x1226,(%esp)
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     ...
     e88:	e8 b5 fe ff ff       	call   d42 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     ...
     ef8:	50                   	push   %eax
     ef9:	57                   	push   %edi
     efa:	e8 43 fe ff ff       	call   d42 <write>
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     ...
     f5a:	50                   	push   %eax
     f5b:	57                   	push   %edi
     f5c:	e8 e1 fd ff ff       	call   d42 <write>
     ...
     f71:	e8 cc fd ff ff       	call   d42 <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     fee:	50                   	push   %eax
     fef:	57                   	push   %edi
     ff0:	e8 4d fd ff ff       	call   d42 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    103f:	50                   	push   %eax
    1040:	57                   	push   %edi
    1041:	e8 fc fc ff ff       	call   d42 <write>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1051:	a1 e4 18 00 00       	mov    0x18e4,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
    10a9:	a3 e4 18 00 00       	mov    %eax,0x18e4
}
    10ae:	5b                   	pop    %ebx
    10af:	5e                   	pop    %esi
    10b0:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    10cd:	a3 e4 18 00 00       	mov    %eax,0x18e4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    10ec:	8b 15 e4 18 00 00    	mov    0x18e4,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1141:	39 05 e4 18 00 00    	cmp    %eax,0x18e4
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    114e:	53                   	push   %ebx
    114f:	e8 56 fc ff ff       	call   daa <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    116b:	8b 15 e4 18 00 00    	mov    0x18e4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    118c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
    118f:	89 15 e4 18 00 00    	mov    %edx,0x18e4
      return (void*)(p + 1);
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    11a6:	c7 05 e4 18 00 00 e8 	movl   $0x18e8,0x18e4
    11ad:	18 00 00 
    11b0:	c7 05 e8 18 00 00 e8 	movl   $0x18e8,0x18e8
    11b7:	18 00 00 
    base.s.size = 0;
    11ba:	b8 e8 18 00 00       	mov    $0x18e8,%eax
    11bf:	c7 05 ec 18 00 00 00 	movl   $0x0,0x18ec
    11c6:	00 00 00 
