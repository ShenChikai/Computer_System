...
int main(void) {
   ...
   e:	51                   	push   %ecx
	...
	for (int f = 0; f < 4; f++) {
		forkedRet = fork();	
   f:	e8 b6 02 00 00       	call   2ca <fork>
  14:	e8 b1 02 00 00       	call   2ca <fork>
  19:	e8 ac 02 00 00       	call   2ca <fork>
  1e:	e8 a7 02 00 00       	call   2ca <fork>
	}

	if (forkedRet > 0) {
  23:	85 c0                	test   %eax,%eax
  25:	7e 27                	jle    4e <main+0x4e>
  ...
  30:	e8 1d 03 00 00       	call   352 <getpid>
  35:	50                   	push   %eax
  36:	53                   	push   %ebx
	}
  ...
  37:	83 c3 01             	add    $0x1,%ebx
			printf(1, "Line %d, pid = %d.", i, getpid());
  3a:	68 40 07 00 00       	push   $0x740
  3f:	6a 01                	push   $0x1
  41:	e8 da 03 00 00       	call   420 <printf>
	}
  ...
  4c:	75 e2                	jne    30 <main+0x30>
		...
		// getpinfo()
		getpinfo(getpid());
  4e:	e8 ff 02 00 00       	call   352 <getpid>
  53:	83 ec 0c             	sub    $0xc,%esp
  56:	50                   	push   %eax
  57:	e8 16 03 00 00       	call   372 <getpinfo>
  5c:	83 c4 10             	add    $0x10,%esp
	...
	for (int f = 0; f < 4; f++) {
		wait();	// wait for child
  5f:	e8 76 02 00 00       	call   2da <wait>
  64:	e8 71 02 00 00       	call   2da <wait>
  69:	e8 6c 02 00 00       	call   2da <wait>
  6e:	e8 67 02 00 00       	call   2da <wait>
	}

	wait();
  73:	e8 62 02 00 00       	call   2da <wait>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 5c 07 00 00 	movzbl 0x75c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 53 07 00 00       	mov    $0x753,%eax
