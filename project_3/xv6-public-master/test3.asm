...
int main(void) {
  ...
  1b:	6a 02                	push   $0x2
  1d:	e8 f0 02 00 00       	call   312 <sleep>
#include "stat.h"
#include "types.h"
...
int main(void) {
  ...
  28:	75 ee                	jne    18 <main+0x18>
		sleep(2);
	}

	getpinfo(getpid());
  2a:	e8 d3 02 00 00       	call   302 <getpid>
  2f:	83 ec 0c             	sub    $0xc,%esp
  32:	50                   	push   %eax
  33:	e8 ea 02 00 00       	call   322 <getpinfo>

	exit();
  38:	e8 45 02 00 00       	call   282 <exit>
  3d:	66 90                	xchg   %ax,%ax
  3f:	90                   	nop
