...
_testfs:     file format elf32-i386
...
main()
{
  ...
  93:	53                   	push   %ebx
  94:	68 1b 08 00 00       	push   $0x81b
  99:	6a 01                	push   $0x1
  9b:	e8 50 04 00 00       	call   4f0 <printf>
 ...
 104:	6a 02                	push   $0x2
 106:	e8 e5 03 00 00       	call   4f0 <printf>
      exit();
 ...
 110:	51                   	push   %ecx
 111:	51                   	push   %ecx
 112:	68 2e 08 00 00       	push   $0x82e
 117:	6a 01                	push   $0x1
 119:	e8 d2 03 00 00       	call   4f0 <printf>
 ...
 123:	57                   	push   %edi
 124:	50                   	push   %eax
 125:	68 ac 08 00 00       	push   $0x8ac
 12a:	6a 02                	push   $0x2
 12c:	e8 bf 03 00 00       	call   4f0 <printf>
             *(int*)buf, i);
      exit();
 ...
 149:	52                   	push   %edx
 14a:	52                   	push   %edx
 14b:	68 80 08 00 00       	push   $0x880
 150:	6a 02                	push   $0x2
 152:	e8 99 03 00 00       	call   4f0 <printf>
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48f:	f7 f6                	div    %esi
 491:	0f b6 92 e4 08 00 00 	movzbl 0x8e4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 608:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 60b:	b8 dc 08 00 00       	mov    $0x8dc,%eax
...
free(void *ap)
{
 ...
 6e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6e9:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 6ee:	5b                   	pop    %ebx
 6ef:	5e                   	pop    %esi
 6f0:	5f                   	pop    %edi
 ...
 70a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 70d:	a3 88 0b 00 00       	mov    %eax,0xb88
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 88 0b 00 00    	mov    0xb88,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 77f:	76 3f                	jbe    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	39 05 88 0b 00 00    	cmp    %eax,0xb88
 ...
 7a6:	e8 e5 fe ff ff       	call   690 <free>
  return freep;
 7ab:	8b 15 88 0b 00 00    	mov    0xb88,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7cc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7cf:	89 15 88 0b 00 00    	mov    %edx,0xb88
      return (void*)(p + 1);
 ...
 7e4:	eb e9                	jmp    7cf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7e6:	c7 05 88 0b 00 00 8c 	movl   $0xb8c,0xb88
 7ed:	0b 00 00 
 7f0:	c7 05 8c 0b 00 00 8c 	movl   $0xb8c,0xb8c
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	b8 8c 0b 00 00       	mov    $0xb8c,%eax
 7ff:	c7 05 90 0b 00 00 00 	movl   $0x0,0xb90
 806:	00 00 00 
