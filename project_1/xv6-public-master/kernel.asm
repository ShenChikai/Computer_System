...
80100044:	bb f4 b7 10 80       	mov    $0x8010b7f4,%ebx
  struct buf head;
} bcache;
...
80100051:	68 c0 b7 10 80       	push   $0x8010b7c0
80100056:	e8 95 41 00 00       	call   801041f0 <initlock>

//PAGEBREAK!
  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
8010005b:	c7 05 0c ff 10 80 bc 	movl   $0x8010febc,0x8010ff0c
80100062:	fe 10 80 
  bcache.head.next = &bcache.head;
80100065:	c7 05 10 ff 10 80 bc 	movl   $0x8010febc,0x8010ff10
8010006c:	fe 10 80 
8010006f:	83 c4 10             	add    $0x10,%esp
80100072:	ba bc fe 10 80       	mov    $0x8010febc,%edx
...
801000aa:	8d 83 5c 02 00 00    	lea    0x25c(%ebx),%eax
    ...
    bcache.head.next->prev = b;
    bcache.head.next = b;
801000b0:	89 1d 10 ff 10 80    	mov    %ebx,0x8010ff10
...
//PAGEBREAK!
  ...
  bcache.head.next = &bcache.head;
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
801000b6:	3d bc fe 10 80       	cmp    $0x8010febc,%eax
...
bget(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
801000df:	68 c0 b7 10 80       	push   $0x8010b7c0
801000e4:	e8 67 42 00 00       	call   80104350 <acquire>

  // Is the block already cached?
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
801000e9:	8b 1d 10 ff 10 80    	mov    0x8010ff10,%ebx
801000ef:	83 c4 10             	add    $0x10,%esp
801000f2:	81 fb bc fe 10 80    	cmp    $0x8010febc,%ebx
801000f8:	75 11                	jne    8010010b <bread+0x3b>
801000fa:	eb 24                	jmp    80100120 <bread+0x50>
801000fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80100100:	8b 5b 54             	mov    0x54(%ebx),%ebx
80100103:	81 fb bc fe 10 80    	cmp    $0x8010febc,%ebx
...
80100120:	8b 1d 0c ff 10 80    	mov    0x8010ff0c,%ebx
80100126:	81 fb bc fe 10 80    	cmp    $0x8010febc,%ebx
8010012c:	75 0d                	jne    8010013b <bread+0x6b>
8010012e:	eb 60                	jmp    80100190 <bread+0xc0>
80100130:	8b 5b 50             	mov    0x50(%ebx),%ebx
80100133:	81 fb bc fe 10 80    	cmp    $0x8010febc,%ebx
...
8010015d:	68 c0 b7 10 80       	push   $0x8010b7c0
...
801001ff:	e8 5c 3f 00 00       	call   80104160 <releasesleep>
  ...
  acquire(&bcache.lock);
80100204:	c7 04 24 c0 b7 10 80 	movl   $0x8010b7c0,(%esp)
...
8010022f:	89 50 54             	mov    %edx,0x54(%eax)
    b->next = bcache.head.next;
80100232:	a1 10 ff 10 80       	mov    0x8010ff10,%eax
    b->prev = &bcache.head;
80100237:	c7 43 50 bc fe 10 80 	movl   $0x8010febc,0x50(%ebx)
  b->refcnt--;
  if (b->refcnt == 0) {
    // no one is waiting for it.
    b->next->prev = b->prev;
...
8010023e:	89 43 54             	mov    %eax,0x54(%ebx)
    b->prev = &bcache.head;
    bcache.head.next->prev = b;
80100241:	a1 10 ff 10 80       	mov    0x8010ff10,%eax
80100246:	89 58 50             	mov    %ebx,0x50(%eax)
    bcache.head.next = b;
80100249:	89 1d 10 ff 10 80    	mov    %ebx,0x8010ff10
  }
  
  release(&bcache.lock);
8010024f:	c7 45 08 c0 b7 10 80 	movl   $0x8010b7c0,0x8(%ebp)
}
...
80100280:	e8 bb 14 00 00       	call   80101740 <iunlock>
  target = n;
  acquire(&cons.lock);
80100285:	c7 04 24 20 a7 10 80 	movl   $0x8010a720,(%esp)
...
801002a1:	a1 a0 01 11 80       	mov    0x801101a0,%eax
801002a6:	3b 05 a4 01 11 80    	cmp    0x801101a4,%eax
...
801002b3:	68 20 a7 10 80       	push   $0x8010a720
801002b8:	68 a0 01 11 80       	push   $0x801101a0
801002bd:	e8 8e 3a 00 00       	call   80103d50 <sleep>
  ...
  while(n > 0){
    while(input.r == input.w){
801002c2:	a1 a0 01 11 80       	mov    0x801101a0,%eax
801002c7:	83 c4 10             	add    $0x10,%esp
801002ca:	3b 05 a4 01 11 80    	cmp    0x801101a4,%eax
...
801002e1:	68 20 a7 10 80       	push   $0x8010a720
...
8010030b:	89 15 a0 01 11 80    	mov    %edx,0x801101a0
80100311:	89 c2                	mov    %eax,%edx
80100313:	83 e2 7f             	and    $0x7f,%edx
80100316:	0f be 92 20 01 11 80 	movsbl -0x7feefee0(%edx),%edx
    if(c == C('D')){  // EOF
...
80100341:	68 20 a7 10 80       	push   $0x8010a720
...
8010035e:	76 05                	jbe    80100365 <consoleread+0xf5>
        ...
        // caller gets a 0-byte result.
        input.r--;
80100360:	a3 a0 01 11 80       	mov    %eax,0x801101a0
...
80100378:	fa                   	cli    
  ...
  cli();
  cons.locking = 0;
80100379:	c7 05 54 a7 10 80 00 	movl   $0x0,0x8010a754
80100380:	00 00 00 
...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 df 79 10 80 	movl   $0x801079df,(%esp)
...
801003d9:	c7 05 58 a7 10 80 01 	movl   $0x1,0x8010a758
801003e0:	00 00 00 
...
{
  if(panicked){
801003f0:	8b 15 58 a7 10 80    	mov    0x8010a758,%edx
...
8010060f:	e8 2c 11 00 00       	call   80101740 <iunlock>
  acquire(&cons.lock);
80100614:	c7 04 24 20 a7 10 80 	movl   $0x8010a720,(%esp)
...
80100642:	68 20 a7 10 80       	push   $0x8010a720
...
80100669:	a1 54 a7 10 80       	mov    0x8010a754,%eax
  if(locking)
...
80100708:	68 20 a7 10 80       	push   $0x8010a720
...
801007c3:	68 20 a7 10 80       	push   $0x8010a720
...
801007fb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&cons.lock);
801007fe:	68 20 a7 10 80       	push   $0x8010a720
...
8010082f:	75 54                	jne    80100885 <consoleintr+0x95>
    ...
    case C('H'): case '\x7f':  // Backspace
      if(input.e != input.w){
80100831:	a1 a8 01 11 80       	mov    0x801101a8,%eax
80100836:	3b 05 a4 01 11 80    	cmp    0x801101a4,%eax
8010083c:	74 d2                	je     80100810 <consoleintr+0x20>
        input.e--;
8010083e:	83 e8 01             	sub    $0x1,%eax
80100841:	a3 a8 01 11 80       	mov    %eax,0x801101a8
        consputc(BACKSPACE);
...
80100863:	68 20 a7 10 80       	push   $0x8010a720
...
80100889:	a1 a8 01 11 80       	mov    0x801101a8,%eax
8010088e:	89 c2                	mov    %eax,%edx
80100890:	2b 15 a0 01 11 80    	sub    0x801101a0,%edx
...
801008a5:	83 ff 0d             	cmp    $0xd,%edi
        input.buf[input.e++ % INPUT_BUF] = c;
801008a8:	89 15 a8 01 11 80    	mov    %edx,0x801101a8
        consputc(BACKSPACE);
      }
      break;
    default:
...
801008b6:	88 88 20 01 11 80    	mov    %cl,-0x7feefee0(%eax)
        consputc(c);
...
801008d5:	a1 a0 01 11 80       	mov    0x801101a0,%eax
801008da:	83 e8 80             	sub    $0xffffff80,%eax
801008dd:	39 05 a8 01 11 80    	cmp    %eax,0x801101a8
...
801008e9:	83 ec 0c             	sub    $0xc,%esp
      if(c != 0 && input.e-input.r < INPUT_BUF){
        ...
        if(c == '\n' || c == C('D') || input.e == input.r+INPUT_BUF){
          input.w = input.e;
801008ec:	a3 a4 01 11 80       	mov    %eax,0x801101a4
          wakeup(&input.r);
801008f1:	68 a0 01 11 80       	push   $0x801101a0
...
80100908:	a1 a8 01 11 80       	mov    0x801101a8,%eax
8010090d:	39 05 a4 01 11 80    	cmp    %eax,0x801101a4
80100913:	75 2b                	jne    80100940 <consoleintr+0x150>
80100915:	e9 f6 fe ff ff       	jmp    80100810 <consoleintr+0x20>
8010091a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            input.buf[(input.e-1) % INPUT_BUF] != '\n'){
        input.e--;
80100920:	a3 a8 01 11 80       	mov    %eax,0x801101a8
        consputc(BACKSPACE);
...
8010092a:	e8 c1 fa ff ff       	call   801003f0 <consputc>
    ...
    case C('U'):  // Kill line.
      while(input.e != input.w &&
8010092f:	a1 a8 01 11 80       	mov    0x801101a8,%eax
80100934:	3b 05 a4 01 11 80    	cmp    0x801101a4,%eax
...
80100945:	83 e2 7f             	and    $0x7f,%edx
    ...
    case C('U'):  // Kill line.
      while(input.e != input.w &&
80100948:	80 ba 20 01 11 80 0a 	cmpb   $0xa,-0x7feefee0(%edx)
...
80100977:	e9 84 36 00 00       	jmp    80104000 <procdump>
    ...
    default:
      if(c != 0 && input.e-input.r < INPUT_BUF){
        c = (c == '\r') ? '\n' : c;
        input.buf[input.e++ % INPUT_BUF] = c;
8010097c:	c6 80 20 01 11 80 0a 	movb   $0xa,-0x7feefee0(%eax)
        consputc(c);
80100983:	b8 0a 00 00 00       	mov    $0xa,%eax
80100988:	e8 63 fa ff ff       	call   801003f0 <consputc>
8010098d:	a1 a8 01 11 80       	mov    0x801101a8,%eax
...
801009ab:	68 20 a7 10 80       	push   $0x8010a720
...
consoleinit(void)
{
  ...
  devsw[CONSOLE].write = consolewrite;
801009bb:	c7 05 6c 0b 11 80 00 	movl   $0x80100600,0x80110b6c
801009c2:	06 10 80 
  devsw[CONSOLE].read = consoleread;
801009c5:	c7 05 68 0b 11 80 70 	movl   $0x80100270,0x80110b68
801009cc:	02 10 80 
  cons.locking = 1;
801009cf:	c7 05 54 a7 10 80 01 	movl   $0x1,0x8010a754
801009d6:	00 00 00 
...
80100a72:	75 d2                	jne    80100a46 <exec+0x56>
  ...
  if((pgdir = setupkvm()) == 0)
80100a74:	e8 17 63 00 00       	call   80106d90 <setupkvm>
...
80100b04:	e8 d7 60 00 00       	call   80106be0 <allocuvm>
...
80100b3a:	e8 e1 5f 00 00       	call   80106b20 <loaduvm>
...
80100b59:	e8 b2 61 00 00       	call   80106d10 <freevm>
...
80100b95:	e8 46 60 00 00       	call   80106be0 <allocuvm>
...
80100bac:	e8 5f 61 00 00       	call   80106d10 <freevm>
...
80100bf1:	e8 3a 62 00 00       	call   80106e30 <clearpteu>
  sp = sz;
...
80100c51:	e8 4a 63 00 00       	call   80106fa0 <copyout>
...
80100cb5:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cbb:	e8 e0 62 00 00       	call   80106fa0 <copyout>
...
80100d2c:	e8 5f 5c 00 00       	call   80106990 <switchuvm>
  freevm(oldpgdir);
80100d31:	89 3c 24             	mov    %edi,(%esp)
80100d34:	e8 d7 5f 00 00       	call   80106d10 <freevm>
  return 0;
...
80100d56:	68 cd 70 10 80       	push   $0x801070cd
80100d5b:	68 c0 01 11 80       	push   $0x801101c0
...
80100d74:	bb f4 01 11 80       	mov    $0x801101f4,%ebx
}
...
80100d79:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&ftable.lock);
80100d7c:	68 c0 01 11 80       	push   $0x801101c0
...
80100d93:	81 fb 54 0b 11 80    	cmp    $0x80110b54,%ebx
...
80100da5:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100dac:	68 c0 01 11 80       	push   $0x801101c0
...
80100dc3:	68 c0 01 11 80       	push   $0x801101c0
...
80100de7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100dea:	68 c0 01 11 80       	push   $0x801101c0
...
80100e04:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100e07:	68 c0 01 11 80       	push   $0x801101c0
...
80100e1b:	68 d4 70 10 80       	push   $0x801070d4
...
80100e39:	8b 7d 08             	mov    0x8(%ebp),%edi
  ...
  acquire(&ftable.lock);
80100e3c:	68 c0 01 11 80       	push   $0x801101c0
...
80100e5c:	74 1a                	je     80100e78 <fileclose+0x48>
    release(&ftable.lock);
80100e5e:	c7 45 08 c0 01 11 80 	movl   $0x801101c0,0x8(%ebp)
...
80100e8d:	8b 47 10             	mov    0x10(%edi),%eax
  ...
  f->type = FD_NONE;
  release(&ftable.lock);
80100e90:	68 c0 01 11 80       	push   $0x801101c0
    panic("fileclose");
  if(--f->ref > 0){
    release(&ftable.lock);
    return;
...
80100ef2:	68 dc 70 10 80       	push   $0x801070dc
...
80100fd2:	68 e6 70 10 80       	push   $0x801070e6
...
801010e4:	68 ef 70 10 80       	push   $0x801070ef
...
801010f1:	68 f5 70 10 80       	push   $0x801070f5
...
8010110a:	03 15 d8 0b 11 80    	add    0x80110bd8,%edx
...
80101165:	68 ff 70 10 80       	push   $0x801070ff
...
80101179:	8b 0d c0 0b 11 80    	mov    0x80110bc0,%ecx
// Blocks.
...
8010119c:	03 05 d8 0b 11 80    	add    0x80110bd8,%eax
...
801011ae:	a1 c0 0b 11 80       	mov    0x80110bc0,%eax
...
80101207:	39 05 c0 0b 11 80    	cmp    %eax,0x80110bc0
...
80101212:	68 12 71 10 80       	push   $0x80107112
...
8010128a:	bb 14 0c 11 80       	mov    $0x80110c14,%ebx
// Find the inode with number inum on device dev
// and return the in-memory copy. Does not lock
// the inode and does not read it from disk.
static struct inode*
...
80101292:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  acquire(&icache.lock);
80101295:	68 e0 0b 11 80       	push   $0x80110be0
...
801012ba:	81 fb 34 28 11 80    	cmp    $0x80112834,%ebx
...
801012d8:	89 de                	mov    %ebx,%esi
  ...
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
    if(ip->ref > 0 && ip->dev == dev && ip->inum == inum){
      ip->ref++;
      release(&icache.lock);
801012da:	68 e0 0b 11 80       	push   $0x80110be0
...
80101303:	81 fb 34 28 11 80    	cmp    $0x80112834,%ebx
...
80101323:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
8010132a:	68 e0 0b 11 80       	push   $0x80110be0
...
80101344:	68 28 71 10 80       	push   $0x80107128
...
8010140a:	68 38 71 10 80       	push   $0x80107138
...
80101464:	bb 20 0c 11 80       	mov    $0x80110c20,%ebx
80101469:	83 ec 0c             	sub    $0xc,%esp
  int i = 0;
  
  initlock(&icache.lock, "icache");
8010146c:	68 4b 71 10 80       	push   $0x8010714b
80101471:	68 e0 0b 11 80       	push   $0x80110be0
...
80101483:	68 52 71 10 80       	push   $0x80107152
...
80101497:	81 fb 40 28 11 80    	cmp    $0x80112840,%ebx
...
801014a2:	68 c0 0b 11 80       	push   $0x80110bc0
801014a7:	ff 75 08             	pushl  0x8(%ebp)
801014aa:	e8 71 ff ff ff       	call   80101420 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
801014af:	ff 35 d8 0b 11 80    	pushl  0x80110bd8
801014b5:	ff 35 d4 0b 11 80    	pushl  0x80110bd4
801014bb:	ff 35 d0 0b 11 80    	pushl  0x80110bd0
801014c1:	ff 35 cc 0b 11 80    	pushl  0x80110bcc
801014c7:	ff 35 c8 0b 11 80    	pushl  0x80110bc8
801014cd:	ff 35 c4 0b 11 80    	pushl  0x80110bc4
801014d3:	ff 35 c0 0b 11 80    	pushl  0x80110bc0
801014d9:	68 b8 71 10 80       	push   $0x801071b8
...
801014f9:	83 3d c8 0b 11 80 01 	cmpl   $0x1,0x80110bc8
// Allocate an inode on device dev.
// Mark it as allocated by  giving it type type.
// Returns an unlocked but allocated and referenced inode.
struct inode*
...
801015a3:	68 58 71 10 80       	push   $0x80107158
...
801015c4:	03 05 d4 0b 11 80    	add    0x80110bd4,%eax
...
80101637:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010163a:	68 e0 0b 11 80       	push   $0x80110be0
8010163f:	e8 0c 2d 00 00       	call   80104350 <acquire>
  ip->ref++;
80101644:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101648:	c7 04 24 e0 0b 11 80 	movl   $0x80110be0,(%esp)
...
801016a9:	03 05 d4 0b 11 80    	add    0x80110bd4,%eax
...
8010171d:	68 70 71 10 80       	push   $0x80107170
...
8010172a:	68 6a 71 10 80       	push   $0x8010716a
...
80101777:	68 7f 71 10 80       	push   $0x8010717f
...
801017ba:	e8 a1 29 00 00       	call   80104160 <releasesleep>
  ...
  acquire(&icache.lock);
801017bf:	c7 04 24 e0 0b 11 80 	movl   $0x80110be0,(%esp)
801017c6:	e8 85 2b 00 00       	call   80104350 <acquire>
  ip->ref--;
801017cb:	83 6e 08 01          	subl   $0x1,0x8(%esi)
  release(&icache.lock);
801017cf:	83 c4 10             	add    $0x10,%esp
801017d2:	c7 45 08 e0 0b 11 80 	movl   $0x80110be0,0x8(%ebp)
}
...
801017eb:	68 e0 0b 11 80       	push   $0x80110be0
801017f0:	e8 5b 2b 00 00       	call   80104350 <acquire>
    int r = ip->ref;
801017f5:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
801017f8:	c7 04 24 e0 0b 11 80 	movl   $0x80110be0,(%esp)
...
80101a1a:	8b 04 c5 60 0b 11 80 	mov    -0x7feef4a0(,%eax,8),%eax
...
80101b2a:	8b 04 c5 64 0b 11 80 	mov    -0x7feef49c(,%eax,8),%eax
...
80101c1d:	68 99 71 10 80       	push   $0x80107199
...
80101c2a:	68 87 71 10 80       	push   $0x80107187
...
{
  acquire(&icache.lock);
80101c64:	68 e0 0b 11 80       	push   $0x80110be0
80101c69:	e8 e2 26 00 00       	call   80104350 <acquire>
  ip->ref++;
80101c6e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c72:	c7 04 24 e0 0b 11 80 	movl   $0x80110be0,(%esp)
...
80101e8b:	68 a8 71 10 80       	push   $0x801071a8
...
80101e98:	68 c6 77 10 80       	push   $0x801077c6
...
80101fa0:	68 14 72 10 80       	push   $0x80107214
...
80101fad:	68 0b 72 10 80       	push   $0x8010720b
...
80101fc6:	68 26 72 10 80       	push   $0x80107226
80101fcb:	68 80 a7 10 80       	push   $0x8010a780
80101fd0:	e8 1b 22 00 00       	call   801041f0 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
80101fd5:	58                   	pop    %eax
80101fd6:	a1 00 2f 11 80       	mov    0x80112f00,%eax
80101fdb:	5a                   	pop    %edx
...
80102018:	74 f6                	je     80102010 <ideinit+0x50>
      havedisk1 = 1;
8010201a:	c7 05 60 a7 10 80 01 	movl   $0x1,0x8010a760
80102021:	00 00 00 
}
...
80102046:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&idelock);
80102049:	68 80 a7 10 80       	push   $0x8010a780
8010204e:	e8 fd 22 00 00       	call   80104350 <acquire>

  if((b = idequeue) == 0){
80102053:	8b 1d 64 a7 10 80    	mov    0x8010a764,%ebx
...
80102063:	a3 64 a7 10 80       	mov    %eax,0x8010a764
...
8010207e:	e8 8d 1e 00 00       	call   80103f10 <wakeup>
  ...
  if(idequeue != 0)
80102083:	a1 64 a7 10 80       	mov    0x8010a764,%eax
...
80102097:	68 80 a7 10 80       	push   $0x8010a780
...
80102113:	a1 60 a7 10 80       	mov    0x8010a760,%eax
...
80102123:	68 80 a7 10 80       	push   $0x8010a780
80102128:	e8 23 22 00 00       	call   80104350 <acquire>

  // Append b to idequeue.
  b->qnext = 0;
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
8010212d:	8b 15 64 a7 10 80    	mov    0x8010a764,%edx
...
80102154:	89 1a                	mov    %ebx,(%edx)
  ...
  if(idequeue == b)
80102156:	3b 1d 64 a7 10 80    	cmp    0x8010a764,%ebx
...
80102173:	68 80 a7 10 80       	push   $0x8010a780
...
80102189:	75 e5                	jne    80102170 <iderw+0x90>
  ...
  release(&idelock);
8010218b:	c7 45 08 80 a7 10 80 	movl   $0x8010a780,0x8(%ebp)
}
...
80102196:	e9 65 22 00 00       	jmp    80104400 <release>
  ...
  b->qnext = 0;
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
8010219b:	ba 64 a7 10 80       	mov    $0x8010a764,%edx
...
801021ae:	68 2a 72 10 80       	push   $0x8010722a
...
801021bb:	68 55 72 10 80       	push   $0x80107255
...
801021c8:	68 40 72 10 80       	push   $0x80107240
...
801021e1:	c7 05 34 28 11 80 00 	movl   $0xfec00000,0x80112834
801021e8:	00 c0 fe 
  ioapic->data = data;
}
...
801021f6:	00 00 00 
  return ioapic->data;
801021f9:	8b 15 34 28 11 80    	mov    0x80112834,%edx
...
80102202:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
80102208:	8b 0d 34 28 11 80    	mov    0x80112834,%ecx
  int i, id, maxintr;
  ...
  if(id != ioapicid)
8010220e:	0f b6 15 60 29 11 80 	movzbl 0x80112960,%edx
ioapicinit(void)
{
  int i, id, maxintr;
...
8010222a:	68 74 72 10 80       	push   $0x80107274
8010222f:	e8 2c e4 ff ff       	call   80100660 <cprintf>
80102234:	8b 0d 34 28 11 80    	mov    0x80112834,%ecx
...
80102250:	89 11                	mov    %edx,(%ecx)
  ioapic->data = data;
80102252:	8b 0d 34 28 11 80    	mov    0x80112834,%ecx
    cprintf("ioapicinit: id isn't equal to ioapicid; not a MP\n");
...
8010226e:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
80102270:	8b 0d 34 28 11 80    	mov    0x80112834,%ecx
...
{
  ioapic->reg = reg;
80102291:	8b 0d 34 28 11 80    	mov    0x80112834,%ecx
  }
}
...
801022a3:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022a5:	8b 0d 34 28 11 80    	mov    0x80112834,%ecx
}
...
801022b4:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022b6:	a1 34 28 11 80       	mov    0x80112834,%eax
{
  // Mark interrupt edge-triggered, active high,
  // enabled, and routed to the given cpunum,
  // which happens to be that cpu's APIC ID.
...
801022e2:	81 fb a8 59 11 80    	cmp    $0x801159a8,%ebx
...
80102302:	e8 49 21 00 00       	call   80104450 <memset>
  ...
  if(kmem.use_lock)
80102307:	8b 15 74 28 11 80    	mov    0x80112874,%edx
...
80102314:	a1 78 28 11 80       	mov    0x80112878,%eax
80102319:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
8010231b:	a1 74 28 11 80       	mov    0x80112874,%eax
  ...
  r->next = kmem.freelist;
  kmem.freelist = r;
80102320:	89 1d 78 28 11 80    	mov    %ebx,0x80112878
  if(kmem.use_lock)
...
8010232f:	90                   	nop
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
80102330:	c7 45 08 40 28 11 80 	movl   $0x80112840,0x8(%ebp)
}
...
80102343:	68 40 28 11 80       	push   $0x80112840
...
80102355:	68 a6 72 10 80       	push   $0x801072a6
...
801023bb:	68 ac 72 10 80       	push   $0x801072ac
801023c0:	68 40 28 11 80       	push   $0x80112840
...
kinit1(void *vstart, void *vend)
{
  initlock(&kmem.lock, "kmem");
  kmem.use_lock = 0;
801023d0:	c7 05 74 28 11 80 00 	movl   $0x0,0x80112874
801023d7:	00 00 00 
...
kinit2(void *vstart, void *vend)
{
  freerange(vstart, vend);
  kmem.use_lock = 1;
80102464:	c7 05 74 28 11 80 01 	movl   $0x1,0x80112874
8010246b:	00 00 00 
}
...
801024c3:	68 40 28 11 80       	push   $0x80112840
801024c8:	e8 83 1e 00 00       	call   80104350 <acquire>
  r = kmem.freelist;
801024cd:	8b 1d 78 28 11 80    	mov    0x80112878,%ebx
  if(r)
801024d3:	83 c4 10             	add    $0x10,%esp
801024d6:	a1 74 28 11 80       	mov    0x80112874,%eax
...
80102514:	8b 0d b4 a7 10 80    	mov    0x8010a7b4,%ecx
  data = inb(KBDATAP);
...
8010254e:	0f b6 82 e0 73 10 80 	movzbl -0x7fef8c20(%edx),%eax
80102555:	09 c1                	or     %eax,%ecx
80102557:	0f b6 82 e0 72 10 80 	movzbl -0x7fef8d20(%edx),%eax
...
80102560:	89 c8                	mov    %ecx,%eax
  ...
  shift |= shiftcode[data];
  shift ^= togglecode[data];
80102562:	89 0d b4 a7 10 80    	mov    %ecx,0x8010a7b4
  c = charcode[shift & (CTL | SHIFT)][data];
...
8010256b:	83 e1 08             	and    $0x8,%ecx
  ...
  shift ^= togglecode[data];
  c = charcode[shift & (CTL | SHIFT)][data];
8010256e:	8b 04 85 c0 72 10 80 	mov    -0x7fef8d40(,%eax,4),%eax
...
80102590:	31 c0                	xor    %eax,%eax
  ...
  if(data == 0xE0){
    shift |= E0ESC;
80102592:	83 0d b4 a7 10 80 40 	orl    $0x40,0x8010a7b4
      c += 'A' - 'a';
    else if('A' <= c && c <= 'Z')
      c += 'a' - 'A';
  }
...
{
  if(!lapic)
801025e0:	a1 7c 28 11 80       	mov    0x8011287c,%eax
...
{
  if (!lapic)
801026e0:	a1 7c 28 11 80       	mov    0x8011287c,%eax
  lapicw(TPR, 0);
}
...
{
  if(lapic)
80102700:	a1 7c 28 11 80       	mov    0x8011287c,%eax
}
...
{
  lapic[index] = value;
8010276e:	a1 7c 28 11 80       	mov    0x8011287c,%eax
...
801029a0:	8b 0d c8 28 11 80    	mov    0x801128c8,%ecx
...
80102a24:	39 1d c8 28 11 80    	cmp    %ebx,0x801128c8
...
80102a47:	ff 35 b4 28 11 80    	pushl  0x801128b4
80102a4d:	ff 35 c4 28 11 80    	pushl  0x801128c4
80102a53:	e8 78 d6 ff ff       	call   801000d0 <bread>
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
80102a58:	8b 0d c8 28 11 80    	mov    0x801128c8,%ecx
...
80102a78:	8b 8a cc 28 11 80    	mov    -0x7feed734(%edx),%ecx
...
80102aaa:	68 e0 74 10 80       	push   $0x801074e0
80102aaf:	68 80 28 11 80       	push   $0x80112880
...
80102acb:	59                   	pop    %ecx
  ...
  log.size = sb.nlog;
  log.dev = dev;
80102acc:	89 1d c4 28 11 80    	mov    %ebx,0x801128c4
  ...
  log.start = sb.logstart;
  log.size = sb.nlog;
80102ad2:	89 15 b8 28 11 80    	mov    %edx,0x801128b8
    panic("initlog: too big logheader");
  ...
  readsb(dev, &sb);
  log.start = sb.logstart;
80102ad8:	a3 b4 28 11 80       	mov    %eax,0x801128b4
...
read_head(void)
{
  ...
  int i;
  log.lh.n = lh->n;
80102aed:	89 0d c8 28 11 80    	mov    %ecx,0x801128c8
  for (i = 0; i < log.lh.n; i++) {
...
80102b07:	89 8a c8 28 11 80    	mov    %ecx,-0x7feed738(%edx)
{
  struct buf *buf = bread(log.dev, log.start);
  struct logheader *lh = (struct logheader *) (buf->data);
  int i;
...
80102b1a:	e8 81 fe ff ff       	call   801029a0 <install_trans>
  log.lh.n = 0;
80102b1f:	c7 05 c8 28 11 80 00 	movl   $0x0,0x801128c8
80102b26:	00 00 00 
...
80102b43:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102b46:	68 80 28 11 80       	push   $0x80112880
...
80102b5b:	68 80 28 11 80       	push   $0x80112880
80102b60:	68 80 28 11 80       	push   $0x80112880
...
begin_op(void)
{
  ...
  while(1){
    if(log.committing){
80102b6d:	a1 c0 28 11 80       	mov    0x801128c0,%eax
80102b72:	85 c0                	test   %eax,%eax
80102b74:	75 e2                	jne    80102b58 <begin_op+0x18>
      sleep(&log, &log.lock);
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102b76:	a1 bc 28 11 80       	mov    0x801128bc,%eax
80102b7b:	8b 15 c8 28 11 80    	mov    0x801128c8,%edx
...
80102b8f:	83 ec 0c             	sub    $0xc,%esp
      ...
      log.outstanding += 1;
80102b92:	a3 bc 28 11 80       	mov    %eax,0x801128bc
      release(&log.lock);
80102b97:	68 80 28 11 80       	push   $0x80112880
...
80102bb6:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102bb9:	68 80 28 11 80       	push   $0x80112880
80102bbe:	e8 8d 17 00 00       	call   80104350 <acquire>
  log.outstanding -= 1;
80102bc3:	a1 bc 28 11 80       	mov    0x801128bc,%eax
  if(log.committing)
80102bc8:	8b 1d c0 28 11 80    	mov    0x801128c0,%ebx
...
end_op(void)
{
  ...
  acquire(&log.lock);
  log.outstanding -= 1;
80102bd6:	a3 bc 28 11 80       	mov    %eax,0x801128bc
  if(log.committing)
...
80102be9:	83 ec 0c             	sub    $0xc,%esp
  ...
  if(log.outstanding == 0){
    do_commit = 1;
    log.committing = 1;
80102bec:	c7 05 c0 28 11 80 01 	movl   $0x1,0x801128c0
80102bf3:	00 00 00 
}
...
80102bf6:	31 db                	xor    %ebx,%ebx
  ...
  release(&log.lock);
80102bf8:	68 80 28 11 80       	push   $0x80112880
...
{
  if (log.lh.n > 0) {
80102c02:	8b 0d c8 28 11 80    	mov    0x801128c8,%ecx
...
80102c7c:	3b 1d c8 28 11 80    	cmp    0x801128c8,%ebx
...
80102c89:	e8 12 fd ff ff       	call   801029a0 <install_trans>
    log.lh.n = 0;
80102c8e:	c7 05 c8 28 11 80 00 	movl   $0x0,0x801128c8
80102c95:	00 00 00 
...
80102ca0:	68 80 28 11 80       	push   $0x80112880
80102ca5:	e8 a6 16 00 00       	call   80104350 <acquire>
    log.committing = 0;
    wakeup(&log);
80102caa:	c7 04 24 80 28 11 80 	movl   $0x80112880,(%esp)
  if(do_commit){
    // call commit w/o holding locks, since not allowed
    // to sleep with locks.
    commit();
    acquire(&log.lock);
    log.committing = 0;
80102cb1:	c7 05 c0 28 11 80 00 	movl   $0x0,0x801128c0
80102cb8:	00 00 00 
    wakeup(&log);
80102cbb:	e8 50 12 00 00       	call   80103f10 <wakeup>
    release(&log.lock);
80102cc0:	c7 04 24 80 28 11 80 	movl   $0x80112880,(%esp)
...
80102ce3:	68 80 28 11 80       	push   $0x80112880
80102ce8:	e8 23 12 00 00       	call   80103f10 <wakeup>
  }
  release(&log.lock);
80102ced:	c7 04 24 80 28 11 80 	movl   $0x80112880,(%esp)
...
80102d07:	68 e4 74 10 80       	push   $0x801074e4
...
80102d27:	8b 15 c8 28 11 80    	mov    0x801128c8,%edx
//   modify bp->data[]
//   log_write(bp)
//   brelse(bp)
void
...
80102d59:	68 80 28 11 80       	push   $0x80112880
80102d5e:	e8 ed 15 00 00       	call   80104350 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102d63:	8b 15 c8 28 11 80    	mov    0x801128c8,%edx
...
80102d74:	31 c0                	xor    %eax,%eax
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102d76:	3b 0d cc 28 11 80    	cmp    0x801128cc,%ecx
80102d7c:	75 0b                	jne    80102d89 <log_write+0x69>
80102d7e:	eb 38                	jmp    80102db8 <log_write+0x98>
80102d80:	39 0c 85 cc 28 11 80 	cmp    %ecx,-0x7feed734(,%eax,4)
...
80102d90:	89 0c 95 cc 28 11 80 	mov    %ecx,-0x7feed734(,%edx,4)
  if (i == log.lh.n)
    log.lh.n++;
80102d97:	83 c2 01             	add    $0x1,%edx
80102d9a:	89 15 c8 28 11 80    	mov    %edx,0x801128c8
  b->flags |= B_DIRTY; // prevent eviction
80102da0:	83 0b 04             	orl    $0x4,(%ebx)
  release(&log.lock);
80102da3:	c7 45 08 80 28 11 80 	movl   $0x80112880,0x8(%ebp)
}
...
80102db4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  log.lh.block[i] = b->blockno;
80102db8:	89 0c 85 cc 28 11 80 	mov    %ecx,-0x7feed734(,%eax,4)
80102dbf:	eb df                	jmp    80102da0 <log_write+0x80>
80102dc1:	8b 43 08             	mov    0x8(%ebx),%eax
80102dc4:	a3 cc 28 11 80       	mov    %eax,0x801128cc
  if (i == log.lh.n)
...
80102dd3:	68 f3 74 10 80       	push   $0x801074f3
80102dd8:	e8 93 d5 ff ff       	call   80100370 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102ddd:	83 ec 0c             	sub    $0xc,%esp
80102de0:	68 09 75 10 80       	push   $0x80107509
...
80102e08:	68 24 75 10 80       	push   $0x80107524
80102e0d:	e8 4e d8 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102e12:	e8 39 2a 00 00       	call   80105850 <idtinit>
...
80102e33:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e36:	e8 35 3b 00 00       	call   80106970 <switchkvm>
  seginit();
80102e3b:	e8 30 3a 00 00       	call   80106870 <seginit>
  lapicinit();
...
80102e5f:	bb 80 29 11 80       	mov    $0x80112980,%ebx
// Allocate a real stack and switch to it, first
// doing some setup required for memory allocator to work.
int
main(void)
...
80102e99:	e8 a2 2c 00 00       	call   80105b40 <uartinit>
  pinit();         // process table
80102e9e:	e8 3d 08 00 00       	call   801036e0 <pinit>
  tvinit();        // trap vectors
80102ea3:	e8 08 29 00 00       	call   801057b0 <tvinit>
  binit();         // buffer cache
...
80102ebf:	68 8c a6 10 80       	push   $0x8010a68c
80102ec4:	68 00 70 00 80       	push   $0x80007000
80102ec9:	e8 32 16 00 00       	call   80104500 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
80102ece:	69 05 00 2f 11 80 b0 	imul   $0xb0,0x80112f00,%eax
80102ed5:	00 00 00 
80102ed8:	83 c4 10             	add    $0x10,%esp
80102edb:	05 80 29 11 80       	add    $0x80112980,%eax
...
80102f38:	74 f6                	je     80102f30 <main+0xe0>
  ...
  for(c = cpus; c < cpus+ncpu; c++){
80102f3a:	69 05 00 2f 11 80 b0 	imul   $0xb0,0x80112f00,%eax
80102f41:	00 00 00 
80102f44:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80102f4a:	05 80 29 11 80       	add    $0x80112980,%eax
...
80102f98:	68 38 75 10 80       	push   $0x80107538
...
8010305c:	68 3d 75 10 80       	push   $0x8010753d
...
801030bf:	a3 7c 28 11 80       	mov    %eax,0x8011287c
...
801030f0:	ff 24 95 7c 75 10 80 	jmp    *-0x7fef8a84(,%edx,4)
...
80103135:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
    ...
    case MPPROC:
      ...
      if(ncpu < NCPU) {
80103138:	8b 0d 00 2f 11 80    	mov    0x80112f00,%ecx
...
80103150:	89 0d 00 2f 11 80    	mov    %ecx,0x80112f00
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
    switch(*p){
    case MPPROC:
      proc = (struct mpproc*)p;
      if(ncpu < NCPU) {
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
80103156:	88 97 80 29 11 80    	mov    %dl,-0x7feed680(%edi)
        ncpu++;
      }
...
8010316c:	83 c0 08             	add    $0x8,%eax
    ...
    case MPIOAPIC:
      ioapic = (struct mpioapic*)p;
      ioapicid = ioapic->apicno;
8010316f:	88 15 60 29 11 80    	mov    %dl,0x80112960
      p += sizeof(struct mpioapic);
      continue;
...
80103197:	68 42 75 10 80       	push   $0x80107542
...
801031a4:	68 5c 75 10 80       	push   $0x8010755c
...
80103250:	00 00 00 
  initlock(&p->lock, "pipe");
80103253:	68 90 75 10 80       	push   $0x80107590
...
801035a4:	bb 54 2f 11 80       	mov    $0x80112f54,%ebx
// If found, change state to EMBRYO and initialize
// state required to run in the kernel.
// Otherwise return 0.
static struct proc*
...
801035a9:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&ptable.lock);
801035ac:	68 20 2f 11 80       	push   $0x80112f20
...
801035c6:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
...
801035e1:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  ...
  release(&ptable.lock);
801035e8:	68 20 2f 11 80       	push   $0x80112f20
  return 0;
...
801035fb:	00 00 00 
  p->trace_flag = 0;
801035fe:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
80103605:	00 00 00 
  release(&ptable.lock);
  return 0;
...
8010360e:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  ...
  release(&ptable.lock);
80103614:	e8 e7 0d 00 00       	call   80104400 <release>
...
80103636:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103639:	c7 40 14 9f 57 10 80 	movl   $0x8010579f,0x14(%eax)
...
80103645:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103648:	e8 03 0e 00 00       	call   80104450 <memset>
...
8010366b:	68 20 2f 11 80       	push   $0x80112f20
80103670:	e8 8b 0d 00 00       	call   80104400 <release>
  return 0;
...
80103693:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103696:	68 20 2f 11 80       	push   $0x80112f20
...
801036eb:	68 20 2f 11 80       	push   $0x80112f20
...
8010370c:	e8 cf ef ff ff       	call   801026e0 <lapicid>
  ...
  for (i = 0; i < ncpu; ++i) {
80103711:	8b 35 00 2f 11 80    	mov    0x80112f00,%esi
80103717:	85 f6                	test   %esi,%esi
80103719:	7e 3f                	jle    8010375a <mycpu+0x5a>
    if (cpus[i].apicid == apicid)
8010371b:	0f b6 15 80 29 11 80 	movzbl 0x80112980,%edx
80103722:	39 d0                	cmp    %edx,%eax
80103724:	74 30                	je     80103756 <mycpu+0x56>
80103726:	b9 30 2a 11 80       	mov    $0x80112a30,%ecx
...
8010374d:	5b                   	pop    %ebx
  ...
  for (i = 0; i < ncpu; ++i) {
    if (cpus[i].apicid == apicid)
      return &cpus[i];
8010374e:	05 80 29 11 80       	add    $0x80112980,%eax
  }
  panic("unknown apicid\n");
}
80103753:	5e                   	pop    %esi
...
8010378b:	2d 80 29 11 80       	sub    $0x80112980,%eax
}
80103790:	c9                   	leave  
}
...
801037dc:	89 c3                	mov    %eax,%ebx
  ...
  initproc = p;
801037de:	a3 b8 a7 10 80       	mov    %eax,0x8010a7b8
  if((p->pgdir = setupkvm()) == 0)
801037e3:	e8 a8 35 00 00       	call   80106d90 <setupkvm>
...
801037fb:	68 60 a6 10 80       	push   $0x8010a660
80103800:	50                   	push   %eax
80103801:	e8 9a 32 00 00       	call   80106aa0 <inituvm>
  p->sz = PGSIZE;
...
80103886:	89 43 68             	mov    %eax,0x68(%ebx)
  ...
  acquire(&ptable.lock);
80103889:	c7 04 24 20 2f 11 80 	movl   $0x80112f20,(%esp)
...
80103895:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  ...
  release(&ptable.lock);
8010389c:	c7 04 24 20 2f 11 80 	movl   $0x80112f20,(%esp)
...
801038ee:	e8 ed 32 00 00       	call   80106be0 <allocuvm>
...
80103900:	e8 8b 30 00 00       	call   80106990 <switchuvm>
  return 0;
...
80103924:	e8 b7 33 00 00       	call   80106ce0 <deallocuvm>
...
80103978:	e8 e3 34 00 00       	call   80106e60 <copyuvm>
...
801039f6:	8b 5f 10             	mov    0x10(%edi),%ebx
  ...
  acquire(&ptable.lock);
801039f9:	c7 04 24 20 2f 11 80 	movl   $0x80112f20,(%esp)
...
80103a05:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  ...
  release(&ptable.lock);
80103a0c:	c7 04 24 20 2f 11 80 	movl   $0x80112f20,(%esp)
...
80103a81:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a84:	bb 54 2f 11 80       	mov    $0x80112f54,%ebx
  for(;;){
    // Enable interrupts on this processor.
    sti();
    ...
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80103a89:	68 20 2f 11 80       	push   $0x80112f20
...
80103aa6:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
...
80103abd:	53                   	push   %ebx
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103abe:	81 c3 88 00 00 00    	add    $0x88,%ebx
      ...
      c->proc = p;
      switchuvm(p);
80103ac4:	e8 c7 2e 00 00       	call   80106990 <switchuvm>
      p->state = RUNNING;

      swtch(&(c->scheduler), p->context);
80103ac9:	58                   	pop    %eax
80103aca:	5a                   	pop    %edx
80103acb:	ff 73 94             	pushl  -0x6c(%ebx)
80103ace:	57                   	push   %edi
      ...
      switchuvm(p);
      p->state = RUNNING;
80103acf:	c7 43 84 04 00 00 00 	movl   $0x4,-0x7c(%ebx)

      swtch(&(c->scheduler), p->context);
80103ad6:	e8 d0 0b 00 00       	call   801046ab <swtch>
      switchkvm();
80103adb:	e8 90 2e 00 00       	call   80106970 <switchkvm>
...
80103ae0:	83 c4 10             	add    $0x10,%esp
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ae3:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
      swtch(&(c->scheduler), p->context);
      switchkvm();
...
80103afb:	68 20 2f 11 80       	push   $0x80112f20
...
80103b2d:	68 20 2f 11 80       	push   $0x80112f20
...
80103be9:	e8 c2 06 00 00       	call   801042b0 <popcli>
{
  ...
  if(curproc == initproc)
80103bee:	39 35 b8 a7 10 80    	cmp    %esi,0x8010a7b8
...
80103c34:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  ...
  acquire(&ptable.lock);
80103c3b:	c7 04 24 20 2f 11 80 	movl   $0x80112f20,(%esp)
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c4d:	b8 54 2f 11 80       	mov    $0x80112f54,%eax
80103c52:	eb 10                	jmp    80103c64 <exit+0x94>
80103c54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103c58:	05 88 00 00 00       	add    $0x88,%eax
80103c5d:	3d 54 51 11 80       	cmp    $0x80115154,%eax
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c76:	05 88 00 00 00       	add    $0x88,%eax
80103c7b:	3d 54 51 11 80       	cmp    $0x80115154,%eax
80103c80:	75 e2                	jne    80103c64 <exit+0x94>
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == curproc){
      p->parent = initproc;
80103c82:	8b 0d b8 a7 10 80    	mov    0x8010a7b8,%ecx
80103c88:	ba 54 2f 11 80       	mov    $0x80112f54,%edx
...
80103c8f:	90                   	nop
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c90:	81 c2 88 00 00 00    	add    $0x88,%edx
...
80103cac:	b8 54 2f 11 80       	mov    $0x80112f54,%eax
...
80103ce7:	68 1d 76 10 80       	push   $0x8010761d
...
80103cf4:	68 10 76 10 80       	push   $0x80107610
...
80103d07:	68 20 2f 11 80       	push   $0x80112f20
...
80103d2d:	e8 de fd ff ff       	call   80103b10 <sched>
  release(&ptable.lock);
80103d32:	c7 04 24 20 2f 11 80 	movl   $0x80112f20,(%esp)
...
80103d80:	81 fe 20 2f 11 80    	cmp    $0x80112f20,%esi
80103d86:	74 50                	je     80103dd8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103d88:	83 ec 0c             	sub    $0xc,%esp
80103d8b:	68 20 2f 11 80       	push   $0x80112f20
...
80103dac:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
80103db3:	c7 04 24 20 2f 11 80 	movl   $0x80112f20,(%esp)
...
80103e2d:	68 20 2f 11 80       	push   $0x80112f20
...
80103e3a:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e3c:	bb 54 2f 11 80       	mov    $0x80112f54,%ebx
...
80103e86:	68 20 2f 11 80       	push   $0x80112f20
...
80103ea8:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103eaf:	e8 5c 2e 00 00       	call   80106d10 <freevm>
        p->pid = 0;
...
80103ecd:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103ed4:	c7 04 24 20 2f 11 80 	movl   $0x80112f20,(%esp)
...
80103eef:	68 20 2f 11 80       	push   $0x80112f20
...
80103f17:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103f1a:	68 20 2f 11 80       	push   $0x80112f20
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f27:	b8 54 2f 11 80       	mov    $0x80112f54,%eax
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f5a:	c7 45 08 20 2f 11 80 	movl   $0x80112f20,0x8(%ebp)
}
...
80103fb1:	68 20 2f 11 80       	push   $0x80112f20
...
80103fdb:	68 20 2f 11 80       	push   $0x80112f20
...
80104009:	bb c0 2f 11 80       	mov    $0x80112fc0,%ebx
...
8010401b:	68 df 79 10 80       	push   $0x801079df
...
80104028:	81 c3 88 00 00 00    	add    $0x88,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010402e:	81 fb c0 51 11 80    	cmp    $0x801151c0,%ebx
...
80104041:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80104044:	ba 40 76 10 80       	mov    $0x80107640,%edx
  uint pc[10];
...
8010404b:	8b 14 85 a0 76 10 80 	mov    -0x7fef8960(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80104052:	b8 40 76 10 80       	mov    $0x80107640,%eax
...
80104061:	68 44 76 10 80       	push   $0x80107644
...
8010409d:	68 81 70 10 80       	push   $0x80107081
...
801040ca:	68 b8 76 10 80       	push   $0x801076b8
...
80104305:	68 da 76 10 80       	push   $0x801076da
...
80104312:	68 c3 76 10 80       	push   $0x801076c3
...
801043f3:	68 e1 76 10 80       	push   $0x801076e1
...
8010443c:	68 e9 76 10 80       	push   $0x801076e9
...
8010486f:	77 6f                	ja     801048e0 <syscall+0x90>
80104871:	8b 04 b5 40 77 10 80 	mov    -0x7fef88c0(,%esi,4),%eax
80104878:	85 c0                	test   %eax,%eax
8010487a:	74 64                	je     801048e0 <syscall+0x90>
    curproc->trace_total++;
8010487c:	83 83 80 00 00 00 01 	addl   $0x1,0x80(%ebx)
    curproc->tf->eax = syscalls[num]();
80104883:	ff d0                	call   *%eax
80104885:	89 47 1c             	mov    %eax,0x1c(%edi)
    if ( (curproc->trace == 1 && num != 22)
80104888:	8b 43 7c             	mov    0x7c(%ebx),%eax
8010488b:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010488e:	83 f8 01             	cmp    $0x1,%eax
80104891:	74 7d                	je     80104910 <syscall+0xc0>
          || (curproc->trace == 0 && num == 22 && curproc->trace_flag == 1) ) {
80104893:	85 c0                	test   %eax,%eax
80104895:	75 68                	jne    801048ff <syscall+0xaf>
80104897:	83 fe 16             	cmp    $0x16,%esi
8010489a:	75 63                	jne    801048ff <syscall+0xaf>
8010489c:	83 bb 84 00 00 00 01 	cmpl   $0x1,0x84(%ebx)
801048a3:	75 5a                	jne    801048ff <syscall+0xaf>
      cprintf("pid: %d [%s] syscall(%d=%s)\n", curproc->pid, curproc->name, num, sys_dict[num - 1]);
801048a5:	8d 43 6c             	lea    0x6c(%ebx),%eax
801048a8:	83 ec 0c             	sub    $0xc,%esp
801048ab:	68 f2 a0 10 80       	push   $0x8010a0f2
801048b0:	6a 16                	push   $0x16
801048b2:	50                   	push   %eax
801048b3:	ff 73 10             	pushl  0x10(%ebx)
801048b6:	68 0d 77 10 80       	push   $0x8010770d
801048bb:	e8 a0 bd ff ff       	call   80100660 <cprintf>
      if (num == 22 && curproc->trace_flag == 1) {
801048c0:	83 c4 20             	add    $0x20,%esp
801048c3:	83 bb 84 00 00 00 01 	cmpl   $0x1,0x84(%ebx)
801048ca:	75 33                	jne    801048ff <syscall+0xaf>
        curproc->trace_flag = 0;
801048cc:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
801048d3:	00 00 00 
801048d6:	eb 27                	jmp    801048ff <syscall+0xaf>
801048d8:	90                   	nop
...
801048e0:	8d 43 6c             	lea    0x6c(%ebx),%eax
        curproc->trace_flag = 0;
      }
    }
...
801048e8:	68 f1 76 10 80       	push   $0x801076f1
...
80104909:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    curproc->tf->eax = syscalls[num]();
    if ( (curproc->trace == 1 && num != 22)
80104910:	83 fe 16             	cmp    $0x16,%esi
80104913:	74 ea                	je     801048ff <syscall+0xaf>
          || (curproc->trace == 0 && num == 22 && curproc->trace_flag == 1) ) {
      cprintf("pid: %d [%s] syscall(%d=%s)\n", curproc->pid, curproc->name, num, sys_dict[num - 1]);
80104915:	8d 04 92             	lea    (%edx,%edx,4),%eax
80104918:	83 ec 0c             	sub    $0xc,%esp
8010491b:	8d 84 00 20 a0 10 80 	lea    -0x7fef5fe0(%eax,%eax,1),%eax
80104922:	50                   	push   %eax
80104923:	8d 43 6c             	lea    0x6c(%ebx),%eax
80104926:	56                   	push   %esi
80104927:	50                   	push   %eax
80104928:	ff 73 10             	pushl  0x10(%ebx)
8010492b:	68 0d 77 10 80       	push   $0x8010770d
80104930:	e8 2b bd ff ff       	call   80100660 <cprintf>
80104935:	83 c4 20             	add    $0x20,%esp
80104938:	eb c5                	jmp    801048ff <syscall+0xaf>
...
80104a84:	68 bc 77 10 80       	push   $0x801077bc
...
80104a9c:	68 bb 77 10 80       	push   $0x801077bb
...
80104ab1:	68 af 77 10 80       	push   $0x801077af
...
80104abe:	68 be 77 10 80       	push   $0x801077be
...
80104acb:	68 a0 77 10 80       	push   $0x801077a0
...
80104af2:	e8 69 fc ff ff       	call   80104760 <argint>
...
80104b04:	e8 97 ec ff ff       	call   801037a0 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80104b6b:	e8 30 ec ff ff       	call   801037a0 <myproc>
...
80104be5:	e8 c6 fb ff ff       	call   801047b0 <argptr>
...
80104c3d:	e8 1e fb ff ff       	call   80104760 <argint>
...
80104c55:	e8 56 fb ff ff       	call   801047b0 <argptr>
...
80104ca3:	78 2b                	js     80104cd0 <sys_close+0x40>
    return -1;
  myproc()->ofile[fd] = 0;
80104ca5:	e8 f6 ea ff ff       	call   801037a0 <myproc>
...
80104cff:	e8 ac fa ff ff       	call   801047b0 <argptr>
...
80104d3f:	e8 cc fa ff ff       	call   80104810 <argstr>
...
80104d58:	e8 b3 fa ff ff       	call   80104810 <argstr>
...
80104e9f:	e8 6c f9 ff ff       	call   80104810 <argstr>
...
80104edd:	58                   	pop    %eax
80104ede:	5a                   	pop    %edx
80104edf:	68 bc 77 10 80       	push   $0x801077bc
...
80104ef8:	68 bb 77 10 80       	push   $0x801077bb
...
80104f52:	e8 f9 f4 ff ff       	call   80104450 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010504d:	68 e0 77 10 80       	push   $0x801077e0
...
8010505a:	68 f2 77 10 80       	push   $0x801077f2
...
80105067:	68 ce 77 10 80       	push   $0x801077ce
...
8010508f:	e8 7c f7 ff ff       	call   80104810 <argstr>
...
801050a8:	e8 b3 f6 ff ff       	call   80104760 <argint>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105103:	e8 98 e6 ff ff       	call   801037a0 <myproc>
80105108:	90                   	nop
...
801051f4:	e8 17 f6 ff ff       	call   80104810 <argstr>
...
80105254:	e8 b7 f5 ff ff       	call   80104810 <argstr>
...
80105269:	e8 f2 f4 ff ff       	call   80104760 <argint>
  struct inode *ip;
  char *path;
  int major, minor;
...
8010527e:	e8 dd f4 ff ff       	call   80104760 <argint>
  char *path;
  int major, minor;
...
801052d5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801052d8:	e8 c3 e4 ff ff       	call   801037a0 <myproc>
...
801052ed:	e8 1e f5 ff ff       	call   80104810 <argstr>
...
80105395:	e8 76 f4 ff ff       	call   80104810 <argstr>
...
801053ad:	e8 ae f3 ff ff       	call   80104760 <argint>
...
801053d8:	e8 73 f0 ff ff       	call   80104450 <memset>
...
801053ee:	e8 cd f2 ff ff       	call   801046c0 <fetchint>
...
80105409:	e8 f2 f2 ff ff       	call   80104700 <fetchstr>
...
80105471:	e8 3a f3 ff ff       	call   801047b0 <argptr>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105499:	e8 02 e3 ff ff       	call   801037a0 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
801054e2:	e8 b9 e2 ff ff       	call   801037a0 <myproc>
...
801054fe:	75 f0                	jne    801054f0 <sys_pipe+0x90>
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105500:	e8 9b e2 ff ff       	call   801037a0 <myproc>
...
{
  return fork();
80105534:	e9 07 e4 ff ff       	jmp    80103940 <fork>
...
8010557e:	e8 ed e9 ff ff       	call   80103f70 <kill>
...
801055a3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801055a6:	e8 f5 e1 ff ff       	call   801037a0 <myproc>
...
801055c7:	78 27                	js     801055f0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801055c9:	e8 d2 e1 ff ff       	call   801037a0 <myproc>
  if(growproc(n) < 0)
...
801055d6:	e8 e5 e2 ff ff       	call   801038c0 <growproc>
...
80105620:	68 60 51 11 80       	push   $0x80115160
80105625:	e8 26 ed ff ff       	call   80104350 <acquire>
  ticks0 = ticks;
...
8010562d:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105630:	8b 1d a0 59 11 80    	mov    0x801159a0,%ebx
  while(ticks - ticks0 < n){
...
80105643:	68 60 51 11 80       	push   $0x80115160
80105648:	68 a0 59 11 80       	push   $0x801159a0
8010564d:	e8 fe e6 ff ff       	call   80103d50 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105652:	a1 a0 59 11 80       	mov    0x801159a0,%eax
...
8010565f:	73 2f                	jae    80105690 <sys_sleep+0x90>
    if(myproc()->killed){
80105661:	e8 3a e1 ff ff       	call   801037a0 <myproc>
...
80105670:	68 60 51 11 80       	push   $0x80115160
...
80105693:	68 60 51 11 80       	push   $0x80115160
...
801056b4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801056b7:	68 60 51 11 80       	push   $0x80115160
801056bc:	e8 8f ec ff ff       	call   80104350 <acquire>
  xticks = ticks;
801056c1:	8b 1d a0 59 11 80    	mov    0x801159a0,%ebx
  release(&tickslock);
801056c7:	c7 04 24 60 51 11 80 	movl   $0x80115160,(%esp)
...
// Each system call from that process will be printed to the console in a user-friendly format
int
sys_trace(void)
{
...
801056f9:	74 2d                	je     80105728 <sys_trace+0x48>
    myproc()->trace = 0;
    return myproc()->trace_total;
  } else {
    myproc()->trace = 1;
801056fb:	e8 a0 e0 ff ff       	call   801037a0 <myproc>
80105700:	c7 40 7c 01 00 00 00 	movl   $0x1,0x7c(%eax)
    myproc()->trace_flag = 1;
80105707:	e8 94 e0 ff ff       	call   801037a0 <myproc>
8010570c:	c7 80 84 00 00 00 01 	movl   $0x1,0x84(%eax)
80105713:	00 00 00 
    return myproc()->trace_total;
80105716:	e8 85 e0 ff ff       	call   801037a0 <myproc>
8010571b:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
  }
}
80105721:	c9                   	leave  
80105722:	c3                   	ret    
...
sys_trace(void)
{
  ...
  if (n == 0) {
    myproc()->trace = 0;
80105728:	e8 73 e0 ff ff       	call   801037a0 <myproc>
8010572d:	c7 40 7c 00 00 00 00 	movl   $0x0,0x7c(%eax)
    return myproc()->trace_total;
80105734:	e8 67 e0 ff ff       	call   801037a0 <myproc>
80105739:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
  } else {
    myproc()->trace = 1;
    myproc()->trace_flag = 1;
    return myproc()->trace_total;
...
8010573f:	c9                   	leave  
80105740:	c3                   	ret    
80105741:	eb 0d                	jmp    80105750 <sys_date>
80105743:	90                   	nop
80105744:	90                   	nop
80105745:	90                   	nop
80105746:	90                   	nop
...
8010575e:	e8 4d f0 ff ff       	call   801047b0 <argptr>
...
80105770:	e8 4b d0 ff ff       	call   801027c0 <cmostime>
    return 0;
...
80105788:	06                   	push   %es
  pushl %fs
80105789:	0f a0                	push   %fs
  pushl %gs
8010578b:	0f a8                	push   %gs
  pushal
8010578d:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
8010578e:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105792:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105794:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105796:	54                   	push   %esp
  call trap
80105797:	e8 e4 00 00 00       	call   80105880 <trap>
  addl $4, %esp
8010579c:	83 c4 04             	add    $0x4,%esp
...
8010579f:	61                   	popa   
  popl %gs
801057a0:	0f a9                	pop    %gs
  popl %fs
801057a2:	0f a1                	pop    %fs
  popl %es
801057a4:	07                   	pop    %es
  popl %ds
801057a5:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801057a6:	83 c4 08             	add    $0x8,%esp
  iret
801057a9:	cf                   	iret   
...
801057b8:	8b 14 85 14 a2 10 80 	mov    -0x7fef5dec(,%eax,4),%edx
801057bf:	b9 08 00 00 00       	mov    $0x8,%ecx
801057c4:	c6 04 c5 a4 51 11 80 	movb   $0x0,-0x7feeae5c(,%eax,8)
801057cb:	00 
801057cc:	66 89 0c c5 a2 51 11 	mov    %cx,-0x7feeae5e(,%eax,8)
801057d3:	80 
801057d4:	c6 04 c5 a5 51 11 80 	movb   $0x8e,-0x7feeae5b(,%eax,8)
801057db:	8e 
801057dc:	66 89 14 c5 a0 51 11 	mov    %dx,-0x7feeae60(,%eax,8)
801057e3:	80 
801057e4:	c1 ea 10             	shr    $0x10,%edx
801057e7:	66 89 14 c5 a6 51 11 	mov    %dx,-0x7feeae5a(,%eax,8)
801057ee:	80 
void
tvinit(void)
{
...
80105801:	83 ec 10             	sub    $0x10,%esp
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105804:	a1 14 a3 10 80       	mov    0x8010a314,%eax

  initlock(&tickslock, "time");
80105809:	68 01 78 10 80       	push   $0x80107801
8010580e:	68 60 51 11 80       	push   $0x80115160
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105813:	66 89 15 a2 53 11 80 	mov    %dx,0x801153a2
8010581a:	c6 05 a4 53 11 80 00 	movb   $0x0,0x801153a4
80105821:	66 a3 a0 53 11 80    	mov    %ax,0x801153a0
80105827:	c1 e8 10             	shr    $0x10,%eax
8010582a:	c6 05 a5 53 11 80 ef 	movb   $0xef,0x801153a5
80105831:	66 a3 a6 53 11 80    	mov    %ax,0x801153a6

  initlock(&tickslock, "time");
80105837:	e8 b4 e9 ff ff       	call   801041f0 <initlock>
}
8010583c:	83 c4 10             	add    $0x10,%esp
8010583f:	c9                   	leave  
80105840:	c3                   	ret    
80105841:	eb 0d                	jmp    80105850 <idtinit>
80105843:	90                   	nop
80105844:	90                   	nop
80105845:	90                   	nop
80105846:	90                   	nop
...
8010585b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010585f:	b8 a0 51 11 80       	mov    $0x801151a0,%eax
...
801058a0:	ff 24 85 a8 78 10 80 	jmp    *-0x7fef8758(,%eax,4)
...
801058b0:	e8 eb de ff ff       	call   801037a0 <myproc>
...
801058d3:	e8 a8 de ff ff       	call   80103780 <cpuid>
...
801058e9:	e8 b2 de ff ff       	call   801037a0 <myproc>
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
...
80105905:	68 64 78 10 80       	push   $0x80107864
...
80105912:	e8 89 de ff ff       	call   801037a0 <myproc>
...
80105935:	e8 66 de ff ff       	call   801037a0 <myproc>
8010593a:	85 c0                	test   %eax,%eax
8010593c:	74 0b                	je     80105949 <trap+0xc9>
8010593e:	e8 5d de ff ff       	call   801037a0 <myproc>
...
8010598b:	75 a8                	jne    80105935 <trap+0xb5>
    exit();
8010598d:	e8 3e e2 ff ff       	call   80103bd0 <exit>
...
8010599c:	75 ab                	jne    80105949 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
8010599e:	e8 5d e3 ff ff       	call   80103d00 <yield>
...
801059a5:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
801059a8:	e8 d3 dd ff ff       	call   80103780 <cpuid>
...
801059bf:	90                   	nop
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801059c0:	e8 fb cb ff ff       	call   801025c0 <kbdintr>
    lapiceoi();
...
801059e7:	e8 94 dd ff ff       	call   80103780 <cpuid>
801059ec:	56                   	push   %esi
801059ed:	53                   	push   %ebx
801059ee:	50                   	push   %eax
801059ef:	68 0c 78 10 80       	push   $0x8010780c
801059f4:	e8 67 ac ff ff       	call   80100660 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
801059f9:	e8 02 cd ff ff       	call   80102700 <lapiceoi>
    break;
...
80105a09:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105a10:	e8 2b c6 ff ff       	call   80102040 <ideintr>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
80105a20:	e8 7b dd ff ff       	call   801037a0 <myproc>
80105a25:	8b 58 24             	mov    0x24(%eax),%ebx
80105a28:	85 db                	test   %ebx,%ebx
80105a2a:	75 2c                	jne    80105a58 <trap+0x1d8>
      exit();
    myproc()->tf = tf;
80105a2c:	e8 6f dd ff ff       	call   801037a0 <myproc>
80105a31:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105a34:	e8 17 ee ff ff       	call   80104850 <syscall>
    if(myproc()->killed)
80105a39:	e8 62 dd ff ff       	call   801037a0 <myproc>
...
80105a4f:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105a50:	e9 7b e1 ff ff       	jmp    80103bd0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105a58:	e8 73 e1 ff ff       	call   80103bd0 <exit>
...
80105a68:	e8 e3 e8 ff ff       	call   80104350 <acquire>
      ticks++;
      wakeup(&ticks);
80105a6d:	c7 04 24 a0 59 11 80 	movl   $0x801159a0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105a74:	83 05 a0 59 11 80 01 	addl   $0x1,0x801159a0
      wakeup(&ticks);
80105a7b:	e8 90 e4 ff ff       	call   80103f10 <wakeup>
      release(&tickslock);
80105a80:	c7 04 24 60 51 11 80 	movl   $0x80115160,(%esp)
80105a87:	e8 74 e9 ff ff       	call   80104400 <release>
...
80105a9a:	e8 e1 dc ff ff       	call   80103780 <cpuid>
...
80105aa8:	68 30 78 10 80       	push   $0x80107830
80105aad:	e8 ae ab ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105ab2:	83 c4 14             	add    $0x14,%esp
80105ab5:	68 06 78 10 80       	push   $0x80107806
...
{
  if(!uart)
80105ac0:	a1 bc a7 10 80       	mov    0x8010a7bc,%eax
  outb(COM1+0, c);
}
...
80105b15:	e8 06 cc ff ff       	call   80102720 <microdelay>
{
  int i;
...
80105b97:	74 5a                	je     80105bf3 <uartinit+0xb3>
    return;
  uart = 1;
80105b99:	c7 05 bc a7 10 80 01 	movl   $0x1,0x8010a7bc
80105ba0:	00 00 00 
...
80105baf:	bb 28 79 10 80       	mov    $0x80107928,%ebx
80105bb4:	6a 00                	push   $0x0
80105bb6:	6a 04                	push   $0x4
80105bb8:	e8 d3 c6 ff ff       	call   80102290 <ioapicenable>
...
uartputc(int c)
{
  ...
  if(!uart)
80105bda:	8b 15 bc a7 10 80    	mov    0x8010a7bc,%edx
...
uartputc(int c)
{
  ...
  if(!uart)
80105c00:	8b 15 bc a7 10 80    	mov    0x8010a7bc,%edx
    uartputc(*p);
}
...
80105c47:	6a 00                	push   $0x0
  jmp alltraps
80105c49:	e9 39 fb ff ff       	jmp    80105787 <alltraps>
...
80105c50:	6a 01                	push   $0x1
  jmp alltraps
80105c52:	e9 30 fb ff ff       	jmp    80105787 <alltraps>
...
80105c59:	6a 02                	push   $0x2
  jmp alltraps
80105c5b:	e9 27 fb ff ff       	jmp    80105787 <alltraps>
...
80105c62:	6a 03                	push   $0x3
  jmp alltraps
80105c64:	e9 1e fb ff ff       	jmp    80105787 <alltraps>
...
80105c6b:	6a 04                	push   $0x4
  jmp alltraps
80105c6d:	e9 15 fb ff ff       	jmp    80105787 <alltraps>
...
80105c74:	6a 05                	push   $0x5
  jmp alltraps
80105c76:	e9 0c fb ff ff       	jmp    80105787 <alltraps>
...
80105c7d:	6a 06                	push   $0x6
  jmp alltraps
80105c7f:	e9 03 fb ff ff       	jmp    80105787 <alltraps>
...
80105c86:	6a 07                	push   $0x7
  jmp alltraps
80105c88:	e9 fa fa ff ff       	jmp    80105787 <alltraps>
...
80105c8d:	6a 08                	push   $0x8
  jmp alltraps
80105c8f:	e9 f3 fa ff ff       	jmp    80105787 <alltraps>
...
80105c96:	6a 09                	push   $0x9
  jmp alltraps
80105c98:	e9 ea fa ff ff       	jmp    80105787 <alltraps>
...
80105c9d:	6a 0a                	push   $0xa
  jmp alltraps
80105c9f:	e9 e3 fa ff ff       	jmp    80105787 <alltraps>
...
80105ca4:	6a 0b                	push   $0xb
  jmp alltraps
80105ca6:	e9 dc fa ff ff       	jmp    80105787 <alltraps>
...
80105cab:	6a 0c                	push   $0xc
  jmp alltraps
80105cad:	e9 d5 fa ff ff       	jmp    80105787 <alltraps>
...
80105cb2:	6a 0d                	push   $0xd
  jmp alltraps
80105cb4:	e9 ce fa ff ff       	jmp    80105787 <alltraps>
...
80105cb9:	6a 0e                	push   $0xe
  jmp alltraps
80105cbb:	e9 c7 fa ff ff       	jmp    80105787 <alltraps>
...
80105cc2:	6a 0f                	push   $0xf
  jmp alltraps
80105cc4:	e9 be fa ff ff       	jmp    80105787 <alltraps>
...
80105ccb:	6a 10                	push   $0x10
  jmp alltraps
80105ccd:	e9 b5 fa ff ff       	jmp    80105787 <alltraps>
...
80105cd2:	6a 11                	push   $0x11
  jmp alltraps
80105cd4:	e9 ae fa ff ff       	jmp    80105787 <alltraps>
...
80105cdb:	6a 12                	push   $0x12
  jmp alltraps
80105cdd:	e9 a5 fa ff ff       	jmp    80105787 <alltraps>
...
80105ce4:	6a 13                	push   $0x13
  jmp alltraps
80105ce6:	e9 9c fa ff ff       	jmp    80105787 <alltraps>
...
80105ced:	6a 14                	push   $0x14
  jmp alltraps
80105cef:	e9 93 fa ff ff       	jmp    80105787 <alltraps>
...
80105cf6:	6a 15                	push   $0x15
  jmp alltraps
80105cf8:	e9 8a fa ff ff       	jmp    80105787 <alltraps>
...
80105cff:	6a 16                	push   $0x16
  jmp alltraps
80105d01:	e9 81 fa ff ff       	jmp    80105787 <alltraps>
...
80105d08:	6a 17                	push   $0x17
  jmp alltraps
80105d0a:	e9 78 fa ff ff       	jmp    80105787 <alltraps>
...
80105d11:	6a 18                	push   $0x18
  jmp alltraps
80105d13:	e9 6f fa ff ff       	jmp    80105787 <alltraps>
...
80105d1a:	6a 19                	push   $0x19
  jmp alltraps
80105d1c:	e9 66 fa ff ff       	jmp    80105787 <alltraps>
...
80105d23:	6a 1a                	push   $0x1a
  jmp alltraps
80105d25:	e9 5d fa ff ff       	jmp    80105787 <alltraps>
...
80105d2c:	6a 1b                	push   $0x1b
  jmp alltraps
80105d2e:	e9 54 fa ff ff       	jmp    80105787 <alltraps>
...
80105d35:	6a 1c                	push   $0x1c
  jmp alltraps
80105d37:	e9 4b fa ff ff       	jmp    80105787 <alltraps>
...
80105d3e:	6a 1d                	push   $0x1d
  jmp alltraps
80105d40:	e9 42 fa ff ff       	jmp    80105787 <alltraps>
...
80105d47:	6a 1e                	push   $0x1e
  jmp alltraps
80105d49:	e9 39 fa ff ff       	jmp    80105787 <alltraps>
...
80105d50:	6a 1f                	push   $0x1f
  jmp alltraps
80105d52:	e9 30 fa ff ff       	jmp    80105787 <alltraps>
...
80105d59:	6a 20                	push   $0x20
  jmp alltraps
80105d5b:	e9 27 fa ff ff       	jmp    80105787 <alltraps>
...
80105d62:	6a 21                	push   $0x21
  jmp alltraps
80105d64:	e9 1e fa ff ff       	jmp    80105787 <alltraps>
...
80105d6b:	6a 22                	push   $0x22
  jmp alltraps
80105d6d:	e9 15 fa ff ff       	jmp    80105787 <alltraps>
...
80105d74:	6a 23                	push   $0x23
  jmp alltraps
80105d76:	e9 0c fa ff ff       	jmp    80105787 <alltraps>
...
80105d7d:	6a 24                	push   $0x24
  jmp alltraps
80105d7f:	e9 03 fa ff ff       	jmp    80105787 <alltraps>
...
80105d86:	6a 25                	push   $0x25
  jmp alltraps
80105d88:	e9 fa f9 ff ff       	jmp    80105787 <alltraps>
...
80105d8f:	6a 26                	push   $0x26
  jmp alltraps
80105d91:	e9 f1 f9 ff ff       	jmp    80105787 <alltraps>
...
80105d98:	6a 27                	push   $0x27
  jmp alltraps
80105d9a:	e9 e8 f9 ff ff       	jmp    80105787 <alltraps>
...
80105da1:	6a 28                	push   $0x28
  jmp alltraps
80105da3:	e9 df f9 ff ff       	jmp    80105787 <alltraps>
...
80105daa:	6a 29                	push   $0x29
  jmp alltraps
80105dac:	e9 d6 f9 ff ff       	jmp    80105787 <alltraps>
...
80105db3:	6a 2a                	push   $0x2a
  jmp alltraps
80105db5:	e9 cd f9 ff ff       	jmp    80105787 <alltraps>
...
80105dbc:	6a 2b                	push   $0x2b
  jmp alltraps
80105dbe:	e9 c4 f9 ff ff       	jmp    80105787 <alltraps>
...
80105dc5:	6a 2c                	push   $0x2c
  jmp alltraps
80105dc7:	e9 bb f9 ff ff       	jmp    80105787 <alltraps>
...
80105dce:	6a 2d                	push   $0x2d
  jmp alltraps
80105dd0:	e9 b2 f9 ff ff       	jmp    80105787 <alltraps>
...
80105dd7:	6a 2e                	push   $0x2e
  jmp alltraps
80105dd9:	e9 a9 f9 ff ff       	jmp    80105787 <alltraps>
...
80105de0:	6a 2f                	push   $0x2f
  jmp alltraps
80105de2:	e9 a0 f9 ff ff       	jmp    80105787 <alltraps>
...
80105de9:	6a 30                	push   $0x30
  jmp alltraps
80105deb:	e9 97 f9 ff ff       	jmp    80105787 <alltraps>
...
80105df2:	6a 31                	push   $0x31
  jmp alltraps
80105df4:	e9 8e f9 ff ff       	jmp    80105787 <alltraps>
...
80105dfb:	6a 32                	push   $0x32
  jmp alltraps
80105dfd:	e9 85 f9 ff ff       	jmp    80105787 <alltraps>
...
80105e04:	6a 33                	push   $0x33
  jmp alltraps
80105e06:	e9 7c f9 ff ff       	jmp    80105787 <alltraps>
...
80105e0d:	6a 34                	push   $0x34
  jmp alltraps
80105e0f:	e9 73 f9 ff ff       	jmp    80105787 <alltraps>
...
80105e16:	6a 35                	push   $0x35
  jmp alltraps
80105e18:	e9 6a f9 ff ff       	jmp    80105787 <alltraps>
...
80105e1f:	6a 36                	push   $0x36
  jmp alltraps
80105e21:	e9 61 f9 ff ff       	jmp    80105787 <alltraps>
...
80105e28:	6a 37                	push   $0x37
  jmp alltraps
80105e2a:	e9 58 f9 ff ff       	jmp    80105787 <alltraps>
...
80105e31:	6a 38                	push   $0x38
  jmp alltraps
80105e33:	e9 4f f9 ff ff       	jmp    80105787 <alltraps>
...
80105e3a:	6a 39                	push   $0x39
  jmp alltraps
80105e3c:	e9 46 f9 ff ff       	jmp    80105787 <alltraps>
...
80105e43:	6a 3a                	push   $0x3a
  jmp alltraps
80105e45:	e9 3d f9 ff ff       	jmp    80105787 <alltraps>
...
80105e4c:	6a 3b                	push   $0x3b
  jmp alltraps
80105e4e:	e9 34 f9 ff ff       	jmp    80105787 <alltraps>
...
80105e55:	6a 3c                	push   $0x3c
  jmp alltraps
80105e57:	e9 2b f9 ff ff       	jmp    80105787 <alltraps>
...
80105e5e:	6a 3d                	push   $0x3d
  jmp alltraps
80105e60:	e9 22 f9 ff ff       	jmp    80105787 <alltraps>
...
80105e67:	6a 3e                	push   $0x3e
  jmp alltraps
80105e69:	e9 19 f9 ff ff       	jmp    80105787 <alltraps>
...
80105e70:	6a 3f                	push   $0x3f
  jmp alltraps
80105e72:	e9 10 f9 ff ff       	jmp    80105787 <alltraps>
...
80105e79:	6a 40                	push   $0x40
  jmp alltraps
80105e7b:	e9 07 f9 ff ff       	jmp    80105787 <alltraps>
...
80105e82:	6a 41                	push   $0x41
  jmp alltraps
80105e84:	e9 fe f8 ff ff       	jmp    80105787 <alltraps>
...
80105e8b:	6a 42                	push   $0x42
  jmp alltraps
80105e8d:	e9 f5 f8 ff ff       	jmp    80105787 <alltraps>
...
80105e94:	6a 43                	push   $0x43
  jmp alltraps
80105e96:	e9 ec f8 ff ff       	jmp    80105787 <alltraps>
...
80105e9d:	6a 44                	push   $0x44
  jmp alltraps
80105e9f:	e9 e3 f8 ff ff       	jmp    80105787 <alltraps>
...
80105ea6:	6a 45                	push   $0x45
  jmp alltraps
80105ea8:	e9 da f8 ff ff       	jmp    80105787 <alltraps>
...
80105eaf:	6a 46                	push   $0x46
  jmp alltraps
80105eb1:	e9 d1 f8 ff ff       	jmp    80105787 <alltraps>
...
80105eb8:	6a 47                	push   $0x47
  jmp alltraps
80105eba:	e9 c8 f8 ff ff       	jmp    80105787 <alltraps>
...
80105ec1:	6a 48                	push   $0x48
  jmp alltraps
80105ec3:	e9 bf f8 ff ff       	jmp    80105787 <alltraps>
...
80105eca:	6a 49                	push   $0x49
  jmp alltraps
80105ecc:	e9 b6 f8 ff ff       	jmp    80105787 <alltraps>
...
80105ed3:	6a 4a                	push   $0x4a
  jmp alltraps
80105ed5:	e9 ad f8 ff ff       	jmp    80105787 <alltraps>
...
80105edc:	6a 4b                	push   $0x4b
  jmp alltraps
80105ede:	e9 a4 f8 ff ff       	jmp    80105787 <alltraps>
...
80105ee5:	6a 4c                	push   $0x4c
  jmp alltraps
80105ee7:	e9 9b f8 ff ff       	jmp    80105787 <alltraps>
...
80105eee:	6a 4d                	push   $0x4d
  jmp alltraps
80105ef0:	e9 92 f8 ff ff       	jmp    80105787 <alltraps>
...
80105ef7:	6a 4e                	push   $0x4e
  jmp alltraps
80105ef9:	e9 89 f8 ff ff       	jmp    80105787 <alltraps>
...
80105f00:	6a 4f                	push   $0x4f
  jmp alltraps
80105f02:	e9 80 f8 ff ff       	jmp    80105787 <alltraps>
...
80105f09:	6a 50                	push   $0x50
  jmp alltraps
80105f0b:	e9 77 f8 ff ff       	jmp    80105787 <alltraps>
...
80105f12:	6a 51                	push   $0x51
  jmp alltraps
80105f14:	e9 6e f8 ff ff       	jmp    80105787 <alltraps>
...
80105f1b:	6a 52                	push   $0x52
  jmp alltraps
80105f1d:	e9 65 f8 ff ff       	jmp    80105787 <alltraps>
...
80105f24:	6a 53                	push   $0x53
  jmp alltraps
80105f26:	e9 5c f8 ff ff       	jmp    80105787 <alltraps>
...
80105f2d:	6a 54                	push   $0x54
  jmp alltraps
80105f2f:	e9 53 f8 ff ff       	jmp    80105787 <alltraps>
...
80105f36:	6a 55                	push   $0x55
  jmp alltraps
80105f38:	e9 4a f8 ff ff       	jmp    80105787 <alltraps>
...
80105f3f:	6a 56                	push   $0x56
  jmp alltraps
80105f41:	e9 41 f8 ff ff       	jmp    80105787 <alltraps>
...
80105f48:	6a 57                	push   $0x57
  jmp alltraps
80105f4a:	e9 38 f8 ff ff       	jmp    80105787 <alltraps>
...
80105f51:	6a 58                	push   $0x58
  jmp alltraps
80105f53:	e9 2f f8 ff ff       	jmp    80105787 <alltraps>
...
80105f5a:	6a 59                	push   $0x59
  jmp alltraps
80105f5c:	e9 26 f8 ff ff       	jmp    80105787 <alltraps>
...
80105f63:	6a 5a                	push   $0x5a
  jmp alltraps
80105f65:	e9 1d f8 ff ff       	jmp    80105787 <alltraps>
...
80105f6c:	6a 5b                	push   $0x5b
  jmp alltraps
80105f6e:	e9 14 f8 ff ff       	jmp    80105787 <alltraps>
...
80105f75:	6a 5c                	push   $0x5c
  jmp alltraps
80105f77:	e9 0b f8 ff ff       	jmp    80105787 <alltraps>
...
80105f7e:	6a 5d                	push   $0x5d
  jmp alltraps
80105f80:	e9 02 f8 ff ff       	jmp    80105787 <alltraps>
...
80105f87:	6a 5e                	push   $0x5e
  jmp alltraps
80105f89:	e9 f9 f7 ff ff       	jmp    80105787 <alltraps>
...
80105f90:	6a 5f                	push   $0x5f
  jmp alltraps
80105f92:	e9 f0 f7 ff ff       	jmp    80105787 <alltraps>
...
80105f99:	6a 60                	push   $0x60
  jmp alltraps
80105f9b:	e9 e7 f7 ff ff       	jmp    80105787 <alltraps>
...
80105fa2:	6a 61                	push   $0x61
  jmp alltraps
80105fa4:	e9 de f7 ff ff       	jmp    80105787 <alltraps>
...
80105fab:	6a 62                	push   $0x62
  jmp alltraps
80105fad:	e9 d5 f7 ff ff       	jmp    80105787 <alltraps>
...
80105fb4:	6a 63                	push   $0x63
  jmp alltraps
80105fb6:	e9 cc f7 ff ff       	jmp    80105787 <alltraps>
...
80105fbd:	6a 64                	push   $0x64
  jmp alltraps
80105fbf:	e9 c3 f7 ff ff       	jmp    80105787 <alltraps>
...
80105fc6:	6a 65                	push   $0x65
  jmp alltraps
80105fc8:	e9 ba f7 ff ff       	jmp    80105787 <alltraps>
...
80105fcf:	6a 66                	push   $0x66
  jmp alltraps
80105fd1:	e9 b1 f7 ff ff       	jmp    80105787 <alltraps>
...
80105fd8:	6a 67                	push   $0x67
  jmp alltraps
80105fda:	e9 a8 f7 ff ff       	jmp    80105787 <alltraps>
...
80105fe1:	6a 68                	push   $0x68
  jmp alltraps
80105fe3:	e9 9f f7 ff ff       	jmp    80105787 <alltraps>
...
80105fea:	6a 69                	push   $0x69
  jmp alltraps
80105fec:	e9 96 f7 ff ff       	jmp    80105787 <alltraps>
...
80105ff3:	6a 6a                	push   $0x6a
  jmp alltraps
80105ff5:	e9 8d f7 ff ff       	jmp    80105787 <alltraps>
...
80105ffc:	6a 6b                	push   $0x6b
  jmp alltraps
80105ffe:	e9 84 f7 ff ff       	jmp    80105787 <alltraps>
...
80106005:	6a 6c                	push   $0x6c
  jmp alltraps
80106007:	e9 7b f7 ff ff       	jmp    80105787 <alltraps>
...
8010600e:	6a 6d                	push   $0x6d
  jmp alltraps
80106010:	e9 72 f7 ff ff       	jmp    80105787 <alltraps>
...
80106017:	6a 6e                	push   $0x6e
  jmp alltraps
80106019:	e9 69 f7 ff ff       	jmp    80105787 <alltraps>
...
80106020:	6a 6f                	push   $0x6f
  jmp alltraps
80106022:	e9 60 f7 ff ff       	jmp    80105787 <alltraps>
...
80106029:	6a 70                	push   $0x70
  jmp alltraps
8010602b:	e9 57 f7 ff ff       	jmp    80105787 <alltraps>
...
80106032:	6a 71                	push   $0x71
  jmp alltraps
80106034:	e9 4e f7 ff ff       	jmp    80105787 <alltraps>
...
8010603b:	6a 72                	push   $0x72
  jmp alltraps
8010603d:	e9 45 f7 ff ff       	jmp    80105787 <alltraps>
...
80106044:	6a 73                	push   $0x73
  jmp alltraps
80106046:	e9 3c f7 ff ff       	jmp    80105787 <alltraps>
...
8010604d:	6a 74                	push   $0x74
  jmp alltraps
8010604f:	e9 33 f7 ff ff       	jmp    80105787 <alltraps>
...
80106056:	6a 75                	push   $0x75
  jmp alltraps
80106058:	e9 2a f7 ff ff       	jmp    80105787 <alltraps>
...
8010605f:	6a 76                	push   $0x76
  jmp alltraps
80106061:	e9 21 f7 ff ff       	jmp    80105787 <alltraps>
...
80106068:	6a 77                	push   $0x77
  jmp alltraps
8010606a:	e9 18 f7 ff ff       	jmp    80105787 <alltraps>
...
80106071:	6a 78                	push   $0x78
  jmp alltraps
80106073:	e9 0f f7 ff ff       	jmp    80105787 <alltraps>
...
8010607a:	6a 79                	push   $0x79
  jmp alltraps
8010607c:	e9 06 f7 ff ff       	jmp    80105787 <alltraps>
...
80106083:	6a 7a                	push   $0x7a
  jmp alltraps
80106085:	e9 fd f6 ff ff       	jmp    80105787 <alltraps>
...
8010608c:	6a 7b                	push   $0x7b
  jmp alltraps
8010608e:	e9 f4 f6 ff ff       	jmp    80105787 <alltraps>
...
80106095:	6a 7c                	push   $0x7c
  jmp alltraps
80106097:	e9 eb f6 ff ff       	jmp    80105787 <alltraps>
...
8010609e:	6a 7d                	push   $0x7d
  jmp alltraps
801060a0:	e9 e2 f6 ff ff       	jmp    80105787 <alltraps>
...
801060a7:	6a 7e                	push   $0x7e
  jmp alltraps
801060a9:	e9 d9 f6 ff ff       	jmp    80105787 <alltraps>
...
801060b0:	6a 7f                	push   $0x7f
  jmp alltraps
801060b2:	e9 d0 f6 ff ff       	jmp    80105787 <alltraps>
...
801060b9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801060be:	e9 c4 f6 ff ff       	jmp    80105787 <alltraps>
...
801060c5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801060ca:	e9 b8 f6 ff ff       	jmp    80105787 <alltraps>
...
801060d1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801060d6:	e9 ac f6 ff ff       	jmp    80105787 <alltraps>
...
801060dd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801060e2:	e9 a0 f6 ff ff       	jmp    80105787 <alltraps>
...
801060e9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801060ee:	e9 94 f6 ff ff       	jmp    80105787 <alltraps>
...
801060f5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801060fa:	e9 88 f6 ff ff       	jmp    80105787 <alltraps>
...
80106101:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106106:	e9 7c f6 ff ff       	jmp    80105787 <alltraps>
...
8010610d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106112:	e9 70 f6 ff ff       	jmp    80105787 <alltraps>
...
80106119:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010611e:	e9 64 f6 ff ff       	jmp    80105787 <alltraps>
...
80106125:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010612a:	e9 58 f6 ff ff       	jmp    80105787 <alltraps>
...
80106131:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106136:	e9 4c f6 ff ff       	jmp    80105787 <alltraps>
...
8010613d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106142:	e9 40 f6 ff ff       	jmp    80105787 <alltraps>
...
80106149:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010614e:	e9 34 f6 ff ff       	jmp    80105787 <alltraps>
...
80106155:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010615a:	e9 28 f6 ff ff       	jmp    80105787 <alltraps>
...
80106161:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106166:	e9 1c f6 ff ff       	jmp    80105787 <alltraps>
...
8010616d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106172:	e9 10 f6 ff ff       	jmp    80105787 <alltraps>
...
80106179:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010617e:	e9 04 f6 ff ff       	jmp    80105787 <alltraps>
...
80106185:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010618a:	e9 f8 f5 ff ff       	jmp    80105787 <alltraps>
...
80106191:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106196:	e9 ec f5 ff ff       	jmp    80105787 <alltraps>
...
8010619d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801061a2:	e9 e0 f5 ff ff       	jmp    80105787 <alltraps>
...
801061a9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801061ae:	e9 d4 f5 ff ff       	jmp    80105787 <alltraps>
...
801061b5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801061ba:	e9 c8 f5 ff ff       	jmp    80105787 <alltraps>
...
801061c1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801061c6:	e9 bc f5 ff ff       	jmp    80105787 <alltraps>
...
801061cd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801061d2:	e9 b0 f5 ff ff       	jmp    80105787 <alltraps>
...
801061d9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801061de:	e9 a4 f5 ff ff       	jmp    80105787 <alltraps>
...
801061e5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801061ea:	e9 98 f5 ff ff       	jmp    80105787 <alltraps>
...
801061f1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801061f6:	e9 8c f5 ff ff       	jmp    80105787 <alltraps>
...
801061fd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106202:	e9 80 f5 ff ff       	jmp    80105787 <alltraps>
...
80106209:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010620e:	e9 74 f5 ff ff       	jmp    80105787 <alltraps>
...
80106215:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010621a:	e9 68 f5 ff ff       	jmp    80105787 <alltraps>
...
80106221:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106226:	e9 5c f5 ff ff       	jmp    80105787 <alltraps>
...
8010622d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106232:	e9 50 f5 ff ff       	jmp    80105787 <alltraps>
...
80106239:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010623e:	e9 44 f5 ff ff       	jmp    80105787 <alltraps>
...
80106245:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010624a:	e9 38 f5 ff ff       	jmp    80105787 <alltraps>
...
80106251:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106256:	e9 2c f5 ff ff       	jmp    80105787 <alltraps>
...
8010625d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106262:	e9 20 f5 ff ff       	jmp    80105787 <alltraps>
...
80106269:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010626e:	e9 14 f5 ff ff       	jmp    80105787 <alltraps>
...
80106275:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010627a:	e9 08 f5 ff ff       	jmp    80105787 <alltraps>
...
80106281:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106286:	e9 fc f4 ff ff       	jmp    80105787 <alltraps>
...
8010628d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106292:	e9 f0 f4 ff ff       	jmp    80105787 <alltraps>
...
80106299:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010629e:	e9 e4 f4 ff ff       	jmp    80105787 <alltraps>
...
801062a5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801062aa:	e9 d8 f4 ff ff       	jmp    80105787 <alltraps>
...
801062b1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801062b6:	e9 cc f4 ff ff       	jmp    80105787 <alltraps>
...
801062bd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801062c2:	e9 c0 f4 ff ff       	jmp    80105787 <alltraps>
...
801062c9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801062ce:	e9 b4 f4 ff ff       	jmp    80105787 <alltraps>
...
801062d5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801062da:	e9 a8 f4 ff ff       	jmp    80105787 <alltraps>
...
801062e1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801062e6:	e9 9c f4 ff ff       	jmp    80105787 <alltraps>
...
801062ed:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801062f2:	e9 90 f4 ff ff       	jmp    80105787 <alltraps>
...
801062f9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801062fe:	e9 84 f4 ff ff       	jmp    80105787 <alltraps>
...
80106305:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010630a:	e9 78 f4 ff ff       	jmp    80105787 <alltraps>
...
80106311:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106316:	e9 6c f4 ff ff       	jmp    80105787 <alltraps>
...
8010631d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106322:	e9 60 f4 ff ff       	jmp    80105787 <alltraps>
...
80106329:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010632e:	e9 54 f4 ff ff       	jmp    80105787 <alltraps>
...
80106335:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010633a:	e9 48 f4 ff ff       	jmp    80105787 <alltraps>
...
80106341:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106346:	e9 3c f4 ff ff       	jmp    80105787 <alltraps>
...
8010634d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106352:	e9 30 f4 ff ff       	jmp    80105787 <alltraps>
...
80106359:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010635e:	e9 24 f4 ff ff       	jmp    80105787 <alltraps>
...
80106365:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010636a:	e9 18 f4 ff ff       	jmp    80105787 <alltraps>
...
80106371:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106376:	e9 0c f4 ff ff       	jmp    80105787 <alltraps>
...
8010637d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106382:	e9 00 f4 ff ff       	jmp    80105787 <alltraps>
...
80106389:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010638e:	e9 f4 f3 ff ff       	jmp    80105787 <alltraps>
...
80106395:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010639a:	e9 e8 f3 ff ff       	jmp    80105787 <alltraps>
...
801063a1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801063a6:	e9 dc f3 ff ff       	jmp    80105787 <alltraps>
...
801063ad:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801063b2:	e9 d0 f3 ff ff       	jmp    80105787 <alltraps>
...
801063b9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801063be:	e9 c4 f3 ff ff       	jmp    80105787 <alltraps>
...
801063c5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801063ca:	e9 b8 f3 ff ff       	jmp    80105787 <alltraps>
...
801063d1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801063d6:	e9 ac f3 ff ff       	jmp    80105787 <alltraps>
...
801063dd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801063e2:	e9 a0 f3 ff ff       	jmp    80105787 <alltraps>
...
801063e9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801063ee:	e9 94 f3 ff ff       	jmp    80105787 <alltraps>
...
801063f5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801063fa:	e9 88 f3 ff ff       	jmp    80105787 <alltraps>
...
80106401:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106406:	e9 7c f3 ff ff       	jmp    80105787 <alltraps>
...
8010640d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106412:	e9 70 f3 ff ff       	jmp    80105787 <alltraps>
...
80106419:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010641e:	e9 64 f3 ff ff       	jmp    80105787 <alltraps>
...
80106425:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010642a:	e9 58 f3 ff ff       	jmp    80105787 <alltraps>
...
80106431:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106436:	e9 4c f3 ff ff       	jmp    80105787 <alltraps>
...
8010643d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106442:	e9 40 f3 ff ff       	jmp    80105787 <alltraps>
...
80106449:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010644e:	e9 34 f3 ff ff       	jmp    80105787 <alltraps>
...
80106455:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010645a:	e9 28 f3 ff ff       	jmp    80105787 <alltraps>
...
80106461:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106466:	e9 1c f3 ff ff       	jmp    80105787 <alltraps>
...
8010646d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106472:	e9 10 f3 ff ff       	jmp    80105787 <alltraps>
...
80106479:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010647e:	e9 04 f3 ff ff       	jmp    80105787 <alltraps>
...
80106485:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010648a:	e9 f8 f2 ff ff       	jmp    80105787 <alltraps>
...
80106491:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106496:	e9 ec f2 ff ff       	jmp    80105787 <alltraps>
...
8010649d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801064a2:	e9 e0 f2 ff ff       	jmp    80105787 <alltraps>
...
801064a9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801064ae:	e9 d4 f2 ff ff       	jmp    80105787 <alltraps>
...
801064b5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801064ba:	e9 c8 f2 ff ff       	jmp    80105787 <alltraps>
...
801064c1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801064c6:	e9 bc f2 ff ff       	jmp    80105787 <alltraps>
...
801064cd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801064d2:	e9 b0 f2 ff ff       	jmp    80105787 <alltraps>
...
801064d9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801064de:	e9 a4 f2 ff ff       	jmp    80105787 <alltraps>
...
801064e5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801064ea:	e9 98 f2 ff ff       	jmp    80105787 <alltraps>
...
801064f1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801064f6:	e9 8c f2 ff ff       	jmp    80105787 <alltraps>
...
801064fd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106502:	e9 80 f2 ff ff       	jmp    80105787 <alltraps>
...
80106509:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010650e:	e9 74 f2 ff ff       	jmp    80105787 <alltraps>
...
80106515:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010651a:	e9 68 f2 ff ff       	jmp    80105787 <alltraps>
...
80106521:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106526:	e9 5c f2 ff ff       	jmp    80105787 <alltraps>
...
8010652d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106532:	e9 50 f2 ff ff       	jmp    80105787 <alltraps>
...
80106539:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010653e:	e9 44 f2 ff ff       	jmp    80105787 <alltraps>
...
80106545:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010654a:	e9 38 f2 ff ff       	jmp    80105787 <alltraps>
...
80106551:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106556:	e9 2c f2 ff ff       	jmp    80105787 <alltraps>
...
8010655d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106562:	e9 20 f2 ff ff       	jmp    80105787 <alltraps>
...
80106569:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010656e:	e9 14 f2 ff ff       	jmp    80105787 <alltraps>
...
80106575:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010657a:	e9 08 f2 ff ff       	jmp    80105787 <alltraps>
...
80106581:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106586:	e9 fc f1 ff ff       	jmp    80105787 <alltraps>
...
8010658d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106592:	e9 f0 f1 ff ff       	jmp    80105787 <alltraps>
...
80106599:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010659e:	e9 e4 f1 ff ff       	jmp    80105787 <alltraps>
...
801065a5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801065aa:	e9 d8 f1 ff ff       	jmp    80105787 <alltraps>
...
801065b1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801065b6:	e9 cc f1 ff ff       	jmp    80105787 <alltraps>
...
801065bd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801065c2:	e9 c0 f1 ff ff       	jmp    80105787 <alltraps>
...
801065c9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801065ce:	e9 b4 f1 ff ff       	jmp    80105787 <alltraps>
...
801065d5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801065da:	e9 a8 f1 ff ff       	jmp    80105787 <alltraps>
...
801065e1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801065e6:	e9 9c f1 ff ff       	jmp    80105787 <alltraps>
...
801065ed:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801065f2:	e9 90 f1 ff ff       	jmp    80105787 <alltraps>
...
801065f9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801065fe:	e9 84 f1 ff ff       	jmp    80105787 <alltraps>
...
80106605:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010660a:	e9 78 f1 ff ff       	jmp    80105787 <alltraps>
...
80106611:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106616:	e9 6c f1 ff ff       	jmp    80105787 <alltraps>
...
8010661d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106622:	e9 60 f1 ff ff       	jmp    80105787 <alltraps>
...
80106629:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010662e:	e9 54 f1 ff ff       	jmp    80105787 <alltraps>
...
80106635:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010663a:	e9 48 f1 ff ff       	jmp    80105787 <alltraps>
...
80106641:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106646:	e9 3c f1 ff ff       	jmp    80105787 <alltraps>
...
8010664d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106652:	e9 30 f1 ff ff       	jmp    80105787 <alltraps>
...
80106659:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010665e:	e9 24 f1 ff ff       	jmp    80105787 <alltraps>
...
80106665:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010666a:	e9 18 f1 ff ff       	jmp    80105787 <alltraps>
...
80106671:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106676:	e9 0c f1 ff ff       	jmp    80105787 <alltraps>
...
8010667d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106682:	e9 00 f1 ff ff       	jmp    80105787 <alltraps>
...
80106689:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010668e:	e9 f4 f0 ff ff       	jmp    80105787 <alltraps>
...
80106695:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010669a:	e9 e8 f0 ff ff       	jmp    80105787 <alltraps>
...
801066a1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801066a6:	e9 dc f0 ff ff       	jmp    80105787 <alltraps>
...
801066ad:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801066b2:	e9 d0 f0 ff ff       	jmp    80105787 <alltraps>
...
80106704:	e8 77 bd ff ff       	call   80102480 <kalloc>
...
8010671a:	e8 31 dd ff ff       	call   80104450 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801067bd:	68 30 79 10 80       	push   $0x80107930
...
80106814:	e8 b7 ba ff ff       	call   801022d0 <kfree>
      *pte = 0;
...
80106862:	68 a6 72 10 80       	push   $0x801072a6
...
80106873:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106876:	e8 05 cf ff ff       	call   80103780 <cpuid>
...
80106888:	66 89 90 f8 29 11 80 	mov    %dx,-0x7feed608(%eax)
8010688f:	66 89 88 fa 29 11 80 	mov    %cx,-0x7feed606(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106896:	ba ff ff ff ff       	mov    $0xffffffff,%edx
8010689b:	31 c9                	xor    %ecx,%ecx
8010689d:	66 89 90 00 2a 11 80 	mov    %dx,-0x7feed600(%eax)
...
801068a4:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068a9:	66 89 88 02 2a 11 80 	mov    %cx,-0x7feed5fe(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801068b0:	31 c9                	xor    %ecx,%ecx
801068b2:	66 89 90 08 2a 11 80 	mov    %dx,-0x7feed5f8(%eax)
801068b9:	66 89 88 0a 2a 11 80 	mov    %cx,-0x7feed5f6(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801068c0:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801068c5:	31 c9                	xor    %ecx,%ecx
801068c7:	66 89 90 10 2a 11 80 	mov    %dx,-0x7feed5f0(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801068ce:	c6 80 fc 29 11 80 00 	movb   $0x0,-0x7feed604(%eax)
static inline void
...
801068da:	c6 80 fd 29 11 80 9a 	movb   $0x9a,-0x7feed603(%eax)
801068e1:	c6 80 fe 29 11 80 cf 	movb   $0xcf,-0x7feed602(%eax)
801068e8:	c6 80 ff 29 11 80 00 	movb   $0x0,-0x7feed601(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068ef:	c6 80 04 2a 11 80 00 	movb   $0x0,-0x7feed5fc(%eax)
801068f6:	c6 80 05 2a 11 80 92 	movb   $0x92,-0x7feed5fb(%eax)
801068fd:	c6 80 06 2a 11 80 cf 	movb   $0xcf,-0x7feed5fa(%eax)
80106904:	c6 80 07 2a 11 80 00 	movb   $0x0,-0x7feed5f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010690b:	c6 80 0c 2a 11 80 00 	movb   $0x0,-0x7feed5f4(%eax)
80106912:	c6 80 0d 2a 11 80 fa 	movb   $0xfa,-0x7feed5f3(%eax)
80106919:	c6 80 0e 2a 11 80 cf 	movb   $0xcf,-0x7feed5f2(%eax)
80106920:	c6 80 0f 2a 11 80 00 	movb   $0x0,-0x7feed5f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106927:	66 89 88 12 2a 11 80 	mov    %cx,-0x7feed5ee(%eax)
8010692e:	c6 80 14 2a 11 80 00 	movb   $0x0,-0x7feed5ec(%eax)
80106935:	c6 80 15 2a 11 80 f2 	movb   $0xf2,-0x7feed5eb(%eax)
8010693c:	c6 80 16 2a 11 80 cf 	movb   $0xcf,-0x7feed5ea(%eax)
80106943:	c6 80 17 2a 11 80 00 	movb   $0x0,-0x7feed5e9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
8010694a:	05 f0 29 11 80       	add    $0x801129f0,%eax
...
80106970:	a1 a4 59 11 80       	mov    0x801159a4,%eax
...
801069b4:	0f 84 c4 00 00 00    	je     80106a7e <switchuvm+0xee>
  ...
  pushcli();
801069ba:	e8 b1 d8 ff ff       	call   80104270 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801069bf:	e8 3c cd ff ff       	call   80103700 <mycpu>
801069c4:	89 c3                	mov    %eax,%ebx
801069c6:	e8 35 cd ff ff       	call   80103700 <mycpu>
801069cb:	89 c7                	mov    %eax,%edi
801069cd:	e8 2e cd ff ff       	call   80103700 <mycpu>
801069d2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801069d5:	83 c7 08             	add    $0x8,%edi
801069d8:	e8 23 cd ff ff       	call   80103700 <mycpu>
...
80106a19:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106a1e:	e8 dd cc ff ff       	call   80103700 <mycpu>
80106a23:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106a2a:	e8 d1 cc ff ff       	call   80103700 <mycpu>
80106a2f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106a34:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106a38:	e8 c3 cc ff ff       	call   80103700 <mycpu>
...
80106a46:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106a49:	e8 b2 cc ff ff       	call   80103700 <mycpu>
...
80106a6b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106a6c:	e9 3f d8 ff ff       	jmp    801042b0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106a74:	68 36 79 10 80       	push   $0x80107936
...
80106a81:	68 61 79 10 80       	push   $0x80107961
...
80106a8e:	68 4c 79 10 80       	push   $0x8010794c
...
80106abb:	77 49                	ja     80106b06 <inituvm+0x66>
  ...
  mem = kalloc();
80106abd:	e8 be b9 ff ff       	call   80102480 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106acf:	e8 7c d9 ff ff       	call   80104450 <memset>
...
80106b00:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106b01:	e9 fa d9 ff ff       	jmp    80104500 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106b09:	68 75 79 10 80       	push   $0x80107975
...
80106bbd:	68 8f 79 10 80       	push   $0x8010798f
...
80106bca:	68 30 7a 10 80       	push   $0x80107a30
...
80106c23:	e8 28 d8 ff ff       	call   80104450 <memset>
...
80106c3d:	e8 fe fa ff ff       	call   80106740 <mappages>
...
80106c51:	76 7d                	jbe    80106cd0 <allocuvm+0xf0>
    mem = kalloc();
80106c53:	e8 28 b8 ff ff       	call   80102480 <kalloc>
    if(mem == 0){
...
80106c61:	68 ad 79 10 80       	push   $0x801079ad
...
80106c7b:	e8 50 fb ff ff       	call   801067d0 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106cad:	e8 1e fb ff ff       	call   801067d0 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106cb6:	e8 15 b6 ff ff       	call   801022d0 <kfree>
      return 0;
...
80106cf0:	5d                   	pop    %ebp
80106cf1:	e9 da fa ff ff       	jmp    801067d0 <deallocuvm.part.0>
...
80106d29:	e8 a2 fa ff ff       	call   801067d0 <deallocuvm.part.0>
...
80106d5e:	e8 6d b5 ff ff       	call   801022d0 <kfree>
...
80106d73:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106d74:	e9 57 b5 ff ff       	jmp    801022d0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
80106d7c:	68 e1 79 10 80       	push   $0x801079e1
...
80106d95:	e8 e6 b6 ff ff       	call   80102480 <kalloc>
80106d9a:	85 c0                	test   %eax,%eax
80106d9c:	74 6a                	je     80106e08 <setupkvm+0x78>
    return 0;
...
80106da3:	bb 20 a6 10 80       	mov    $0x8010a620,%ebx
  pde_t *pgdir;
  struct kmap *k;
...
80106db0:	e8 9b d6 ff ff       	call   80104450 <memset>
...
80106dcb:	e8 70 f9 ff ff       	call   80106740 <mappages>
...
80106dda:	81 fb 60 a6 10 80    	cmp    $0x8010a660,%ebx
80106de0:	75 d6                	jne    80106db8 <setupkvm+0x28>
80106de2:	89 f0                	mov    %esi,%eax
...
80106de4:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106de7:	5b                   	pop    %ebx
80106de8:	5e                   	pop    %esi
80106de9:	5d                   	pop    %ebp
80106dea:	c3                   	ret    
...
80106df4:	e8 17 ff ff ff       	call   80106d10 <freevm>
      return 0;
80106df9:	83 c4 10             	add    $0x10,%esp
    }
  return pgdir;
}
80106dfc:	8d 65 f8             	lea    -0x8(%ebp),%esp
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
                (uint)k->phys_start, k->perm) < 0) {
...
80106e05:	8d 76 00             	lea    0x0(%esi),%esi
{
  ...
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
80106e08:	31 c0                	xor    %eax,%eax
80106e0a:	eb d8                	jmp    80106de4 <setupkvm+0x54>
...
80106e1b:	a3 a4 59 11 80       	mov    %eax,0x801159a4
...
80106e4f:	68 f2 79 10 80       	push   $0x801079f2
...
80106e73:	0f 84 c5 00 00 00    	je     80106f3e <copyuvm+0xde>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106ea0:	e8 5b d6 ff ff       	call   80104500 <memmove>
...
80106ec5:	78 69                	js     80106f30 <copyuvm+0xd0>
  uint pa, i, flags;
  char *mem;
...
80106ee0:	74 6d                	je     80106f4f <copyuvm+0xef>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106ee2:	8b 00                	mov    (%eax),%eax
80106ee4:	a8 01                	test   $0x1,%al
80106ee6:	74 5a                	je     80106f42 <copyuvm+0xe2>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
...
80106ef5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106ef8:	e8 83 b5 ff ff       	call   80102480 <kalloc>
...
80106f34:	e8 97 b3 ff ff       	call   801022d0 <kfree>
      goto bad;
80106f39:	83 c4 10             	add    $0x10,%esp
80106f3c:	eb c5                	jmp    80106f03 <copyuvm+0xa3>
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
80106f3e:	31 c0                	xor    %eax,%eax
80106f40:	eb d1                	jmp    80106f13 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80106f45:	68 16 7a 10 80       	push   $0x80107a16
80106f4a:	e8 21 94 ff ff       	call   80100370 <panic>
...
80106f52:	68 fc 79 10 80       	push   $0x801079fc
80106f57:	e8 14 94 ff ff       	call   80100370 <panic>
...
80106f6e:	e8 4d f7 ff ff       	call   801066c0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106fdf:	e8 1c d5 ff ff       	call   80104500 <memmove>
    len -= n;
    buf += n;
