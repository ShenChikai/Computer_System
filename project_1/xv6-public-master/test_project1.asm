...
_test_project1:     file format elf32-i386
...
main(void)
{
 ...
 // 2 sys calls sbrk and exec
	...
	// 1 sys call
	int pid = getpid();
   f:	e8 4e 03 00 00       	call   362 <getpid>
...
main(void)
{
 // 2 sys calls sbrk and exec
  ...
  17:	89 c3                	mov    %eax,%ebx
	...
	trace(1);
  19:	6a 01                	push   $0x1
  1b:	e8 62 03 00 00       	call   382 <trace>
	
	// 4 sys calls
	fork();
  20:	e8 b5 02 00 00       	call   2da <fork>
	fork();
  25:	e8 b0 02 00 00       	call   2da <fork>
	wait();
  2a:	e8 bb 02 00 00       	call   2ea <wait>
	wait();
  2f:	e8 b6 02 00 00       	call   2ea <wait>
	
	// 1 sys call
	if(getpid() == pid){
  34:	e8 29 03 00 00       	call   362 <getpid>
  39:	83 c4 10             	add    $0x10,%esp
  3c:	39 c3                	cmp    %eax,%ebx
  3e:	74 18                	je     58 <main+0x58>
	...
	// 2 sys calls
	fork();
  40:	e8 95 02 00 00       	call   2da <fork>
	wait();
  45:	e8 a0 02 00 00       	call   2ea <wait>
	
	// 1 sys call
	if(getpid() == pid){
  4a:	e8 13 03 00 00       	call   362 <getpid>
  4f:	39 c3                	cmp    %eax,%ebx
  51:	74 24                	je     77 <main+0x77>
 ...
 exit();
  ...
  5b:	6a 00                	push   $0x0
  5d:	e8 20 03 00 00       	call   382 <trace>
  62:	83 c4 0c             	add    $0xc,%esp
  65:	50                   	push   %eax
  66:	68 60 07 00 00       	push   $0x760
  6b:	6a 01                	push   $0x1
  6d:	e8 ce 03 00 00       	call   440 <printf>
  72:	83 c4 10             	add    $0x10,%esp
  75:	eb c9                	jmp    40 <main+0x40>
	wait();
  ...
  7a:	6a 00                	push   $0x0
  7c:	e8 01 03 00 00       	call   382 <trace>
  81:	83 c4 0c             	add    $0xc,%esp
  84:	50                   	push   %eax
  85:	68 60 07 00 00       	push   $0x760
  8a:	6a 01                	push   $0x1
  8c:	e8 af 03 00 00       	call   440 <printf>
  91:	83 c4 10             	add    $0x10,%esp
  94:	eb bd                	jmp    53 <main+0x53>
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  9a:	66 90                	xchg   %ax,%ax
  9c:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3df:	f7 f6                	div    %esi
 3e1:	0f b6 92 84 07 00 00 	movzbl 0x784(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 558:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 55b:	b8 7b 07 00 00       	mov    $0x77b,%eax
...
free(void *ap)
{
 ...
 5e1:	a1 20 0a 00 00       	mov    0xa20,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 20 0a 00 00       	mov    %eax,0xa20
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 20 0a 00 00    	mov    0xa20,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6cf:	76 3f                	jbe    710 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	39 05 20 0a 00 00    	cmp    %eax,0xa20
 ...
 6f6:	e8 e5 fe ff ff       	call   5e0 <free>
  return freep;
 6fb:	8b 15 20 0a 00 00    	mov    0xa20,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 71c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 71f:	89 15 20 0a 00 00    	mov    %edx,0xa20
      return (void*)(p + 1);
 ...
 734:	eb e9                	jmp    71f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 20 0a 00 00 24 	movl   $0xa24,0xa20
 73d:	0a 00 00 
 740:	c7 05 24 0a 00 00 24 	movl   $0xa24,0xa24
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 24 0a 00 00       	mov    $0xa24,%eax
 74f:	c7 05 28 0a 00 00 00 	movl   $0x0,0xa28
 756:	00 00 00 
