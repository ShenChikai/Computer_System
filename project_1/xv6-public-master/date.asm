...
int main(int argc, char *argv[]){
   ...
   f:	51                   	push   %ecx
	...
	if (date(&r)) {
  10:	8d 85 40 ff ff ff    	lea    -0xc0(%ebp),%eax
#include "types.h"
#include "user.h"
#include "date.h"

int main(int argc, char *argv[]){
  16:	81 ec c8 00 00 00    	sub    $0xc8,%esp
	struct rtcdate r;

	if (date(&r)) {
  1c:	50                   	push   %eax
  1d:	e8 68 03 00 00       	call   38a <date>
  22:	83 c4 10             	add    $0x10,%esp
  25:	85 c0                	test   %eax,%eax
  27:	75 64                	jne    8d <main+0x8d>
	}
	...
	char dn;
	if (r.hour > 12) {
  29:	8b 85 48 ff ff ff    	mov    -0xb8(%ebp),%eax
		my_hour = r.hour - 12;
		dn = 'p';
	} else {
		my_hour = r.hour;
		dn = 'a';
  2f:	ba 61 00 00 00       	mov    $0x61,%edx
	}
	...
	char dn;
	if (r.hour > 12) {
  34:	83 f8 0c             	cmp    $0xc,%eax
  37:	76 08                	jbe    41 <main+0x41>
		my_hour = r.hour - 12;
  39:	83 e8 0c             	sub    $0xc,%eax
		dn = 'p';
  3c:	ba 70 00 00 00       	mov    $0x70,%edx
	} else {
		my_hour = r.hour;
		dn = 'a';
	}
  ...
  41:	8d bd 58 ff ff ff    	lea    -0xa8(%ebp),%edi
  47:	be a0 07 00 00       	mov    $0x7a0,%esi
  4c:	b9 24 00 00 00       	mov    $0x24,%ecx
  ...
  53:	8b 8d 50 ff ff ff    	mov    -0xb0(%ebp),%ecx
  59:	ff b5 54 ff ff ff    	pushl  -0xac(%ebp)
  5f:	ff b5 4c ff ff ff    	pushl  -0xb4(%ebp)
  65:	8d 4c 49 fd          	lea    -0x3(%ecx,%ecx,2),%ecx
  69:	8d 8c 8d 58 ff ff ff 	lea    -0xa8(%ebp,%ecx,4),%ecx
  70:	51                   	push   %ecx
  71:	52                   	push   %edx
  72:	ff b5 44 ff ff ff    	pushl  -0xbc(%ebp)
  78:	50                   	push   %eax
  79:	68 6d 07 00 00       	push   $0x76d
  7e:	6a 01                	push   $0x1
...
int main(int argc, char *argv[]){
  ...
  8d:	50                   	push   %eax
  8e:	50                   	push   %eax
  8f:	68 60 07 00 00       	push   $0x760
  94:	6a 02                	push   $0x2
  96:	e8 a5 03 00 00       	call   440 <printf>
		exit();
  9b:	e8 42 02 00 00       	call   2e2 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3df:	f7 f6                	div    %esi
 3e1:	0f b6 92 38 08 00 00 	movzbl 0x838(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 558:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 55b:	b8 30 08 00 00       	mov    $0x830,%eax
...
free(void *ap)
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 d8 0a 00 00       	mov    %eax,0xad8
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 d8 0a 00 00       	mov    %eax,0xad8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6cf:	76 3f                	jbe    710 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	39 05 d8 0a 00 00    	cmp    %eax,0xad8
 ...
 6f6:	e8 e5 fe ff ff       	call   5e0 <free>
  return freep;
 6fb:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 734:	eb e9                	jmp    71f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 d8 0a 00 00 dc 	movl   $0xadc,0xad8
 73d:	0a 00 00 
 740:	c7 05 dc 0a 00 00 dc 	movl   $0xadc,0xadc
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 dc 0a 00 00       	mov    $0xadc,%eax
 74f:	c7 05 e0 0a 00 00 00 	movl   $0x0,0xae0
 756:	00 00 00 
