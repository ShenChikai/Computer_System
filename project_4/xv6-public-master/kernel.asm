...
80100c51:	e8 aa 63 00 00       	call   80107000 <copyout>
...
80100cb5:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cbb:	e8 40 63 00 00       	call   80107000 <copyout>
...
80100d60:	e8 0b 35 00 00       	call   80104270 <initlock>
}
...
80100d81:	e8 4a 36 00 00       	call   801043d0 <acquire>
...
80100def:	e8 dc 35 00 00       	call   801043d0 <acquire>
  if(f->ref < 1)
...
80100e41:	e8 8a 35 00 00       	call   801043d0 <acquire>
  if(f->ref < 1)
...
80101255:	e8 76 32 00 00       	call   801044d0 <memset>
  log_write(bp);
...
8010129a:	e8 31 31 00 00       	call   801043d0 <acquire>
...
801012df:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012e2:	e8 99 31 00 00       	call   80104480 <release>
      return ip;
...
8010132f:	e8 4c 31 00 00       	call   80104480 <release>
...
80101441:	e8 3a 31 00 00       	call   80104580 <memmove>
  brelse(bp);
...
80101476:	e8 f5 2d 00 00       	call   80104270 <initlock>
...
8010148f:	e8 ac 2c 00 00       	call   80104140 <initsleeplock>
iinit(int dev)
{
  int i = 0;
...
8010156e:	e8 5d 2f 00 00       	call   801044d0 <memset>
      dip->type = type;
...
80101611:	e8 6a 2f 00 00       	call   80104580 <memmove>
  log_write(bp);
...
8010164f:	e8 2c 2e 00 00       	call   80104480 <release>
  return ip;
}
...
80101682:	e8 f9 2a 00 00       	call   80104180 <acquiresleep>
...
801016f8:	e8 83 2e 00 00       	call   80104580 <memmove>
    brelse(bp);
...
80101753:	e8 c8 2a 00 00       	call   80104220 <holdingsleep>
...
iunlock(struct inode *ip)
{
  ...
  releasesleep(&ip->lock);
8010176f:	e9 6c 2a 00 00       	jmp    801041e0 <releasesleep>
// Unlock the given inode.
void
iunlock(struct inode *ip)
{
...
801017a0:	e8 db 29 00 00       	call   80104180 <acquiresleep>
...
801017ba:	e8 21 2a 00 00       	call   801041e0 <releasesleep>

  acquire(&icache.lock);
801017bf:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017c6:	e8 05 2c 00 00       	call   801043d0 <acquire>
  ip->ref--;
...
801017df:	5d                   	pop    %ebp
  ...
  ip->ref--;
  release(&icache.lock);
801017e0:	e9 9b 2c 00 00       	jmp    80104480 <release>
...
801017f0:	e8 db 2b 00 00       	call   801043d0 <acquire>
    int r = ip->ref;
801017f5:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
801017f8:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017ff:	e8 7c 2c 00 00       	call   80104480 <release>
    if(r == 1){
...
80101b7e:	e8 7d 2a 00 00       	call   80104600 <strncmp>
}
80101b83:	c9                   	leave  
80101b84:	c3                   	ret    
...
80101be5:	e8 16 2a 00 00       	call   80104600 <strncmp>
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
    if(de.inum == 0)
...
80101c69:	e8 62 27 00 00       	call   801043d0 <acquire>
  ip->ref++;
80101c6e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c72:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101c79:	e8 02 28 00 00       	call   80104480 <release>
...
80101cd5:	e8 a6 28 00 00       	call   80104580 <memmove>
    path++;
  if(*path == 0)
    return 0;
  s = path;
...
80101d64:	e8 17 28 00 00       	call   80104580 <memmove>
    name[len] = 0;
...
80101e4d:	e8 1e 28 00 00       	call   80104670 <strncpy>
  de.inum = inum;
...
80101e98:	68 62 79 10 80       	push   $0x80107962
...
80101fd0:	e8 9b 22 00 00       	call   80104270 <initlock>
...
8010204e:	e8 7d 23 00 00       	call   801043d0 <acquire>
...
8010209c:	e8 df 23 00 00       	call   80104480 <release>
  // Start disk on next buf in queue.
  if(idequeue != 0)
    idestart(idequeue);
...
801020ee:	e8 2d 21 00 00       	call   80104220 <holdingsleep>
...
80102128:	e8 a3 22 00 00       	call   801043d0 <acquire>
...
80102195:	c9                   	leave  
  ...
  release(&idelock);
80102196:	e9 e5 22 00 00       	jmp    80104480 <release>
...
801022e2:	81 fb 14 35 12 80    	cmp    $0x80123514,%ebx
...
80102302:	e8 c9 21 00 00       	call   801044d0 <memset>
...
8010233a:	c9                   	leave  
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
8010233b:	e9 40 21 00 00       	jmp    80104480 <release>
...
801023c5:	e8 a6 1e 00 00       	call   80104270 <initlock>
...
801024ae:	e8 cd 1f 00 00       	call   80104480 <release>
...
801028d4:	e8 47 1c 00 00       	call   80104520 <memcmp>
...
80102a04:	e8 77 1b 00 00       	call   80104580 <memmove>
...
80102ab4:	e8 b7 17 00 00       	call   80104270 <initlock>
  readsb(dev, &sb);
80102ab9:	58                   	pop    %eax
...
80102b4b:	e8 80 18 00 00       	call   801043d0 <acquire>
...
80102b9c:	e8 df 18 00 00       	call   80104480 <release>
      break;
    }
  }
}
...
80102bbe:	e8 0d 18 00 00       	call   801043d0 <acquire>
  log.outstanding -= 1;
...
80102bfd:	e8 7e 18 00 00       	call   80104480 <release>
}
...
80102c5c:	e8 1f 19 00 00       	call   80104580 <memmove>
...
80102ca5:	e8 26 17 00 00       	call   801043d0 <acquire>
    log.committing = 0;
    wakeup(&log);
...
80102cc7:	e8 b4 17 00 00       	call   80104480 <release>
...
80102cf4:	e8 87 17 00 00       	call   80104480 <release>
...
80102d5e:	e8 6d 16 00 00       	call   801043d0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dad:	c9                   	leave  
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
80102dae:	e9 cd 16 00 00       	jmp    80104480 <release>
80102db3:	90                   	nop
...
80102e12:	e8 99 29 00 00       	call   801057b0 <idtinit>
...
80102e6c:	68 14 35 12 80       	push   $0x80123514
...
80102e99:	e8 12 2c 00 00       	call   80105ab0 <uartinit>
  pinit();         // process table
80102e9e:	e8 0d 08 00 00       	call   801036b0 <pinit>
  tvinit();        // trap vectors
80102ea3:	e8 68 28 00 00       	call   80105710 <tvinit>
  binit();         // buffer cache
...
80102ec9:	e8 b2 16 00 00       	call   80104580 <memmove>
...
80102f9e:	e8 7d 15 00 00       	call   80104520 <memcmp>
...
80103062:	e8 b9 14 00 00       	call   80104520 <memcmp>
...
80103259:	e8 12 10 00 00       	call   80104270 <initlock>
  (*f0)->type = FD_PIPE;
...
801032ef:	e8 dc 10 00 00       	call   801043d0 <acquire>
  if(writable){
...
80103333:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
80103334:	e9 47 11 00 00       	jmp    80104480 <release>
...
80103364:	e8 17 11 00 00       	call   80104480 <release>
    kfree((char*)p);
...
8010338d:	e8 3e 10 00 00       	call   801043d0 <acquire>
  for(i = 0; i < n; i++){
...
80103414:	e8 67 10 00 00       	call   80104480 <release>
        return -1;
...
80103490:	e8 3b 0f 00 00       	call   801043d0 <acquire>
...
801034f9:	e8 82 0f 00 00       	call   80104480 <release>
      return -1;
...
80103566:	e8 15 0f 00 00       	call   80104480 <release>
  return i;
...
801035b1:	e8 1a 0e 00 00       	call   801043d0 <acquire>
...
801035ec:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  ...
  release(&ptable.lock);
801035f2:	e8 89 0e 00 00       	call   80104480 <release>
...
80103614:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103617:	c7 40 14 f7 56 10 80 	movl   $0x801056f7,0x14(%eax)
...
80103623:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103626:	e8 a5 0e 00 00       	call   801044d0 <memset>
...
80103648:	e8 33 0e 00 00       	call   80104480 <release>
  return 0;
...
8010366b:	e8 10 0e 00 00       	call   80104480 <release>
...
801036b6:	68 35 77 10 80       	push   $0x80107735
801036bb:	68 20 2d 11 80       	push   $0x80112d20
801036c0:	e8 ab 0b 00 00       	call   80104270 <initlock>
}
...
8010372d:	68 3c 77 10 80       	push   $0x8010773c
...
8010373a:	68 2c 78 10 80       	push   $0x8010782c
...
80103774:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
80103777:	e8 74 0b 00 00       	call   801042f0 <pushcli>
  c = mycpu();
8010377c:	e8 4f ff ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103781:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103787:	e8 a4 0b 00 00       	call   80104330 <popcli>
  return p;
}
...
801037b3:	e8 f8 35 00 00       	call   80106db0 <setupkvm>
...
801037e6:	e8 e5 0c 00 00       	call   801044d0 <memset>
...
8010383f:	68 65 77 10 80       	push   $0x80107765
80103844:	50                   	push   %eax
80103845:	e8 86 0e 00 00       	call   801046d0 <safestrcpy>
  p->cwd = namei("/");
8010384a:	c7 04 24 6e 77 10 80 	movl   $0x8010776e,(%esp)
...
80103860:	e8 6b 0b 00 00       	call   801043d0 <acquire>
...
80103873:	e8 08 0c 00 00       	call   80104480 <release>
}
...
80103883:	68 4c 77 10 80       	push   $0x8010774c
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103898:	e8 53 0a 00 00       	call   801042f0 <pushcli>
  c = mycpu();
8010389d:	e8 2e fe ff ff       	call   801036d0 <mycpu>
  p = c->proc;
801038a2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038a8:	e8 83 0a 00 00       	call   80104330 <popcli>
{
  uint sz;
  struct proc *curproc = myproc();
...
801038be:	e8 0d 33 00 00       	call   80106bd0 <allocuvm>
...
801038f4:	e8 07 34 00 00       	call   80106d00 <deallocuvm>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103919:	e8 d2 09 00 00       	call   801042f0 <pushcli>
  c = mycpu();
8010391e:	e8 ad fd ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103923:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103929:	e8 02 0a 00 00       	call   80104330 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
...
80103948:	e8 63 35 00 00       	call   80106eb0 <cow>
...
801039c1:	e8 0a 0d 00 00       	call   801046d0 <safestrcpy>
...
801039d0:	e8 fb 09 00 00       	call   801043d0 <acquire>
...
801039e3:	e8 98 0a 00 00       	call   80104480 <release>
...
80103a5e:	e8 6d 09 00 00       	call   801043d0 <acquire>
...
80103a99:	c7 43 90 04 00 00 00 	movl   $0x4,-0x70(%ebx)
      ...
      swtch(&(c->scheduler), p->context);
80103aa0:	e8 86 0c 00 00       	call   8010472b <swtch>
      switchkvm();
...
80103ac8:	e8 b3 09 00 00       	call   80104480 <release>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103ae5:	e8 06 08 00 00       	call   801042f0 <pushcli>
  c = mycpu();
80103aea:	e8 e1 fb ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103aef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103af5:	e8 36 08 00 00       	call   80104330 <popcli>
sched(void)
{
  int intena;
...
80103b02:	e8 99 08 00 00       	call   801043a0 <holding>
...
80103b43:	e8 e3 0b 00 00       	call   8010472b <swtch>
  mycpu()->intena = intena;
...
80103b60:	68 70 77 10 80       	push   $0x80107770
...
80103b6d:	68 9c 77 10 80       	push   $0x8010779c
...
80103b7a:	68 8e 77 10 80       	push   $0x8010778e
...
80103b87:	68 82 77 10 80       	push   $0x80107782
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103ba9:	e8 42 07 00 00       	call   801042f0 <pushcli>
  c = mycpu();
80103bae:	e8 1d fb ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103bb3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103bb9:	e8 72 07 00 00       	call   80104330 <popcli>
{
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
...
80103c12:	e8 b9 07 00 00       	call   801043d0 <acquire>
...
80103cad:	68 bd 77 10 80       	push   $0x801077bd
...
80103cba:	68 b0 77 10 80       	push   $0x801077b0
...
80103cdc:	e8 ef 06 00 00       	call   801043d0 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103ce1:	e8 0a 06 00 00       	call   801042f0 <pushcli>
  c = mycpu();
80103ce6:	e8 e5 f9 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103ceb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103cf1:	e8 3a 06 00 00       	call   80104330 <popcli>
// Give up the CPU for one scheduling round.
void
yield(void)
{
...
80103d09:	e8 72 07 00 00       	call   80104480 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103d2f:	e8 bc 05 00 00       	call   801042f0 <pushcli>
  c = mycpu();
80103d34:	e8 97 f9 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103d39:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d3f:	e8 ec 05 00 00       	call   80104330 <popcli>
void
sleep(void *chan, struct spinlock *lk)
{
  struct proc *p = myproc();
...
80103d60:	e8 6b 06 00 00       	call   801043d0 <acquire>
    release(lk);
80103d65:	89 34 24             	mov    %esi,(%esp)
80103d68:	e8 13 07 00 00       	call   80104480 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103d8a:	e8 f1 06 00 00       	call   80104480 <release>
    acquire(lk);
...
80103d9b:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103d9c:	e9 2f 06 00 00       	jmp    801043d0 <acquire>
...
80103dc9:	68 cf 77 10 80       	push   $0x801077cf
...
80103dd6:	68 c9 77 10 80       	push   $0x801077c9
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103de5:	e8 06 05 00 00       	call   801042f0 <pushcli>
  c = mycpu();
80103dea:	e8 e1 f8 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103def:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103df5:	e8 36 05 00 00       	call   80104330 <popcli>
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80103e02:	e8 c9 05 00 00       	call   801043d0 <acquire>
...
80103e70:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e77:	e8 b4 2e 00 00       	call   80106d30 <freevm>
        p->pid = 0;
...
80103ea3:	e8 d8 05 00 00       	call   80104480 <release>
        return pid;
...
80103ebc:	e8 bf 05 00 00       	call   80104480 <release>
      return -1;
...
80103edf:	e8 ec 04 00 00       	call   801043d0 <acquire>
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f21:	e9 5a 05 00 00       	jmp    80104480 <release>
...
80103f3f:	e8 8c 04 00 00       	call   801043d0 <acquire>
...
80103f74:	e8 07 05 00 00       	call   80104480 <release>
      return 0;
...
80103fa0:	e8 db 04 00 00       	call   80104480 <release>
  return -1;
...
80103fc6:	bf c0 2d 11 80       	mov    $0x80112dc0,%edi
80103fcb:	be c0 4c 11 80       	mov    $0x80114cc0,%esi
80103fd0:	83 ec 3c             	sub    $0x3c,%esp
80103fd3:	90                   	nop
80103fd4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->state == UNUSED)
80103fd8:	8b 47 a0             	mov    -0x60(%edi),%eax
80103fdb:	85 c0                	test   %eax,%eax
80103fdd:	0f 84 dd 00 00 00    	je     801040c0 <procdump+0x100>
      continue;
...
80103fe3:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80103fe6:	ba e0 77 10 80       	mov    $0x801077e0,%edx
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->state == UNUSED)
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103feb:	77 11                	ja     80103ffe <procdump+0x3e>
80103fed:	8b 14 85 54 78 10 80 	mov    -0x7fef87ac(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80103ff4:	b8 e0 77 10 80       	mov    $0x801077e0,%eax
80103ff9:	85 d2                	test   %edx,%edx
80103ffb:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80103ffe:	57                   	push   %edi
80103fff:	52                   	push   %edx
80104000:	ff 77 a4             	pushl  -0x5c(%edi)
80104003:	68 e4 77 10 80       	push   $0x801077e4
80104008:	e8 53 c6 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
8010400d:	83 c4 10             	add    $0x10,%esp
80104010:	83 7f a0 02          	cmpl   $0x2,-0x60(%edi)
80104014:	0f 84 dc 00 00 00    	je     801040f6 <procdump+0x136>
...
8010401a:	83 ec 0c             	sub    $0xc,%esp
    ...
    // map VPN to PPN
    for (int j = 0; j < NPDENTRIES * NPDENTRIES; j++) {
8010401d:	31 db                	xor    %ebx,%ebx
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    ...
    cprintf("\n");
8010401f:	68 c3 7b 10 80       	push   $0x80107bc3
80104024:	e8 37 c6 ff ff       	call   80100660 <cprintf>
80104029:	83 c4 10             	add    $0x10,%esp
8010402c:	eb 0d                	jmp    8010403b <procdump+0x7b>
8010402e:	66 90                	xchg   %ax,%ax

    // added code starts from here
    // map VPN to PPN
    for (int j = 0; j < NPDENTRIES * NPDENTRIES; j++) {
80104030:	83 c3 01             	add    $0x1,%ebx
80104033:	81 fb 00 00 10 00    	cmp    $0x100000,%ebx
80104039:	74 75                	je     801040b0 <procdump+0xf0>
    	// virtual address
      	void *VA = (void *) (j << PTXSHIFT);
      	pde_t *pageEntry = &p->pgdir[PDX(VA)];
8010403b:	89 d8                	mov    %ebx,%eax


	    if (PTE_P & *pageEntry) {
8010403d:	8b 57 98             	mov    -0x68(%edi),%edx
    // added code starts from here
    // map VPN to PPN
    for (int j = 0; j < NPDENTRIES * NPDENTRIES; j++) {
    	// virtual address
      	void *VA = (void *) (j << PTXSHIFT);
      	pde_t *pageEntry = &p->pgdir[PDX(VA)];
80104040:	c1 e0 0c             	shl    $0xc,%eax


	    if (PTE_P & *pageEntry) {
80104043:	89 c1                	mov    %eax,%ecx
80104045:	c1 e9 16             	shr    $0x16,%ecx
80104048:	8b 14 8a             	mov    (%edx,%ecx,4),%edx

	        if (PTE_U & *pageEntry) {
8010404b:	89 d1                	mov    %edx,%ecx
8010404d:	83 e1 05             	and    $0x5,%ecx
80104050:	83 f9 05             	cmp    $0x5,%ecx
80104053:	75 db                	jne    80104030 <procdump+0x70>
	        	// P2V is a provided in memlayout.h
	          	pte_t *t = (pte_t*)P2V(PTE_ADDR(*pageEntry));
	          	// get table entry
	          	pte_t *addr = &t[PTX(VA)];
	          	// check flags
	          	if ((PTE_U & *addr) && (PTE_P & *addr)) {
80104055:	c1 e8 0c             	shr    $0xc,%eax
80104058:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
8010405e:	25 ff 03 00 00       	and    $0x3ff,%eax
80104063:	8b 84 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%eax
8010406a:	89 c2                	mov    %eax,%edx
8010406c:	83 e2 05             	and    $0x5,%edx
8010406f:	83 fa 05             	cmp    $0x5,%edx
80104072:	75 bc                	jne    80104030 <procdump+0x70>
	          		// check writeBit
	          		if (*addr & PTE_W) { 
80104074:	a8 02                	test   $0x2,%al
80104076:	75 60                	jne    801040d8 <procdump+0x118>
	          			cprintf("%d->%d %s", j, *addr >> PTXSHIFT, ", y\n");
		            } else if (*addr & PTE_SH) {
80104078:	f6 c4 01             	test   $0x1,%ah
8010407b:	74 6b                	je     801040e8 <procdump+0x128>
                  if (page_share_counter[*addr >> PTXSHIFT] == 1){
8010407d:	c1 e8 0c             	shr    $0xc,%eax
80104080:	80 b8 c0 54 11 80 01 	cmpb   $0x1,-0x7feeab40(%eax)
80104087:	74 66                	je     801040ef <procdump+0x12f>
                    cprintf("%d->%d %s", j, *addr >> PTXSHIFT, ", y\n");
                  } else {
                    cprintf("%d->%d %s", j, *addr >> PTXSHIFT, ", n\n");
80104089:	68 fc 77 10 80       	push   $0x801077fc
                  }
                } else {
	 					      cprintf("%d->%d %s", j, *addr >> PTXSHIFT, ", n\n");
...
80104090:	83 c3 01             	add    $0x1,%ebx
                    ...
                    cprintf("%d->%d %s", j, *addr >> PTXSHIFT, ", n\n");
	 					      ...
	 					      cprintf("%d->%d %s", j, *addr >> PTXSHIFT, ", n\n");
80104093:	68 f2 77 10 80       	push   $0x801077f2
...
8010409d:	83 c4 10             	add    $0x10,%esp
    ...
    // map VPN to PPN
    for (int j = 0; j < NPDENTRIES * NPDENTRIES; j++) {
801040a0:	81 fb 00 00 10 00    	cmp    $0x100000,%ebx
801040a6:	75 93                	jne    8010403b <procdump+0x7b>
801040a8:	90                   	nop
...
801040c0:	83 c7 7c             	add    $0x7c,%edi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040c3:	39 fe                	cmp    %edi,%esi
801040c5:	0f 85 0d ff ff ff    	jne    80103fd8 <procdump+0x18>
	    }
	}
	// new line
    cprintf("\n");
...
801040d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	          	...
	          	if ((PTE_U & *addr) && (PTE_P & *addr)) {
	          		...
	          		if (*addr & PTE_W) { 
	          			cprintf("%d->%d %s", j, *addr >> PTXSHIFT, ", y\n");
801040d8:	68 ed 77 10 80       	push   $0x801077ed
                    cprintf("%d->%d %s", j, *addr >> PTXSHIFT, ", y\n");
                  } else {
                    cprintf("%d->%d %s", j, *addr >> PTXSHIFT, ", n\n");
                  }
	 					      ...
	 					      cprintf("%d->%d %s", j, *addr >> PTXSHIFT, ", n\n");
801040dd:	c1 e8 0c             	shr    $0xc,%eax
801040e0:	eb ac                	jmp    8010408e <procdump+0xce>
801040e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801040e8:	68 fc 77 10 80       	push   $0x801077fc
801040ed:	eb ee                	jmp    801040dd <procdump+0x11d>
	          		// check writeBit
	          		if (*addr & PTE_W) { 
	          			cprintf("%d->%d %s", j, *addr >> PTXSHIFT, ", y\n");
		            } else if (*addr & PTE_SH) {
                  if (page_share_counter[*addr >> PTXSHIFT] == 1){
                    cprintf("%d->%d %s", j, *addr >> PTXSHIFT, ", y\n");
801040ef:	68 ed 77 10 80       	push   $0x801077ed
801040f4:	eb 98                	jmp    8010408e <procdump+0xce>
      state = states[p->state];
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
...
801040fc:	8d 5d c0             	lea    -0x40(%ebp),%ebx
801040ff:	50                   	push   %eax
80104100:	8b 47 b0             	mov    -0x50(%edi),%eax
80104103:	8b 40 0c             	mov    0xc(%eax),%eax
80104106:	83 c0 08             	add    $0x8,%eax
80104109:	50                   	push   %eax
8010410a:	e8 81 01 00 00       	call   80104290 <getcallerpcs>
8010410f:	83 c4 10             	add    $0x10,%esp
      for(i=0; i<10 && pc[i] != 0; i++)
80104112:	8b 03                	mov    (%ebx),%eax
80104114:	85 c0                	test   %eax,%eax
80104116:	0f 84 fe fe ff ff    	je     8010401a <procdump+0x5a>
        cprintf(" %p", pc[i]);
8010411c:	83 ec 08             	sub    $0x8,%esp
8010411f:	83 c3 04             	add    $0x4,%ebx
80104122:	50                   	push   %eax
80104123:	68 21 72 10 80       	push   $0x80107221
80104128:	e8 33 c5 ff ff       	call   80100660 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
8010412d:	8d 45 e8             	lea    -0x18(%ebp),%eax
80104130:	83 c4 10             	add    $0x10,%esp
80104133:	39 d8                	cmp    %ebx,%eax
80104135:	75 db                	jne    80104112 <procdump+0x152>
80104137:	e9 de fe ff ff       	jmp    8010401a <procdump+0x5a>
...
8010414a:	68 6c 78 10 80       	push   $0x8010786c
...
8010418f:	e8 3c 02 00 00       	call   801043d0 <acquire>
  while (lk->locked) {
...
801041a5:	e8 76 fb ff ff       	call   80103d20 <sleep>
...
801041b3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801041b9:	e8 b2 f5 ff ff       	call   80103770 <myproc>
...
801041cc:	5d                   	pop    %ebp
  ...
  lk->pid = myproc()->pid;
  release(&lk->lk);
801041cd:	e9 ae 02 00 00       	jmp    80104480 <release>
...
801041ef:	e8 dc 01 00 00       	call   801043d0 <acquire>
  lk->locked = 0;
...
80104204:	e8 c7 fc ff ff       	call   80103ed0 <wakeup>
  release(&lk->lk);
...
80104214:	5d                   	pop    %ebp
{
  ...
  wakeup(lk);
  release(&lk->lk);
80104215:	e9 66 02 00 00       	jmp    80104480 <release>
...
80104232:	e8 99 01 00 00       	call   801043d0 <acquire>
...
80104243:	e8 28 f5 ff ff       	call   80103770 <myproc>
...
80104257:	e8 24 02 00 00       	call   80104480 <release>
  return r;
}
...
801042f9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801042fa:	e8 d1 f3 ff ff       	call   801036d0 <mycpu>
...
8010430f:	e8 bc f3 ff ff       	call   801036d0 <mycpu>
80104314:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010431a:	e8 b1 f3 ff ff       	call   801036d0 <mycpu>
...
8010433b:	75 52                	jne    8010438f <popcli+0x5f>
  ...
  if(--mycpu()->ncli < 0)
8010433d:	e8 8e f3 ff ff       	call   801036d0 <mycpu>
...
80104355:	e8 76 f3 ff ff       	call   801036d0 <mycpu>
...
80104369:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104370:	e8 5b f3 ff ff       	call   801036d0 <mycpu>
...
80104385:	68 8e 78 10 80       	push   $0x8010788e
...
80104392:	68 77 78 10 80       	push   $0x80107877
...
801043b8:	e8 13 f3 ff ff       	call   801036d0 <mycpu>
801043bd:	39 c3                	cmp    %eax,%ebx
801043bf:	0f 94 c3             	sete   %bl
801043c2:	0f b6 db             	movzbl %bl,%ebx
  popcli();
801043c5:	e8 66 ff ff ff       	call   80104330 <popcli>
  return r;
}
...
801043e3:	e8 b8 ff ff ff       	call   801043a0 <holding>
801043e8:	83 c4 10             	add    $0x10,%esp
801043eb:	85 c0                	test   %eax,%eax
801043ed:	0f 85 7d 00 00 00    	jne    80104470 <acquire+0xa0>
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80104414:	e8 b7 f2 ff ff       	call   801036d0 <mycpu>
getcallerpcs(void *v, uint pcs[])
{
  uint *ebp;
  int i;
...
8010445d:	74 e7                	je     80104446 <acquire+0x76>
    pcs[i] = 0;
...
8010446c:	75 e2                	jne    80104450 <acquire+0x80>
8010446e:	eb d6                	jmp    80104446 <acquire+0x76>
void
acquire(struct spinlock *lk)
{
  pushcli(); // disable interrupts to avoid deadlock.
...
80104473:	68 95 78 10 80       	push   $0x80107895
80104478:	e8 f3 be ff ff       	call   80100370 <panic>
...
8010448b:	e8 10 ff ff ff       	call   801043a0 <holding>
...
801044bc:	68 9d 78 10 80       	push   $0x8010789d
...
80104787:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010478a:	e8 e1 ef ff ff       	call   80103770 <myproc>
...
801047e5:	e8 86 ef ff ff       	call   80103770 <myproc>
...
{
  struct proc *curproc = myproc();
801047f6:	e8 75 ef ff ff       	call   80103770 <myproc>
...
80104838:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010483b:	e8 30 ef ff ff       	call   80103770 <myproc>
...
801048d4:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
801048d5:	e8 96 ee ff ff       	call   80103770 <myproc>
...
801048e5:	83 fa 15             	cmp    $0x15,%edx
801048e8:	77 1e                	ja     80104908 <syscall+0x38>
801048ea:	8b 14 85 e0 78 10 80 	mov    -0x7fef8720(,%eax,4),%edx
...
80104910:	68 a5 78 10 80       	push   $0x801078a5
...
create(char *path, short type, short major, short minor)
{
80104939:	83 ec 34             	sub    $0x34,%esp
8010493c:	89 4d d0             	mov    %ecx,-0x30(%ebp)
...
create(char *path, short type, short major, short minor)
{
80104944:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104947:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
8010494a:	e8 81 d5 ff ff       	call   80101ed0 <nameiparent>
...
80104960:	e8 fb cc ff ff       	call   80101660 <ilock>
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
80104965:	83 c4 0c             	add    $0xc,%esp
80104968:	6a 00                	push   $0x0
8010496a:	56                   	push   %esi
8010496b:	57                   	push   %edi
8010496c:	e8 1f d2 ff ff       	call   80101b90 <dirlookup>
80104971:	83 c4 10             	add    $0x10,%esp
80104974:	85 c0                	test   %eax,%eax
80104976:	89 c3                	mov    %eax,%ebx
80104978:	74 56                	je     801049d0 <create+0xa0>
    iunlockput(dp);
8010497a:	83 ec 0c             	sub    $0xc,%esp
8010497d:	57                   	push   %edi
8010497e:	e8 6d cf ff ff       	call   801018f0 <iunlockput>
    ilock(ip);
80104983:	89 1c 24             	mov    %ebx,(%esp)
80104986:	e8 d5 cc ff ff       	call   80101660 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
8010498b:	83 c4 10             	add    $0x10,%esp
8010498e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104993:	75 1b                	jne    801049b0 <create+0x80>
80104995:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
8010499a:	89 d8                	mov    %ebx,%eax
8010499c:	75 12                	jne    801049b0 <create+0x80>
...
801049b4:	e8 37 cf ff ff       	call   801018f0 <iunlockput>
    return 0;
...
801049da:	e8 11 cb ff ff       	call   801014f0 <ialloc>
...
801049f0:	e8 6b cc ff ff       	call   80101660 <ilock>
  ip->major = major;
...
80104a11:	e8 9a cb ff ff       	call   801015b0 <iupdate>
...
80104a28:	e8 c3 d3 ff ff       	call   80101df0 <dirlink>
...
80104a38:	e8 b3 ce ff ff       	call   801018f0 <iunlockput>
...
80104a52:	e9 47 ff ff ff       	jmp    8010499e <create+0x6e>
...
80104a69:	e8 42 cb ff ff       	call   801015b0 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104a6e:	83 c4 0c             	add    $0xc,%esp
80104a71:	ff 73 04             	pushl  0x4(%ebx)
80104a74:	68 58 79 10 80       	push   $0x80107958
80104a79:	53                   	push   %ebx
80104a7a:	e8 71 d3 ff ff       	call   80101df0 <dirlink>
...
80104a8c:	68 57 79 10 80       	push   $0x80107957
80104a91:	53                   	push   %ebx
80104a92:	e8 59 d3 ff ff       	call   80101df0 <dirlink>
...
80104aa1:	68 4b 79 10 80       	push   $0x8010794b
...
80104aae:	68 5a 79 10 80       	push   $0x8010795a
...
80104abb:	68 3c 79 10 80       	push   $0x8010793c
...
80104af4:	e8 77 ec ff ff       	call   80103770 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80104b5b:	e8 10 ec ff ff       	call   80103770 <myproc>
...
80104c93:	78 2b                	js     80104cc0 <sys_close+0x40>
    return -1;
  myproc()->ofile[fd] = 0;
80104c95:	e8 d6 ea ff ff       	call   80103770 <myproc>
...
80104d52:	0f 88 e2 00 00 00    	js     80104e3a <sys_link+0x11a>
  ...
  begin_op();
80104d58:	e8 e3 dd ff ff       	call   80102b40 <begin_op>
  if((ip = namei(old)) == 0){
80104d5d:	83 ec 0c             	sub    $0xc,%esp
80104d60:	ff 75 d4             	pushl  -0x2c(%ebp)
80104d63:	e8 48 d1 ff ff       	call   80101eb0 <namei>
...
80104dab:	e8 20 d1 ff ff       	call   80101ed0 <nameiparent>
...
80104dd3:	e8 18 d0 ff ff       	call   80101df0 <dirlink>
...
80104de3:	e8 08 cb ff ff       	call   801018f0 <iunlockput>
  iput(ip);
80104de8:	89 1c 24             	mov    %ebx,(%esp)
80104deb:	e8 a0 c9 ff ff       	call   80101790 <iput>

  end_op();
80104df0:	e8 bb dd ff ff       	call   80102bb0 <end_op>
...
80104e0c:	e8 df ca ff ff       	call   801018f0 <iunlockput>
    goto bad;
...
80104e2d:	e8 be ca ff ff       	call   801018f0 <iunlockput>
  end_op();
80104e32:	e8 79 dd ff ff       	call   80102bb0 <end_op>
  return -1;
...
80104e54:	e8 97 ca ff ff       	call   801018f0 <iunlockput>
    end_op();
80104e59:	e8 52 dd ff ff       	call   80102bb0 <end_op>
    return -1;
...
80104e66:	eb 92                	jmp    80104dfa <sys_link+0xda>
  ...
  if((ip = namei(old)) == 0){
    end_op();
80104e68:	e8 43 dd ff ff       	call   80102bb0 <end_op>
    return -1;
...
80104e9f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  ...
  begin_op();
80104ea2:	e8 99 dc ff ff       	call   80102b40 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104ea7:	83 ec 08             	sub    $0x8,%esp
80104eaa:	53                   	push   %ebx
80104eab:	ff 75 c0             	pushl  -0x40(%ebp)
80104eae:	e8 1d d0 ff ff       	call   80101ed0 <nameiparent>
...
80104ecd:	58                   	pop    %eax
80104ece:	5a                   	pop    %edx
80104ecf:	68 58 79 10 80       	push   $0x80107958
80104ed4:	53                   	push   %ebx
80104ed5:	e8 96 cc ff ff       	call   80101b70 <namecmp>
...
80104ee8:	68 57 79 10 80       	push   $0x80107957
80104eed:	53                   	push   %ebx
80104eee:	e8 7d cc ff ff       	call   80101b70 <namecmp>
...
80104f07:	e8 84 cc ff ff       	call   80101b90 <dirlookup>
...
80104f50:	e8 eb ca ff ff       	call   80101a40 <writei>
...
80104f72:	e8 79 c9 ff ff       	call   801018f0 <iunlockput>
...
80104fc1:	e8 7a c9 ff ff       	call   80101940 <readi>
...
80104fd9:	e8 12 c9 ff ff       	call   801018f0 <iunlockput>
    goto bad;
...
80105026:	e9 6b ff ff ff       	jmp    80104f96 <sys_unlink+0x116>
  ...
  if((dp = nameiparent(path, name)) == 0){
    end_op();
8010502b:	e8 80 db ff ff       	call   80102bb0 <end_op>
    return -1;
...
8010503d:	68 7c 79 10 80       	push   $0x8010797c
...
8010504a:	68 8e 79 10 80       	push   $0x8010798e
...
80105057:	68 6a 79 10 80       	push   $0x8010796a
...
801050a2:	0f 88 85 00 00 00    	js     8010512d <sys_open+0xbd>
  ...
  begin_op();
801050a8:	e8 93 da ff ff       	call   80102b40 <begin_op>
...
801050bd:	e8 ee cd ff ff       	call   80101eb0 <namei>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
801050f3:	e8 78 e6 ff ff       	call   80103770 <myproc>
801050f8:	90                   	nop
...
80105120:	e8 cb c7 ff ff       	call   801018f0 <iunlockput>
    end_op();
...
8010515b:	75 89                	jne    801050e6 <sys_open+0x76>
      end_op();
8010515d:	e8 4e da ff ff       	call   80102bb0 <end_op>
      return -1;
...
8010520f:	e8 dc c6 ff ff       	call   801018f0 <iunlockput>
  end_op();
80105214:	e8 97 d9 ff ff       	call   80102bb0 <end_op>
  return 0;
...
8010529e:	e8 4d c6 ff ff       	call   801018f0 <iunlockput>
  end_op();
801052a3:	e8 08 d9 ff ff       	call   80102bb0 <end_op>
  return 0;
...
801052c5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801052c8:	e8 a3 e4 ff ff       	call   80103770 <myproc>
801052cd:	89 c6                	mov    %eax,%esi
  
  begin_op();
801052cf:	e8 6c d8 ff ff       	call   80102b40 <begin_op>
...
801052ef:	e8 bc cb ff ff       	call   80101eb0 <namei>
...
80105301:	e8 5a c3 ff ff       	call   80101660 <ilock>
  if(ip->type != T_DIR){
...
80105314:	e8 27 c4 ff ff       	call   80101740 <iunlock>
  iput(curproc->cwd);
80105319:	58                   	pop    %eax
8010531a:	ff 76 68             	pushl  0x68(%esi)
8010531d:	e8 6e c4 ff ff       	call   80101790 <iput>
  end_op();
80105322:	e8 89 d8 ff ff       	call   80102bb0 <end_op>
  curproc->cwd = ip;
...
80105344:	e8 a7 c5 ff ff       	call   801018f0 <iunlockput>
    end_op();
80105349:	e8 62 d8 ff ff       	call   80102bb0 <end_op>
    return -1;
...
80105359:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
    end_op();
80105360:	e8 4b d8 ff ff       	call   80102bb0 <end_op>
    return -1;
...
80105478:	e8 63 dd ff ff       	call   801031e0 <pipealloc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105489:	e8 e2 e2 ff ff       	call   80103770 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
801054d2:	e8 99 e2 ff ff       	call   80103770 <myproc>
...
801054ee:	75 f0                	jne    801054e0 <sys_pipe+0x90>
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
801054f0:	e8 7b e2 ff ff       	call   80103770 <myproc>
...
{
  return fork();
80105524:	e9 e7 e3 ff ff       	jmp    80103910 <fork>
...
80105533:	83 ec 08             	sub    $0x8,%esp
  exit();
80105536:	e8 65 e6 ff ff       	call   80103ba0 <exit>
...
{
  return wait();
80105544:	e9 97 e8 ff ff       	jmp    80103de0 <wait>
...
8010556e:	e8 bd e9 ff ff       	call   80103f30 <kill>
...
80105593:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105596:	e8 d5 e1 ff ff       	call   80103770 <myproc>
...
801055b7:	78 27                	js     801055e0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801055b9:	e8 b2 e1 ff ff       	call   80103770 <myproc>
  if(growproc(n) < 0)
...
801055c6:	e8 c5 e2 ff ff       	call   80103890 <growproc>
...
8010564f:	73 2f                	jae    80105680 <sys_sleep+0x90>
    if(myproc()->killed){
80105651:	e8 1a e1 ff ff       	call   80103770 <myproc>
...
801056ac:	e8 1f ed ff ff       	call   801043d0 <acquire>
  xticks = ticks;
...
801056d3:	83 ec 08             	sub    $0x8,%esp
  procdump();
801056d6:	e8 e5 e8 ff ff       	call   80103fc0 <procdump>
  return 0;
...
801056e0:	06                   	push   %es
  pushl %fs
801056e1:	0f a0                	push   %fs
  pushl %gs
801056e3:	0f a8                	push   %gs
  pushal
801056e5:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801056e6:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801056ea:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801056ec:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801056ee:	54                   	push   %esp
  call trap
801056ef:	e8 ec 00 00 00       	call   801057e0 <trap>
  addl $4, %esp
801056f4:	83 c4 04             	add    $0x4,%esp
...
801056f7:	61                   	popa   
  popl %gs
801056f8:	0f a9                	pop    %gs
  popl %fs
801056fa:	0f a1                	pop    %fs
  popl %es
801056fc:	07                   	pop    %es
  popl %ds
801056fd:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801056fe:	83 c4 08             	add    $0x8,%esp
  iret
80105701:	cf                   	iret   
80105702:	66 90                	xchg   %ax,%ax
80105704:	66 90                	xchg   %ax,%ax
...
80105718:	8b 14 85 08 a0 10 80 	mov    -0x7fef5ff8(,%eax,4),%edx
8010571f:	b9 08 00 00 00       	mov    $0x8,%ecx
80105724:	c6 04 c5 a4 4c 11 80 	movb   $0x0,-0x7feeb35c(,%eax,8)
8010572b:	00 
8010572c:	66 89 0c c5 a2 4c 11 	mov    %cx,-0x7feeb35e(,%eax,8)
80105733:	80 
80105734:	c6 04 c5 a5 4c 11 80 	movb   $0x8e,-0x7feeb35b(,%eax,8)
8010573b:	8e 
8010573c:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105743:	80 
80105744:	c1 ea 10             	shr    $0x10,%edx
80105747:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
8010574e:	80 
void
tvinit(void)
{
...
80105761:	83 ec 10             	sub    $0x10,%esp
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105764:	a1 08 a1 10 80       	mov    0x8010a108,%eax

  initlock(&tickslock, "time");
80105769:	68 9d 79 10 80       	push   $0x8010799d
8010576e:	68 60 4c 11 80       	push   $0x80114c60
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105773:	66 89 15 a2 4e 11 80 	mov    %dx,0x80114ea2
8010577a:	c6 05 a4 4e 11 80 00 	movb   $0x0,0x80114ea4
80105781:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
80105787:	c1 e8 10             	shr    $0x10,%eax
8010578a:	c6 05 a5 4e 11 80 ef 	movb   $0xef,0x80114ea5
80105791:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6

  initlock(&tickslock, "time");
80105797:	e8 d4 ea ff ff       	call   80104270 <initlock>
}
8010579c:	83 c4 10             	add    $0x10,%esp
8010579f:	c9                   	leave  
801057a0:	c3                   	ret    
801057a1:	eb 0d                	jmp    801057b0 <idtinit>
801057a3:	90                   	nop
801057a4:	90                   	nop
801057a5:	90                   	nop
801057a6:	90                   	nop
...
801057f2:	0f 84 98 01 00 00    	je     80105990 <trap+0x1b0>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
801057f8:	83 e8 0e             	sub    $0xe,%eax
801057fb:	83 f8 31             	cmp    $0x31,%eax
801057fe:	77 10                	ja     80105810 <trap+0x30>
80105800:	ff 24 85 44 7a 10 80 	jmp    *-0x7fef85bc(,%eax,4)
...
80105817:	0f 84 e7 01 00 00    	je     80105a04 <trap+0x224>
8010581d:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105821:	0f 84 dd 01 00 00    	je     80105a04 <trap+0x224>
...
8010582a:	8b 57 38             	mov    0x38(%edi),%edx
8010582d:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105830:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105833:	e8 18 df ff ff       	call   80103750 <cpuid>
80105838:	8b 77 34             	mov    0x34(%edi),%esi
8010583b:	8b 5f 30             	mov    0x30(%edi),%ebx
8010583e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105841:	e8 2a df ff ff       	call   80103770 <myproc>
...
80105855:	52                   	push   %edx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105856:	8b 55 e0             	mov    -0x20(%ebp),%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105859:	ff 75 e4             	pushl  -0x1c(%ebp)
...
80105865:	68 00 7a 10 80       	push   $0x80107a00
...
80105872:	e8 f9 de ff ff       	call   80103770 <myproc>
...
80105887:	74 0c                	je     80105895 <trap+0xb5>
80105889:	e8 e2 de ff ff       	call   80103770 <myproc>
8010588e:	8b 50 24             	mov    0x24(%eax),%edx
80105891:	85 d2                	test   %edx,%edx
80105893:	75 4b                	jne    801058e0 <trap+0x100>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105895:	e8 d6 de ff ff       	call   80103770 <myproc>
8010589a:	85 c0                	test   %eax,%eax
8010589c:	74 0b                	je     801058a9 <trap+0xc9>
8010589e:	e8 cd de ff ff       	call   80103770 <myproc>
801058a3:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801058a7:	74 4f                	je     801058f8 <trap+0x118>
...
801058b0:	74 1d                	je     801058cf <trap+0xef>
801058b2:	e8 b9 de ff ff       	call   80103770 <myproc>
801058b7:	8b 40 24             	mov    0x24(%eax),%eax
801058ba:	85 c0                	test   %eax,%eax
801058bc:	74 11                	je     801058cf <trap+0xef>
801058be:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
801058c2:	83 e0 03             	and    $0x3,%eax
801058c5:	66 83 f8 03          	cmp    $0x3,%ax
801058c9:	0f 84 ea 00 00 00    	je     801059b9 <trap+0x1d9>
    exit();
}
...
801058d9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  // until it gets to the regular system call return.)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058e0:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
801058e4:	83 e0 03             	and    $0x3,%eax
801058e7:	66 83 f8 03          	cmp    $0x3,%ax
801058eb:	75 a8                	jne    80105895 <trap+0xb5>
    exit();
801058ed:	e8 ae e2 ff ff       	call   80103ba0 <exit>
801058f2:	eb a1                	jmp    80105895 <trap+0xb5>
801058f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801058f8:	83 7f 30 20          	cmpl   $0x20,0x30(%edi)
801058fc:	75 ab                	jne    801058a9 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
801058fe:	e8 cd e3 ff ff       	call   80103cd0 <yield>
80105903:	eb a4                	jmp    801058a9 <trap+0xc9>
80105905:	8d 76 00             	lea    0x0(%esi),%esi
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
    break;
  // added pagefault case
  case T_PGFLT:
    pagefault();
80105908:	e8 93 17 00 00       	call   801070a0 <pagefault>
    break;
8010590d:	e9 6e ff ff ff       	jmp    80105880 <trap+0xa0>
80105912:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105918:	e8 33 de ff ff       	call   80103750 <cpuid>
8010591d:	85 c0                	test   %eax,%eax
8010591f:	0f 84 ab 00 00 00    	je     801059d0 <trap+0x1f0>
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
...
80105925:	e8 d6 cd ff ff       	call   80102700 <lapiceoi>
    break;
8010592a:	e9 51 ff ff ff       	jmp    80105880 <trap+0xa0>
8010592f:	90                   	nop
...
80105935:	e8 c6 cd ff ff       	call   80102700 <lapiceoi>
    break;
8010593a:	e9 41 ff ff ff       	jmp    80105880 <trap+0xa0>
8010593f:	90                   	nop
...
80105945:	e8 b6 cd ff ff       	call   80102700 <lapiceoi>
    break;
8010594a:	e9 31 ff ff ff       	jmp    80105880 <trap+0xa0>
8010594f:	90                   	nop
  case T_IRQ0 + 7:
...
80105957:	e8 f4 dd ff ff       	call   80103750 <cpuid>
8010595c:	56                   	push   %esi
8010595d:	53                   	push   %ebx
8010595e:	50                   	push   %eax
8010595f:	68 a8 79 10 80       	push   $0x801079a8
80105964:	e8 f7 ac ff ff       	call   80100660 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80105969:	e8 92 cd ff ff       	call   80102700 <lapiceoi>
    break;
8010596e:	83 c4 10             	add    $0x10,%esp
80105971:	e9 0a ff ff ff       	jmp    80105880 <trap+0xa0>
...
80105979:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105980:	e8 bb c6 ff ff       	call   80102040 <ideintr>
80105985:	eb 9e                	jmp    80105925 <trap+0x145>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
80105990:	e8 db dd ff ff       	call   80103770 <myproc>
80105995:	8b 58 24             	mov    0x24(%eax),%ebx
80105998:	85 db                	test   %ebx,%ebx
8010599a:	75 2c                	jne    801059c8 <trap+0x1e8>
      exit();
    myproc()->tf = tf;
8010599c:	e8 cf dd ff ff       	call   80103770 <myproc>
801059a1:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801059a4:	e8 27 ef ff ff       	call   801048d0 <syscall>
    if(myproc()->killed)
801059a9:	e8 c2 dd ff ff       	call   80103770 <myproc>
801059ae:	8b 48 24             	mov    0x24(%eax),%ecx
801059b1:	85 c9                	test   %ecx,%ecx
801059b3:	0f 84 16 ff ff ff    	je     801058cf <trap+0xef>
    yield();
...
801059bf:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
801059c0:	e9 db e1 ff ff       	jmp    80103ba0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
801059c8:	e8 d3 e1 ff ff       	call   80103ba0 <exit>
801059cd:	eb cd                	jmp    8010599c <trap+0x1bc>
801059cf:	90                   	nop
  }
...
801059d3:	68 60 4c 11 80       	push   $0x80114c60
801059d8:	e8 f3 e9 ff ff       	call   801043d0 <acquire>
      ticks++;
      wakeup(&ticks);
801059dd:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
801059e4:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
801059eb:	e8 e0 e4 ff ff       	call   80103ed0 <wakeup>
      release(&tickslock);
801059f0:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801059f7:	e8 84 ea ff ff       	call   80104480 <release>
801059fc:	83 c4 10             	add    $0x10,%esp
801059ff:	e9 21 ff ff ff       	jmp    80105925 <trap+0x145>
...
80105a0a:	e8 41 dd ff ff       	call   80103750 <cpuid>
...
80105a18:	68 cc 79 10 80       	push   $0x801079cc
80105a1d:	e8 3e ac ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105a22:	83 c4 14             	add    $0x14,%esp
80105a25:	68 a2 79 10 80       	push   $0x801079a2
...
80105a85:	e8 96 cc ff ff       	call   80102720 <microdelay>
{
  int i;
...
80105b1f:	bb 0c 7b 10 80       	mov    $0x80107b0c,%ebx
80105b24:	6a 00                	push   $0x0
80105b26:	6a 04                	push   $0x4
80105b28:	e8 63 c7 ff ff       	call   80102290 <ioapicenable>
...
80105bb7:	6a 00                	push   $0x0
  jmp alltraps
80105bb9:	e9 21 fb ff ff       	jmp    801056df <alltraps>
...
80105bc0:	6a 01                	push   $0x1
  jmp alltraps
80105bc2:	e9 18 fb ff ff       	jmp    801056df <alltraps>
...
80105bc9:	6a 02                	push   $0x2
  jmp alltraps
80105bcb:	e9 0f fb ff ff       	jmp    801056df <alltraps>
...
80105bd2:	6a 03                	push   $0x3
  jmp alltraps
80105bd4:	e9 06 fb ff ff       	jmp    801056df <alltraps>
...
80105bdb:	6a 04                	push   $0x4
  jmp alltraps
80105bdd:	e9 fd fa ff ff       	jmp    801056df <alltraps>
...
80105be4:	6a 05                	push   $0x5
  jmp alltraps
80105be6:	e9 f4 fa ff ff       	jmp    801056df <alltraps>
...
80105bed:	6a 06                	push   $0x6
  jmp alltraps
80105bef:	e9 eb fa ff ff       	jmp    801056df <alltraps>
...
80105bf6:	6a 07                	push   $0x7
  jmp alltraps
80105bf8:	e9 e2 fa ff ff       	jmp    801056df <alltraps>
...
80105bfd:	6a 08                	push   $0x8
  jmp alltraps
80105bff:	e9 db fa ff ff       	jmp    801056df <alltraps>
...
80105c06:	6a 09                	push   $0x9
  jmp alltraps
80105c08:	e9 d2 fa ff ff       	jmp    801056df <alltraps>
...
80105c0d:	6a 0a                	push   $0xa
  jmp alltraps
80105c0f:	e9 cb fa ff ff       	jmp    801056df <alltraps>
...
80105c14:	6a 0b                	push   $0xb
  jmp alltraps
80105c16:	e9 c4 fa ff ff       	jmp    801056df <alltraps>
...
80105c1b:	6a 0c                	push   $0xc
  jmp alltraps
80105c1d:	e9 bd fa ff ff       	jmp    801056df <alltraps>
...
80105c22:	6a 0d                	push   $0xd
  jmp alltraps
80105c24:	e9 b6 fa ff ff       	jmp    801056df <alltraps>
...
80105c29:	6a 0e                	push   $0xe
  jmp alltraps
80105c2b:	e9 af fa ff ff       	jmp    801056df <alltraps>
...
80105c32:	6a 0f                	push   $0xf
  jmp alltraps
80105c34:	e9 a6 fa ff ff       	jmp    801056df <alltraps>
...
80105c3b:	6a 10                	push   $0x10
  jmp alltraps
80105c3d:	e9 9d fa ff ff       	jmp    801056df <alltraps>
...
80105c42:	6a 11                	push   $0x11
  jmp alltraps
80105c44:	e9 96 fa ff ff       	jmp    801056df <alltraps>
...
80105c4b:	6a 12                	push   $0x12
  jmp alltraps
80105c4d:	e9 8d fa ff ff       	jmp    801056df <alltraps>
...
80105c54:	6a 13                	push   $0x13
  jmp alltraps
80105c56:	e9 84 fa ff ff       	jmp    801056df <alltraps>
...
80105c5d:	6a 14                	push   $0x14
  jmp alltraps
80105c5f:	e9 7b fa ff ff       	jmp    801056df <alltraps>
...
80105c66:	6a 15                	push   $0x15
  jmp alltraps
80105c68:	e9 72 fa ff ff       	jmp    801056df <alltraps>
...
80105c6f:	6a 16                	push   $0x16
  jmp alltraps
80105c71:	e9 69 fa ff ff       	jmp    801056df <alltraps>
...
80105c78:	6a 17                	push   $0x17
  jmp alltraps
80105c7a:	e9 60 fa ff ff       	jmp    801056df <alltraps>
...
80105c81:	6a 18                	push   $0x18
  jmp alltraps
80105c83:	e9 57 fa ff ff       	jmp    801056df <alltraps>
...
80105c8a:	6a 19                	push   $0x19
  jmp alltraps
80105c8c:	e9 4e fa ff ff       	jmp    801056df <alltraps>
...
80105c93:	6a 1a                	push   $0x1a
  jmp alltraps
80105c95:	e9 45 fa ff ff       	jmp    801056df <alltraps>
...
80105c9c:	6a 1b                	push   $0x1b
  jmp alltraps
80105c9e:	e9 3c fa ff ff       	jmp    801056df <alltraps>
...
80105ca5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ca7:	e9 33 fa ff ff       	jmp    801056df <alltraps>
...
80105cae:	6a 1d                	push   $0x1d
  jmp alltraps
80105cb0:	e9 2a fa ff ff       	jmp    801056df <alltraps>
...
80105cb7:	6a 1e                	push   $0x1e
  jmp alltraps
80105cb9:	e9 21 fa ff ff       	jmp    801056df <alltraps>
...
80105cc0:	6a 1f                	push   $0x1f
  jmp alltraps
80105cc2:	e9 18 fa ff ff       	jmp    801056df <alltraps>
...
80105cc9:	6a 20                	push   $0x20
  jmp alltraps
80105ccb:	e9 0f fa ff ff       	jmp    801056df <alltraps>
...
80105cd2:	6a 21                	push   $0x21
  jmp alltraps
80105cd4:	e9 06 fa ff ff       	jmp    801056df <alltraps>
...
80105cdb:	6a 22                	push   $0x22
  jmp alltraps
80105cdd:	e9 fd f9 ff ff       	jmp    801056df <alltraps>
...
80105ce4:	6a 23                	push   $0x23
  jmp alltraps
80105ce6:	e9 f4 f9 ff ff       	jmp    801056df <alltraps>
...
80105ced:	6a 24                	push   $0x24
  jmp alltraps
80105cef:	e9 eb f9 ff ff       	jmp    801056df <alltraps>
...
80105cf6:	6a 25                	push   $0x25
  jmp alltraps
80105cf8:	e9 e2 f9 ff ff       	jmp    801056df <alltraps>
...
80105cff:	6a 26                	push   $0x26
  jmp alltraps
80105d01:	e9 d9 f9 ff ff       	jmp    801056df <alltraps>
...
80105d08:	6a 27                	push   $0x27
  jmp alltraps
80105d0a:	e9 d0 f9 ff ff       	jmp    801056df <alltraps>
...
80105d11:	6a 28                	push   $0x28
  jmp alltraps
80105d13:	e9 c7 f9 ff ff       	jmp    801056df <alltraps>
...
80105d1a:	6a 29                	push   $0x29
  jmp alltraps
80105d1c:	e9 be f9 ff ff       	jmp    801056df <alltraps>
...
80105d23:	6a 2a                	push   $0x2a
  jmp alltraps
80105d25:	e9 b5 f9 ff ff       	jmp    801056df <alltraps>
...
80105d2c:	6a 2b                	push   $0x2b
  jmp alltraps
80105d2e:	e9 ac f9 ff ff       	jmp    801056df <alltraps>
...
80105d35:	6a 2c                	push   $0x2c
  jmp alltraps
80105d37:	e9 a3 f9 ff ff       	jmp    801056df <alltraps>
...
80105d3e:	6a 2d                	push   $0x2d
  jmp alltraps
80105d40:	e9 9a f9 ff ff       	jmp    801056df <alltraps>
...
80105d47:	6a 2e                	push   $0x2e
  jmp alltraps
80105d49:	e9 91 f9 ff ff       	jmp    801056df <alltraps>
...
80105d50:	6a 2f                	push   $0x2f
  jmp alltraps
80105d52:	e9 88 f9 ff ff       	jmp    801056df <alltraps>
...
80105d59:	6a 30                	push   $0x30
  jmp alltraps
80105d5b:	e9 7f f9 ff ff       	jmp    801056df <alltraps>
...
80105d62:	6a 31                	push   $0x31
  jmp alltraps
80105d64:	e9 76 f9 ff ff       	jmp    801056df <alltraps>
...
80105d6b:	6a 32                	push   $0x32
  jmp alltraps
80105d6d:	e9 6d f9 ff ff       	jmp    801056df <alltraps>
...
80105d74:	6a 33                	push   $0x33
  jmp alltraps
80105d76:	e9 64 f9 ff ff       	jmp    801056df <alltraps>
...
80105d7d:	6a 34                	push   $0x34
  jmp alltraps
80105d7f:	e9 5b f9 ff ff       	jmp    801056df <alltraps>
...
80105d86:	6a 35                	push   $0x35
  jmp alltraps
80105d88:	e9 52 f9 ff ff       	jmp    801056df <alltraps>
...
80105d8f:	6a 36                	push   $0x36
  jmp alltraps
80105d91:	e9 49 f9 ff ff       	jmp    801056df <alltraps>
...
80105d98:	6a 37                	push   $0x37
  jmp alltraps
80105d9a:	e9 40 f9 ff ff       	jmp    801056df <alltraps>
...
80105da1:	6a 38                	push   $0x38
  jmp alltraps
80105da3:	e9 37 f9 ff ff       	jmp    801056df <alltraps>
...
80105daa:	6a 39                	push   $0x39
  jmp alltraps
80105dac:	e9 2e f9 ff ff       	jmp    801056df <alltraps>
...
80105db3:	6a 3a                	push   $0x3a
  jmp alltraps
80105db5:	e9 25 f9 ff ff       	jmp    801056df <alltraps>
...
80105dbc:	6a 3b                	push   $0x3b
  jmp alltraps
80105dbe:	e9 1c f9 ff ff       	jmp    801056df <alltraps>
...
80105dc5:	6a 3c                	push   $0x3c
  jmp alltraps
80105dc7:	e9 13 f9 ff ff       	jmp    801056df <alltraps>
...
80105dce:	6a 3d                	push   $0x3d
  jmp alltraps
80105dd0:	e9 0a f9 ff ff       	jmp    801056df <alltraps>
...
80105dd7:	6a 3e                	push   $0x3e
  jmp alltraps
80105dd9:	e9 01 f9 ff ff       	jmp    801056df <alltraps>
...
80105de0:	6a 3f                	push   $0x3f
  jmp alltraps
80105de2:	e9 f8 f8 ff ff       	jmp    801056df <alltraps>
...
80105de9:	6a 40                	push   $0x40
  jmp alltraps
80105deb:	e9 ef f8 ff ff       	jmp    801056df <alltraps>
...
80105df2:	6a 41                	push   $0x41
  jmp alltraps
80105df4:	e9 e6 f8 ff ff       	jmp    801056df <alltraps>
...
80105dfb:	6a 42                	push   $0x42
  jmp alltraps
80105dfd:	e9 dd f8 ff ff       	jmp    801056df <alltraps>
...
80105e04:	6a 43                	push   $0x43
  jmp alltraps
80105e06:	e9 d4 f8 ff ff       	jmp    801056df <alltraps>
...
80105e0d:	6a 44                	push   $0x44
  jmp alltraps
80105e0f:	e9 cb f8 ff ff       	jmp    801056df <alltraps>
...
80105e16:	6a 45                	push   $0x45
  jmp alltraps
80105e18:	e9 c2 f8 ff ff       	jmp    801056df <alltraps>
...
80105e1f:	6a 46                	push   $0x46
  jmp alltraps
80105e21:	e9 b9 f8 ff ff       	jmp    801056df <alltraps>
...
80105e28:	6a 47                	push   $0x47
  jmp alltraps
80105e2a:	e9 b0 f8 ff ff       	jmp    801056df <alltraps>
...
80105e31:	6a 48                	push   $0x48
  jmp alltraps
80105e33:	e9 a7 f8 ff ff       	jmp    801056df <alltraps>
...
80105e3a:	6a 49                	push   $0x49
  jmp alltraps
80105e3c:	e9 9e f8 ff ff       	jmp    801056df <alltraps>
...
80105e43:	6a 4a                	push   $0x4a
  jmp alltraps
80105e45:	e9 95 f8 ff ff       	jmp    801056df <alltraps>
...
80105e4c:	6a 4b                	push   $0x4b
  jmp alltraps
80105e4e:	e9 8c f8 ff ff       	jmp    801056df <alltraps>
...
80105e55:	6a 4c                	push   $0x4c
  jmp alltraps
80105e57:	e9 83 f8 ff ff       	jmp    801056df <alltraps>
...
80105e5e:	6a 4d                	push   $0x4d
  jmp alltraps
80105e60:	e9 7a f8 ff ff       	jmp    801056df <alltraps>
...
80105e67:	6a 4e                	push   $0x4e
  jmp alltraps
80105e69:	e9 71 f8 ff ff       	jmp    801056df <alltraps>
...
80105e70:	6a 4f                	push   $0x4f
  jmp alltraps
80105e72:	e9 68 f8 ff ff       	jmp    801056df <alltraps>
...
80105e79:	6a 50                	push   $0x50
  jmp alltraps
80105e7b:	e9 5f f8 ff ff       	jmp    801056df <alltraps>
...
80105e82:	6a 51                	push   $0x51
  jmp alltraps
80105e84:	e9 56 f8 ff ff       	jmp    801056df <alltraps>
...
80105e8b:	6a 52                	push   $0x52
  jmp alltraps
80105e8d:	e9 4d f8 ff ff       	jmp    801056df <alltraps>
...
80105e94:	6a 53                	push   $0x53
  jmp alltraps
80105e96:	e9 44 f8 ff ff       	jmp    801056df <alltraps>
...
80105e9d:	6a 54                	push   $0x54
  jmp alltraps
80105e9f:	e9 3b f8 ff ff       	jmp    801056df <alltraps>
...
80105ea6:	6a 55                	push   $0x55
  jmp alltraps
80105ea8:	e9 32 f8 ff ff       	jmp    801056df <alltraps>
...
80105eaf:	6a 56                	push   $0x56
  jmp alltraps
80105eb1:	e9 29 f8 ff ff       	jmp    801056df <alltraps>
...
80105eb8:	6a 57                	push   $0x57
  jmp alltraps
80105eba:	e9 20 f8 ff ff       	jmp    801056df <alltraps>
...
80105ec1:	6a 58                	push   $0x58
  jmp alltraps
80105ec3:	e9 17 f8 ff ff       	jmp    801056df <alltraps>
...
80105eca:	6a 59                	push   $0x59
  jmp alltraps
80105ecc:	e9 0e f8 ff ff       	jmp    801056df <alltraps>
...
80105ed3:	6a 5a                	push   $0x5a
  jmp alltraps
80105ed5:	e9 05 f8 ff ff       	jmp    801056df <alltraps>
...
80105edc:	6a 5b                	push   $0x5b
  jmp alltraps
80105ede:	e9 fc f7 ff ff       	jmp    801056df <alltraps>
...
80105ee5:	6a 5c                	push   $0x5c
  jmp alltraps
80105ee7:	e9 f3 f7 ff ff       	jmp    801056df <alltraps>
...
80105eee:	6a 5d                	push   $0x5d
  jmp alltraps
80105ef0:	e9 ea f7 ff ff       	jmp    801056df <alltraps>
...
80105ef7:	6a 5e                	push   $0x5e
  jmp alltraps
80105ef9:	e9 e1 f7 ff ff       	jmp    801056df <alltraps>
...
80105f00:	6a 5f                	push   $0x5f
  jmp alltraps
80105f02:	e9 d8 f7 ff ff       	jmp    801056df <alltraps>
...
80105f09:	6a 60                	push   $0x60
  jmp alltraps
80105f0b:	e9 cf f7 ff ff       	jmp    801056df <alltraps>
...
80105f12:	6a 61                	push   $0x61
  jmp alltraps
80105f14:	e9 c6 f7 ff ff       	jmp    801056df <alltraps>
...
80105f1b:	6a 62                	push   $0x62
  jmp alltraps
80105f1d:	e9 bd f7 ff ff       	jmp    801056df <alltraps>
...
80105f24:	6a 63                	push   $0x63
  jmp alltraps
80105f26:	e9 b4 f7 ff ff       	jmp    801056df <alltraps>
...
80105f2d:	6a 64                	push   $0x64
  jmp alltraps
80105f2f:	e9 ab f7 ff ff       	jmp    801056df <alltraps>
...
80105f36:	6a 65                	push   $0x65
  jmp alltraps
80105f38:	e9 a2 f7 ff ff       	jmp    801056df <alltraps>
...
80105f3f:	6a 66                	push   $0x66
  jmp alltraps
80105f41:	e9 99 f7 ff ff       	jmp    801056df <alltraps>
...
80105f48:	6a 67                	push   $0x67
  jmp alltraps
80105f4a:	e9 90 f7 ff ff       	jmp    801056df <alltraps>
...
80105f51:	6a 68                	push   $0x68
  jmp alltraps
80105f53:	e9 87 f7 ff ff       	jmp    801056df <alltraps>
...
80105f5a:	6a 69                	push   $0x69
  jmp alltraps
80105f5c:	e9 7e f7 ff ff       	jmp    801056df <alltraps>
...
80105f63:	6a 6a                	push   $0x6a
  jmp alltraps
80105f65:	e9 75 f7 ff ff       	jmp    801056df <alltraps>
...
80105f6c:	6a 6b                	push   $0x6b
  jmp alltraps
80105f6e:	e9 6c f7 ff ff       	jmp    801056df <alltraps>
...
80105f75:	6a 6c                	push   $0x6c
  jmp alltraps
80105f77:	e9 63 f7 ff ff       	jmp    801056df <alltraps>
...
80105f7e:	6a 6d                	push   $0x6d
  jmp alltraps
80105f80:	e9 5a f7 ff ff       	jmp    801056df <alltraps>
...
80105f87:	6a 6e                	push   $0x6e
  jmp alltraps
80105f89:	e9 51 f7 ff ff       	jmp    801056df <alltraps>
...
80105f90:	6a 6f                	push   $0x6f
  jmp alltraps
80105f92:	e9 48 f7 ff ff       	jmp    801056df <alltraps>
...
80105f99:	6a 70                	push   $0x70
  jmp alltraps
80105f9b:	e9 3f f7 ff ff       	jmp    801056df <alltraps>
...
80105fa2:	6a 71                	push   $0x71
  jmp alltraps
80105fa4:	e9 36 f7 ff ff       	jmp    801056df <alltraps>
...
80105fab:	6a 72                	push   $0x72
  jmp alltraps
80105fad:	e9 2d f7 ff ff       	jmp    801056df <alltraps>
...
80105fb4:	6a 73                	push   $0x73
  jmp alltraps
80105fb6:	e9 24 f7 ff ff       	jmp    801056df <alltraps>
...
80105fbd:	6a 74                	push   $0x74
  jmp alltraps
80105fbf:	e9 1b f7 ff ff       	jmp    801056df <alltraps>
...
80105fc6:	6a 75                	push   $0x75
  jmp alltraps
80105fc8:	e9 12 f7 ff ff       	jmp    801056df <alltraps>
...
80105fcf:	6a 76                	push   $0x76
  jmp alltraps
80105fd1:	e9 09 f7 ff ff       	jmp    801056df <alltraps>
...
80105fd8:	6a 77                	push   $0x77
  jmp alltraps
80105fda:	e9 00 f7 ff ff       	jmp    801056df <alltraps>
...
80105fe1:	6a 78                	push   $0x78
  jmp alltraps
80105fe3:	e9 f7 f6 ff ff       	jmp    801056df <alltraps>
...
80105fea:	6a 79                	push   $0x79
  jmp alltraps
80105fec:	e9 ee f6 ff ff       	jmp    801056df <alltraps>
...
80105ff3:	6a 7a                	push   $0x7a
  jmp alltraps
80105ff5:	e9 e5 f6 ff ff       	jmp    801056df <alltraps>
...
80105ffc:	6a 7b                	push   $0x7b
  jmp alltraps
80105ffe:	e9 dc f6 ff ff       	jmp    801056df <alltraps>
...
80106005:	6a 7c                	push   $0x7c
  jmp alltraps
80106007:	e9 d3 f6 ff ff       	jmp    801056df <alltraps>
...
8010600e:	6a 7d                	push   $0x7d
  jmp alltraps
80106010:	e9 ca f6 ff ff       	jmp    801056df <alltraps>
...
80106017:	6a 7e                	push   $0x7e
  jmp alltraps
80106019:	e9 c1 f6 ff ff       	jmp    801056df <alltraps>
...
80106020:	6a 7f                	push   $0x7f
  jmp alltraps
80106022:	e9 b8 f6 ff ff       	jmp    801056df <alltraps>
...
80106029:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010602e:	e9 ac f6 ff ff       	jmp    801056df <alltraps>
...
80106035:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010603a:	e9 a0 f6 ff ff       	jmp    801056df <alltraps>
...
80106041:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106046:	e9 94 f6 ff ff       	jmp    801056df <alltraps>
...
8010604d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106052:	e9 88 f6 ff ff       	jmp    801056df <alltraps>
...
80106059:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010605e:	e9 7c f6 ff ff       	jmp    801056df <alltraps>
...
80106065:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010606a:	e9 70 f6 ff ff       	jmp    801056df <alltraps>
...
80106071:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106076:	e9 64 f6 ff ff       	jmp    801056df <alltraps>
...
8010607d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106082:	e9 58 f6 ff ff       	jmp    801056df <alltraps>
...
80106089:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010608e:	e9 4c f6 ff ff       	jmp    801056df <alltraps>
...
80106095:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010609a:	e9 40 f6 ff ff       	jmp    801056df <alltraps>
...
801060a1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801060a6:	e9 34 f6 ff ff       	jmp    801056df <alltraps>
...
801060ad:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801060b2:	e9 28 f6 ff ff       	jmp    801056df <alltraps>
...
801060b9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801060be:	e9 1c f6 ff ff       	jmp    801056df <alltraps>
...
801060c5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801060ca:	e9 10 f6 ff ff       	jmp    801056df <alltraps>
...
801060d1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801060d6:	e9 04 f6 ff ff       	jmp    801056df <alltraps>
...
801060dd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801060e2:	e9 f8 f5 ff ff       	jmp    801056df <alltraps>
...
801060e9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801060ee:	e9 ec f5 ff ff       	jmp    801056df <alltraps>
...
801060f5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801060fa:	e9 e0 f5 ff ff       	jmp    801056df <alltraps>
...
80106101:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106106:	e9 d4 f5 ff ff       	jmp    801056df <alltraps>
...
8010610d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106112:	e9 c8 f5 ff ff       	jmp    801056df <alltraps>
...
80106119:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010611e:	e9 bc f5 ff ff       	jmp    801056df <alltraps>
...
80106125:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010612a:	e9 b0 f5 ff ff       	jmp    801056df <alltraps>
...
80106131:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106136:	e9 a4 f5 ff ff       	jmp    801056df <alltraps>
...
8010613d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106142:	e9 98 f5 ff ff       	jmp    801056df <alltraps>
...
80106149:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010614e:	e9 8c f5 ff ff       	jmp    801056df <alltraps>
...
80106155:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010615a:	e9 80 f5 ff ff       	jmp    801056df <alltraps>
...
80106161:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106166:	e9 74 f5 ff ff       	jmp    801056df <alltraps>
...
8010616d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106172:	e9 68 f5 ff ff       	jmp    801056df <alltraps>
...
80106179:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010617e:	e9 5c f5 ff ff       	jmp    801056df <alltraps>
...
80106185:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010618a:	e9 50 f5 ff ff       	jmp    801056df <alltraps>
...
80106191:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106196:	e9 44 f5 ff ff       	jmp    801056df <alltraps>
...
8010619d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801061a2:	e9 38 f5 ff ff       	jmp    801056df <alltraps>
...
801061a9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801061ae:	e9 2c f5 ff ff       	jmp    801056df <alltraps>
...
801061b5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801061ba:	e9 20 f5 ff ff       	jmp    801056df <alltraps>
...
801061c1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801061c6:	e9 14 f5 ff ff       	jmp    801056df <alltraps>
...
801061cd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801061d2:	e9 08 f5 ff ff       	jmp    801056df <alltraps>
...
801061d9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801061de:	e9 fc f4 ff ff       	jmp    801056df <alltraps>
...
801061e5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801061ea:	e9 f0 f4 ff ff       	jmp    801056df <alltraps>
...
801061f1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801061f6:	e9 e4 f4 ff ff       	jmp    801056df <alltraps>
...
801061fd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106202:	e9 d8 f4 ff ff       	jmp    801056df <alltraps>
...
80106209:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010620e:	e9 cc f4 ff ff       	jmp    801056df <alltraps>
...
80106215:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010621a:	e9 c0 f4 ff ff       	jmp    801056df <alltraps>
...
80106221:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106226:	e9 b4 f4 ff ff       	jmp    801056df <alltraps>
...
8010622d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106232:	e9 a8 f4 ff ff       	jmp    801056df <alltraps>
...
80106239:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010623e:	e9 9c f4 ff ff       	jmp    801056df <alltraps>
...
80106245:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010624a:	e9 90 f4 ff ff       	jmp    801056df <alltraps>
...
80106251:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106256:	e9 84 f4 ff ff       	jmp    801056df <alltraps>
...
8010625d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106262:	e9 78 f4 ff ff       	jmp    801056df <alltraps>
...
80106269:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010626e:	e9 6c f4 ff ff       	jmp    801056df <alltraps>
...
80106275:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010627a:	e9 60 f4 ff ff       	jmp    801056df <alltraps>
...
80106281:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106286:	e9 54 f4 ff ff       	jmp    801056df <alltraps>
...
8010628d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106292:	e9 48 f4 ff ff       	jmp    801056df <alltraps>
...
80106299:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010629e:	e9 3c f4 ff ff       	jmp    801056df <alltraps>
...
801062a5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801062aa:	e9 30 f4 ff ff       	jmp    801056df <alltraps>
...
801062b1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801062b6:	e9 24 f4 ff ff       	jmp    801056df <alltraps>
...
801062bd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801062c2:	e9 18 f4 ff ff       	jmp    801056df <alltraps>
...
801062c9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801062ce:	e9 0c f4 ff ff       	jmp    801056df <alltraps>
...
801062d5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801062da:	e9 00 f4 ff ff       	jmp    801056df <alltraps>
...
801062e1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801062e6:	e9 f4 f3 ff ff       	jmp    801056df <alltraps>
...
801062ed:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801062f2:	e9 e8 f3 ff ff       	jmp    801056df <alltraps>
...
801062f9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801062fe:	e9 dc f3 ff ff       	jmp    801056df <alltraps>
...
80106305:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010630a:	e9 d0 f3 ff ff       	jmp    801056df <alltraps>
...
80106311:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106316:	e9 c4 f3 ff ff       	jmp    801056df <alltraps>
...
8010631d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106322:	e9 b8 f3 ff ff       	jmp    801056df <alltraps>
...
80106329:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010632e:	e9 ac f3 ff ff       	jmp    801056df <alltraps>
...
80106335:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010633a:	e9 a0 f3 ff ff       	jmp    801056df <alltraps>
...
80106341:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106346:	e9 94 f3 ff ff       	jmp    801056df <alltraps>
...
8010634d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106352:	e9 88 f3 ff ff       	jmp    801056df <alltraps>
...
80106359:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010635e:	e9 7c f3 ff ff       	jmp    801056df <alltraps>
...
80106365:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010636a:	e9 70 f3 ff ff       	jmp    801056df <alltraps>
...
80106371:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106376:	e9 64 f3 ff ff       	jmp    801056df <alltraps>
...
8010637d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106382:	e9 58 f3 ff ff       	jmp    801056df <alltraps>
...
80106389:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010638e:	e9 4c f3 ff ff       	jmp    801056df <alltraps>
...
80106395:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010639a:	e9 40 f3 ff ff       	jmp    801056df <alltraps>
...
801063a1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801063a6:	e9 34 f3 ff ff       	jmp    801056df <alltraps>
...
801063ad:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801063b2:	e9 28 f3 ff ff       	jmp    801056df <alltraps>
...
801063b9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801063be:	e9 1c f3 ff ff       	jmp    801056df <alltraps>
...
801063c5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801063ca:	e9 10 f3 ff ff       	jmp    801056df <alltraps>
...
801063d1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801063d6:	e9 04 f3 ff ff       	jmp    801056df <alltraps>
...
801063dd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801063e2:	e9 f8 f2 ff ff       	jmp    801056df <alltraps>
...
801063e9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801063ee:	e9 ec f2 ff ff       	jmp    801056df <alltraps>
...
801063f5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801063fa:	e9 e0 f2 ff ff       	jmp    801056df <alltraps>
...
80106401:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106406:	e9 d4 f2 ff ff       	jmp    801056df <alltraps>
...
8010640d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106412:	e9 c8 f2 ff ff       	jmp    801056df <alltraps>
...
80106419:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010641e:	e9 bc f2 ff ff       	jmp    801056df <alltraps>
...
80106425:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010642a:	e9 b0 f2 ff ff       	jmp    801056df <alltraps>
...
80106431:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106436:	e9 a4 f2 ff ff       	jmp    801056df <alltraps>
...
8010643d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106442:	e9 98 f2 ff ff       	jmp    801056df <alltraps>
...
80106449:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010644e:	e9 8c f2 ff ff       	jmp    801056df <alltraps>
...
80106455:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010645a:	e9 80 f2 ff ff       	jmp    801056df <alltraps>
...
80106461:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106466:	e9 74 f2 ff ff       	jmp    801056df <alltraps>
...
8010646d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106472:	e9 68 f2 ff ff       	jmp    801056df <alltraps>
...
80106479:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010647e:	e9 5c f2 ff ff       	jmp    801056df <alltraps>
...
80106485:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010648a:	e9 50 f2 ff ff       	jmp    801056df <alltraps>
...
80106491:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106496:	e9 44 f2 ff ff       	jmp    801056df <alltraps>
...
8010649d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801064a2:	e9 38 f2 ff ff       	jmp    801056df <alltraps>
...
801064a9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801064ae:	e9 2c f2 ff ff       	jmp    801056df <alltraps>
...
801064b5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801064ba:	e9 20 f2 ff ff       	jmp    801056df <alltraps>
...
801064c1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801064c6:	e9 14 f2 ff ff       	jmp    801056df <alltraps>
...
801064cd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801064d2:	e9 08 f2 ff ff       	jmp    801056df <alltraps>
...
801064d9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801064de:	e9 fc f1 ff ff       	jmp    801056df <alltraps>
...
801064e5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801064ea:	e9 f0 f1 ff ff       	jmp    801056df <alltraps>
...
801064f1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801064f6:	e9 e4 f1 ff ff       	jmp    801056df <alltraps>
...
801064fd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106502:	e9 d8 f1 ff ff       	jmp    801056df <alltraps>
...
80106509:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010650e:	e9 cc f1 ff ff       	jmp    801056df <alltraps>
...
80106515:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010651a:	e9 c0 f1 ff ff       	jmp    801056df <alltraps>
...
80106521:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106526:	e9 b4 f1 ff ff       	jmp    801056df <alltraps>
...
8010652d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106532:	e9 a8 f1 ff ff       	jmp    801056df <alltraps>
...
80106539:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010653e:	e9 9c f1 ff ff       	jmp    801056df <alltraps>
...
80106545:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010654a:	e9 90 f1 ff ff       	jmp    801056df <alltraps>
...
80106551:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106556:	e9 84 f1 ff ff       	jmp    801056df <alltraps>
...
8010655d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106562:	e9 78 f1 ff ff       	jmp    801056df <alltraps>
...
80106569:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010656e:	e9 6c f1 ff ff       	jmp    801056df <alltraps>
...
80106575:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010657a:	e9 60 f1 ff ff       	jmp    801056df <alltraps>
...
80106581:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106586:	e9 54 f1 ff ff       	jmp    801056df <alltraps>
...
8010658d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106592:	e9 48 f1 ff ff       	jmp    801056df <alltraps>
...
80106599:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010659e:	e9 3c f1 ff ff       	jmp    801056df <alltraps>
...
801065a5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801065aa:	e9 30 f1 ff ff       	jmp    801056df <alltraps>
...
801065b1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801065b6:	e9 24 f1 ff ff       	jmp    801056df <alltraps>
...
801065bd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801065c2:	e9 18 f1 ff ff       	jmp    801056df <alltraps>
...
801065c9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801065ce:	e9 0c f1 ff ff       	jmp    801056df <alltraps>
...
801065d5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801065da:	e9 00 f1 ff ff       	jmp    801056df <alltraps>
...
801065e1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801065e6:	e9 f4 f0 ff ff       	jmp    801056df <alltraps>
...
801065ed:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801065f2:	e9 e8 f0 ff ff       	jmp    801056df <alltraps>
...
801065f9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801065fe:	e9 dc f0 ff ff       	jmp    801056df <alltraps>
...
80106605:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010660a:	e9 d0 f0 ff ff       	jmp    801056df <alltraps>
...
80106611:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106616:	e9 c4 f0 ff ff       	jmp    801056df <alltraps>
...
8010661d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106622:	e9 b8 f0 ff ff       	jmp    801056df <alltraps>
...
80106674:	e8 07 be ff ff       	call   80102480 <kalloc>
...
8010668a:	e8 41 de ff ff       	call   801044d0 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010672d:	68 14 7b 10 80       	push   $0x80107b14
...
8010674c:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
// Deallocate user pages to bring the process size from oldsz to
// newsz.  oldsz and newsz need not be page-aligned, nor does newsz
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
...
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
8010675a:	89 4d dc             	mov    %ecx,-0x24(%ebp)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
8010675d:	0f 83 99 00 00 00    	jae    801067fc <deallocuvm.part.0+0xbc>
80106763:	89 d7                	mov    %edx,%edi
80106765:	eb 6f                	jmp    801067d6 <deallocuvm.part.0+0x96>
...
80106770:	8b 30                	mov    (%eax),%esi
80106772:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106778:	74 52                	je     801067cc <deallocuvm.part.0+0x8c>
      pa = PTE_ADDR(*pte);
      if(pa == 0) {
8010677a:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80106780:	0f 84 a8 00 00 00    	je     8010682e <deallocuvm.part.0+0xee>
        panic("kfree");
      }

      acquire(&lock_share);
80106786:	83 ec 0c             	sub    $0xc,%esp
80106789:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010678c:	68 e0 34 12 80       	push   $0x801234e0
80106791:	e8 3a dc ff ff       	call   801043d0 <acquire>
      // check if this page was shared
      if (page_share_counter[pa/PGSIZE] == 1) {
80106796:	89 f1                	mov    %esi,%ecx
80106798:	83 c4 10             	add    $0x10,%esp
8010679b:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010679e:	c1 e9 0c             	shr    $0xc,%ecx
801067a1:	0f b6 91 c0 54 11 80 	movzbl -0x7feeab40(%ecx),%edx
801067a8:	80 fa 01             	cmp    $0x1,%dl
801067ab:	74 63                	je     80106810 <deallocuvm.part.0+0xd0>
        // only 1 parent is using
        page_share_counter[pa/PGSIZE] -= 1;
        char *virtual = P2V(pa);
        kfree(virtual);
      } else {
        page_share_counter[pa/PGSIZE] -= 1;
801067ad:	83 ea 01             	sub    $0x1,%edx
801067b0:	88 91 c0 54 11 80    	mov    %dl,-0x7feeab40(%ecx)
      }
...
801067b6:	83 ec 0c             	sub    $0xc,%esp
      ...
      *pte = 0;
801067b9:	c7 00 00 00 00 00    	movl   $0x0,(%eax)

      // release before return
      release(&lock_share);
801067bf:	68 e0 34 12 80       	push   $0x801234e0
801067c4:	e8 b7 dc ff ff       	call   80104480 <release>
...
801067d2:	39 fb                	cmp    %edi,%ebx
801067d4:	73 26                	jae    801067fc <deallocuvm.part.0+0xbc>
    pte = walkpgdir(pgdir, (char*)a, 0);
801067d6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801067d9:	31 c9                	xor    %ecx,%ecx
801067db:	89 da                	mov    %ebx,%edx
801067dd:	e8 4e fe ff ff       	call   80106630 <walkpgdir>
    if(!pte)
801067e2:	85 c0                	test   %eax,%eax
801067e4:	75 8a                	jne    80106770 <deallocuvm.part.0+0x30>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801067e6:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
801067ec:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
801067f2:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801067f8:	39 fb                	cmp    %edi,%ebx
801067fa:	72 da                	jb     801067d6 <deallocuvm.part.0+0x96>
      release(&lock_share);
    }
  }
...
801067fc:	8b 45 dc             	mov    -0x24(%ebp),%eax
...
80106813:	81 c6 00 00 00 80    	add    $0x80000000,%esi
      ...
      if (page_share_counter[pa/PGSIZE] == 1) {
        // only 1 parent is using
        page_share_counter[pa/PGSIZE] -= 1;
80106819:	c6 81 c0 54 11 80 00 	movb   $0x0,-0x7feeab40(%ecx)
        char *virtual = P2V(pa);
        kfree(virtual);
80106820:	56                   	push   %esi
80106821:	e8 aa ba ff ff       	call   801022d0 <kfree>
80106826:	83 c4 10             	add    $0x10,%esp
80106829:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010682c:	eb 88                	jmp    801067b6 <deallocuvm.part.0+0x76>
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
      pa = PTE_ADDR(*pte);
...
80106831:	68 46 74 10 80       	push   $0x80107446
80106836:	e8 35 9b ff ff       	call   80100370 <panic>
8010683b:	90                   	nop
...
80106940:	a1 c0 34 12 80       	mov    0x801234c0,%eax
...
80106984:	0f 84 c4 00 00 00    	je     80106a4e <switchuvm+0xee>
  ...
  pushcli();
8010698a:	e8 61 d9 ff ff       	call   801042f0 <pushcli>
...
80106a3b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106a3c:	e9 ef d8 ff ff       	jmp    80104330 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106a44:	68 1a 7b 10 80       	push   $0x80107b1a
...
80106a51:	68 45 7b 10 80       	push   $0x80107b45
...
80106a5e:	68 30 7b 10 80       	push   $0x80107b30
...
80106a7c:	8b 7d 10             	mov    0x10(%ebp),%edi
80106a7f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a82:	8b 45 0c             	mov    0xc(%ebp),%eax
  char *mem;

  if(sz >= PGSIZE)
80106a85:	81 ff ff 0f 00 00    	cmp    $0xfff,%edi
...
inituvm(pde_t *pgdir, char *init, uint sz)
{
80106a8b:	89 45 e0             	mov    %eax,-0x20(%ebp)
  char *mem;

  if(sz >= PGSIZE)
80106a8e:	77 6a                	ja     80106afa <inituvm+0x8a>
    panic("inituvm: more than a page");
  mem = kalloc();
80106a90:	e8 eb b9 ff ff       	call   80102480 <kalloc>
  memset(mem, 0, PGSIZE);
80106a95:	83 ec 04             	sub    $0x4,%esp
{
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
  mem = kalloc();
80106a98:	89 c6                	mov    %eax,%esi
  memset(mem, 0, PGSIZE);
80106a9a:	68 00 10 00 00       	push   $0x1000
80106a9f:	6a 00                	push   $0x0
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106aa1:	8d 9e 00 00 00 80    	lea    -0x80000000(%esi),%ebx
  char *mem;
...
80106aa8:	e8 23 da ff ff       	call   801044d0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106aad:	58                   	pop    %eax
80106aae:	5a                   	pop    %edx
80106aaf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106ab2:	6a 06                	push   $0x6
80106ab4:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106ab9:	53                   	push   %ebx
80106aba:	31 d2                	xor    %edx,%edx
  memmove(mem, init, sz);
  // add a child proc
  acquire(&lock_share);
  page_share_counter[V2P(mem)/PGSIZE] += 1;
80106abc:	c1 eb 0c             	shr    $0xc,%ebx
  ...
  memset(mem, 0, PGSIZE);
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106abf:	e8 ec fb ff ff       	call   801066b0 <mappages>
  memmove(mem, init, sz);
80106ac4:	83 c4 0c             	add    $0xc,%esp
80106ac7:	57                   	push   %edi
80106ac8:	ff 75 e0             	pushl  -0x20(%ebp)
80106acb:	56                   	push   %esi
80106acc:	e8 af da ff ff       	call   80104580 <memmove>
  // add a child proc
  acquire(&lock_share);
80106ad1:	c7 04 24 e0 34 12 80 	movl   $0x801234e0,(%esp)
80106ad8:	e8 f3 d8 ff ff       	call   801043d0 <acquire>
  page_share_counter[V2P(mem)/PGSIZE] += 1;
80106add:	80 83 c0 54 11 80 01 	addb   $0x1,-0x7feeab40(%ebx)
  release(&lock_share);
80106ae4:	c7 45 08 e0 34 12 80 	movl   $0x801234e0,0x8(%ebp)
...
80106af4:	5d                   	pop    %ebp
  ...
  page_share_counter[V2P(mem)/PGSIZE] += 1;
  release(&lock_share);
80106af5:	e9 86 d9 ff ff       	jmp    80104480 <release>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106afd:	68 59 7b 10 80       	push   $0x80107b59
...
80106b53:	e8 d8 fa ff ff       	call   80106630 <walkpgdir>
...
80106b81:	e8 ba ad ff ff       	call   80101940 <readi>
...
80106bad:	68 73 7b 10 80       	push   $0x80107b73
...
80106bba:	68 74 7c 10 80       	push   $0x80107c74
...
80106bd6:	83 ec 0c             	sub    $0xc,%esp
  ...
  if(newsz >= KERNBASE)
80106bd9:	8b 4d 10             	mov    0x10(%ebp),%ecx
80106bdc:	85 c9                	test   %ecx,%ecx
80106bde:	0f 88 fd 00 00 00    	js     80106ce1 <allocuvm+0x111>
    return 0;
  if(newsz < oldsz)
80106be4:	8b 45 0c             	mov    0xc(%ebp),%eax
80106be7:	39 45 10             	cmp    %eax,0x10(%ebp)
80106bea:	0f 82 b4 00 00 00    	jb     80106ca4 <allocuvm+0xd4>
    return oldsz;

  a = PGROUNDUP(oldsz);
80106bf0:	8b 45 0c             	mov    0xc(%ebp),%eax
80106bf3:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106bf9:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106bff:	39 75 10             	cmp    %esi,0x10(%ebp)
80106c02:	77 6e                	ja     80106c72 <allocuvm+0xa2>
80106c04:	e9 e7 00 00 00       	jmp    80106cf0 <allocuvm+0x120>
...
80106c13:	8d 9f 00 00 00 80    	lea    -0x80000000(%edi),%ebx
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
      deallocuvm(pgdir, newsz, oldsz);
      return 0;
...
80106c20:	50                   	push   %eax
80106c21:	e8 aa d8 ff ff       	call   801044d0 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106c26:	58                   	pop    %eax
80106c27:	5a                   	pop    %edx
80106c28:	8b 45 08             	mov    0x8(%ebp),%eax
80106c2b:	6a 06                	push   $0x6
80106c2d:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106c32:	53                   	push   %ebx
80106c33:	89 f2                	mov    %esi,%edx
80106c35:	e8 76 fa ff ff       	call   801066b0 <mappages>
80106c3a:	83 c4 10             	add    $0x10,%esp
80106c3d:	85 c0                	test   %eax,%eax
80106c3f:	78 6f                	js     80106cb0 <allocuvm+0xe0>
      deallocuvm(pgdir, newsz, oldsz);
      kfree(mem);
      return 0;
    }
...
80106c44:	c1 eb 0c             	shr    $0xc,%ebx
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80106c47:	81 c6 00 10 00 00    	add    $0x1000,%esi
      deallocuvm(pgdir, newsz, oldsz);
      kfree(mem);
      return 0;
    }
    // Add 1 for parent
    acquire(&lock_share);
80106c4d:	68 e0 34 12 80       	push   $0x801234e0
80106c52:	e8 79 d7 ff ff       	call   801043d0 <acquire>
    page_share_counter[V2P(mem)/PGSIZE] += 1;
80106c57:	80 83 c0 54 11 80 01 	addb   $0x1,-0x7feeab40(%ebx)
    release(&lock_share);
80106c5e:	c7 04 24 e0 34 12 80 	movl   $0x801234e0,(%esp)
80106c65:	e8 16 d8 ff ff       	call   80104480 <release>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80106c6d:	39 75 10             	cmp    %esi,0x10(%ebp)
80106c70:	76 7e                	jbe    80106cf0 <allocuvm+0x120>
    mem = kalloc();
80106c72:	e8 09 b8 ff ff       	call   80102480 <kalloc>
    if(mem == 0){
80106c77:	85 c0                	test   %eax,%eax
  ...
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
80106c79:	89 c7                	mov    %eax,%edi
    if(mem == 0){
80106c7b:	75 93                	jne    80106c10 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80106c7d:	83 ec 0c             	sub    $0xc,%esp
80106c80:	68 91 7b 10 80       	push   $0x80107b91
80106c85:	e8 d6 99 ff ff       	call   80100660 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
...
80106c90:	39 45 10             	cmp    %eax,0x10(%ebp)
80106c93:	76 4c                	jbe    80106ce1 <allocuvm+0x111>
80106c95:	89 c1                	mov    %eax,%ecx
80106c97:	8b 55 10             	mov    0x10(%ebp),%edx
80106c9a:	8b 45 08             	mov    0x8(%ebp),%eax
80106c9d:	e8 9e fa ff ff       	call   80106740 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106ca4:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106ca7:	5b                   	pop    %ebx
80106ca8:	5e                   	pop    %esi
80106ca9:	5f                   	pop    %edi
80106caa:	5d                   	pop    %ebp
...
80106cb3:	68 a9 7b 10 80       	push   $0x80107ba9
...
80106cc6:	76 0d                	jbe    80106cd5 <allocuvm+0x105>
80106cc8:	89 c1                	mov    %eax,%ecx
80106cca:	8b 55 10             	mov    0x10(%ebp),%edx
80106ccd:	8b 45 08             	mov    0x8(%ebp),%eax
80106cd0:	e8 6b fa ff ff       	call   80106740 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106cd9:	e8 f2 b5 ff ff       	call   801022d0 <kfree>
      return 0;
...
80106ce1:	8d 65 f4             	lea    -0xc(%ebp),%esp
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
      deallocuvm(pgdir, newsz, oldsz);
...
80106d10:	5d                   	pop    %ebp
80106d11:	e9 2a fa ff ff       	jmp    80106740 <deallocuvm.part.0>
...
80106d49:	e8 f2 f9 ff ff       	call   80106740 <deallocuvm.part.0>
...
80106d9c:	68 c5 7b 10 80       	push   $0x80107bc5
...
80106dd0:	e8 fb d6 ff ff       	call   801044d0 <memset>
...
80106e33:	83 ec 10             	sub    $0x10,%esp
  // initialize share page counter and shared lock on it
  initlock(&lock_share, "page_share_counter");
80106e36:	68 d6 7b 10 80       	push   $0x80107bd6
80106e3b:	68 e0 34 12 80       	push   $0x801234e0
80106e40:	e8 2b d4 ff ff       	call   80104270 <initlock>
80106e45:	83 c4 10             	add    $0x10,%esp
  for(int i = 0; i < PHYSTOP/PGSIZE; i++) {
80106e48:	31 c0                	xor    %eax,%eax
80106e4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    page_share_counter[i] = 0;
80106e50:	c6 80 c0 54 11 80 00 	movb   $0x0,-0x7feeab40(%eax)
void
kvmalloc(void)
{
  // initialize share page counter and shared lock on it
  initlock(&lock_share, "page_share_counter");
  for(int i = 0; i < PHYSTOP/PGSIZE; i++) {
80106e57:	83 c0 01             	add    $0x1,%eax
80106e5a:	3d 00 e0 00 00       	cmp    $0xe000,%eax
80106e5f:	75 ef                	jne    80106e50 <kvmalloc+0x20>
    page_share_counter[i] = 0;
  }

  kpgdir = setupkvm();
80106e61:	e8 4a ff ff ff       	call   80106db0 <setupkvm>
80106e66:	a3 c0 34 12 80       	mov    %eax,0x801234c0
...
80106e73:	c9                   	leave  
80106e74:	c3                   	ret    
80106e75:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
80106e9f:	68 e9 7b 10 80       	push   $0x80107be9
...
80106eb6:	83 ec 0c             	sub    $0xc,%esp
  ...
  if((d = setupkvm()) == 0)
80106eb9:	e8 f2 fe ff ff       	call   80106db0 <setupkvm>
80106ebe:	85 c0                	test   %eax,%eax
80106ec0:	0f 84 cf 00 00 00    	je     80106f95 <cow+0xe5>
80106ec6:	89 c7                	mov    %eax,%edi
    return 0;

  for(i = 0; i < sz; i += PGSIZE){
80106ec8:	8b 45 0c             	mov    0xc(%ebp),%eax
80106ecb:	31 f6                	xor    %esi,%esi
80106ecd:	85 c0                	test   %eax,%eax
80106ecf:	75 40                	jne    80106f11 <cow+0x61>
80106ed1:	e9 aa 00 00 00       	jmp    80106f80 <cow+0xd0>
80106ed6:	8d 76 00             	lea    0x0(%esi),%esi
80106ed9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    flags = PTE_FLAGS(*pte);
    // mapp the child process to the parent page table
    if(mappages(d,(void*)i,PGSIZE,pa,flags)<0)
      goto bad;
    //increment the counter of this page table
    acquire(&lock_share);
80106ee0:	83 ec 0c             	sub    $0xc,%esp
    page_share_counter[pa/PGSIZE] += 1;
80106ee3:	c1 eb 0c             	shr    $0xc,%ebx
  // char *mem;
  ...
  for(i = 0; i < sz; i += PGSIZE){
80106ee6:	81 c6 00 10 00 00    	add    $0x1000,%esi
    flags = PTE_FLAGS(*pte);
    // mapp the child process to the parent page table
    if(mappages(d,(void*)i,PGSIZE,pa,flags)<0)
      goto bad;
    //increment the counter of this page table
    acquire(&lock_share);
80106eec:	68 e0 34 12 80       	push   $0x801234e0
80106ef1:	e8 da d4 ff ff       	call   801043d0 <acquire>
    page_share_counter[pa/PGSIZE] += 1;
80106ef6:	80 83 c0 54 11 80 01 	addb   $0x1,-0x7feeab40(%ebx)
    release(&lock_share);
80106efd:	c7 04 24 e0 34 12 80 	movl   $0x801234e0,(%esp)
80106f04:	e8 77 d5 ff ff       	call   80104480 <release>
  // char *mem;
...
80106f0c:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106f0f:	76 6f                	jbe    80106f80 <cow+0xd0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106f11:	8b 45 08             	mov    0x8(%ebp),%eax
80106f14:	31 c9                	xor    %ecx,%ecx
80106f16:	89 f2                	mov    %esi,%edx
80106f18:	e8 13 f7 ff ff       	call   80106630 <walkpgdir>
80106f1d:	85 c0                	test   %eax,%eax
80106f1f:	0f 84 81 00 00 00    	je     80106fa6 <cow+0xf6>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106f25:	8b 10                	mov    (%eax),%edx
80106f27:	f6 c2 01             	test   $0x1,%dl
80106f2a:	74 6d                	je     80106f99 <cow+0xe9>
      panic("copyuvm: page not present");

    //*pte = (~ PTE_W) & *pte;
    pa = PTE_ADDR(*pte);
80106f2c:	89 d3                	mov    %edx,%ebx
    // set shareable
    if (*pte & PTE_W){
      *pte |= PTE_SH;
80106f2e:	89 d1                	mov    %edx,%ecx
80106f30:	80 cd 01             	or     $0x1,%ch
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    ...
    //*pte = (~ PTE_W) & *pte;
    pa = PTE_ADDR(*pte);
80106f33:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    // set shareable
    if (*pte & PTE_W){
      *pte |= PTE_SH;
80106f39:	f6 c2 02             	test   $0x2,%dl
80106f3c:	0f 45 d1             	cmovne %ecx,%edx
    }
    // set not writtable
    *pte &= ~PTE_W;
    flags = PTE_FLAGS(*pte);
...
80106f3f:	83 ec 08             	sub    $0x8,%esp
    ...
    // set not writtable
    *pte &= ~PTE_W;
80106f42:	89 d1                	mov    %edx,%ecx
    flags = PTE_FLAGS(*pte);
    // mapp the child process to the parent page table
    if(mappages(d,(void*)i,PGSIZE,pa,flags)<0)
80106f44:	81 e2 fd 0f 00 00    	and    $0xffd,%edx
    // set shareable
    if (*pte & PTE_W){
      *pte |= PTE_SH;
    }
    // set not writtable
    *pte &= ~PTE_W;
80106f4a:	83 e1 fd             	and    $0xfffffffd,%ecx
80106f4d:	89 08                	mov    %ecx,(%eax)
    flags = PTE_FLAGS(*pte);
    // mapp the child process to the parent page table
    if(mappages(d,(void*)i,PGSIZE,pa,flags)<0)
80106f4f:	52                   	push   %edx
80106f50:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106f55:	53                   	push   %ebx
80106f56:	89 f2                	mov    %esi,%edx
80106f58:	89 f8                	mov    %edi,%eax
80106f5a:	e8 51 f7 ff ff       	call   801066b0 <mappages>
80106f5f:	83 c4 10             	add    $0x10,%esp
80106f62:	85 c0                	test   %eax,%eax
80106f64:	0f 89 76 ff ff ff    	jns    80106ee0 <cow+0x30>
...
80106f6d:	57                   	push   %edi
80106f6e:	e8 bd fd ff ff       	call   80106d30 <freevm>
  return 0;
80106f73:	83 c4 10             	add    $0x10,%esp
80106f76:	31 c0                	xor    %eax,%eax
}
...
80106f94:	c3                   	ret    
  ...
  if((d = setupkvm()) == 0)
    return 0;
80106f95:	31 c0                	xor    %eax,%eax
80106f97:	eb df                	jmp    80106f78 <cow+0xc8>
...
80106f9c:	68 0d 7c 10 80       	push   $0x80107c0d
...
80106fa9:	68 f3 7b 10 80       	push   $0x80107bf3
80106fae:	e8 bd 93 ff ff       	call   80100370 <panic>
...
80106fce:	e8 5d f6 ff ff       	call   80106630 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
8010703f:	e8 3c d5 ff ff       	call   80104580 <memmove>
    len -= n;
    buf += n;
...
801070a9:	e8 c2 c6 ff ff       	call   80103770 <myproc>
...
rcr2(void)
{
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
801070ae:	0f 20 d2             	mov    %cr2,%edx
  // get address with rcr2()
  addr = rcr2();
  //  Check if the address found by rcr2() method is not 0.
  if (addr  == 0) {
801070b1:	85 d2                	test   %edx,%edx
801070b3:	0f 84 fe 00 00 00    	je     801071b7 <pagefault+0x117>
801070b9:	89 c3                	mov    %eax,%ebx
    panic("PageFault, addr == 0");
  }
  // Find page table entry (PTE)
  pte_t *pte = walkpgdir(proc->pgdir, (void* )addr, 0);
801070bb:	8b 40 04             	mov    0x4(%eax),%eax
801070be:	31 c9                	xor    %ecx,%ecx
801070c0:	e8 6b f5 ff ff       	call   80106630 <walkpgdir>
  if (pte == 0) {
801070c5:	85 c0                	test   %eax,%eax
  ...
  // Find page table entry (PTE)
  pte_t *pte = walkpgdir(proc->pgdir, (void* )addr, 0);
801070c7:	89 c6                	mov    %eax,%esi
  if (pte == 0) {
801070c9:	0f 84 db 00 00 00    	je     801071aa <pagefault+0x10a>
    panic("PageFault, no entry exists");
  }
  if (!(*pte & PTE_P)) {
801070cf:	8b 00                	mov    (%eax),%eax
801070d1:	a8 01                	test   $0x1,%al
801070d3:	0f 84 c4 00 00 00    	je     8010719d <pagefault+0xfd>
    // not presented
    panic("PageFault, Page not present");
  } else {
    // find pa
    pa = PTE_ADDR(*pte);
801070d9:	89 c7                	mov    %eax,%edi
801070db:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi

    if(page_share_counter[pa/PGSIZE] <= 1){
801070e1:	89 fa                	mov    %edi,%edx
801070e3:	c1 ea 0c             	shr    $0xc,%edx
801070e6:	80 ba c0 54 11 80 01 	cmpb   $0x1,-0x7feeab40(%edx)
801070ed:	0f 8e 8d 00 00 00    	jle    80107180 <pagefault+0xe0>
        return;
      }else{
        panic("PageFault, 0 process is pointing to this page");
     }
    }else{
        acquire(&lock_share);
801070f3:	83 ec 0c             	sub    $0xc,%esp
801070f6:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801070f9:	68 e0 34 12 80       	push   $0x801234e0
801070fe:	e8 cd d2 ff ff       	call   801043d0 <acquire>
        // copy to a new page
        if((mem_addr = kalloc()) == 0){
80107103:	e8 78 b3 ff ff       	call   80102480 <kalloc>
80107108:	83 c4 10             	add    $0x10,%esp
8010710b:	85 c0                	test   %eax,%eax
8010710d:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107110:	0f 84 ae 00 00 00    	je     801071c4 <pagefault+0x124>
          panic("Page fault, out of memory for new page"); 
        }

        // start creating a new page

        memmove(mem_addr, (char*)P2V(pa),PGSIZE);
80107116:	83 ec 04             	sub    $0x4,%esp
80107119:	81 c7 00 00 00 80    	add    $0x80000000,%edi
8010711f:	89 55 e0             	mov    %edx,-0x20(%ebp)
80107122:	68 00 10 00 00       	push   $0x1000
80107127:	57                   	push   %edi
80107128:	50                   	push   %eax
80107129:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010712c:	e8 4f d4 ff ff       	call   80104580 <memmove>
        // set a new physical address
        uint pa_new = V2P(mem_addr);
80107131:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
        // set new page counter to 1
        page_share_counter[pa_new/PGSIZE] = 1;
        // -1 on the old page counter
        page_share_counter[pa/PGSIZE] -= 1;
80107134:	8b 55 e0             	mov    -0x20(%ebp),%edx
        ...
        // set a new physical address
        uint pa_new = V2P(mem_addr);
80107137:	81 c1 00 00 00 80    	add    $0x80000000,%ecx
        // set new page counter to 1
        page_share_counter[pa_new/PGSIZE] = 1;
8010713d:	89 c8                	mov    %ecx,%eax
        // -1 on the old page counter
        page_share_counter[pa/PGSIZE] -= 1;
        // set the pte for this new page 
        *pte = pa_new | PTE_P |PTE_W | PTE_U | PTE_SH;
8010713f:	81 c9 07 01 00 00    	or     $0x107,%ecx
        ...
        // set new page counter to 1
        page_share_counter[pa_new/PGSIZE] = 1;
80107145:	c1 e8 0c             	shr    $0xc,%eax
80107148:	c6 80 c0 54 11 80 01 	movb   $0x1,-0x7feeab40(%eax)
        // -1 on the old page counter
        page_share_counter[pa/PGSIZE] -= 1;
8010714f:	80 aa c0 54 11 80 01 	subb   $0x1,-0x7feeab40(%edx)
        // set the pte for this new page 
        *pte = pa_new | PTE_P |PTE_W | PTE_U | PTE_SH;
80107156:	89 0e                	mov    %ecx,(%esi)
        release(&lock_share);
80107158:	c7 04 24 e0 34 12 80 	movl   $0x801234e0,(%esp)
8010715f:	e8 1c d3 ff ff       	call   80104480 <release>
}
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
80107164:	8b 43 04             	mov    0x4(%ebx),%eax
80107167:	05 00 00 00 80       	add    $0x80000000,%eax
8010716c:	0f 22 d8             	mov    %eax,%cr3
...
8010717a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(page_share_counter[pa/PGSIZE] <= 1){
      // Make sure only 1 process is pointing to this place
      if(page_share_counter[pa/PGSIZE] == 1){
80107180:	75 4f                	jne    801071d1 <pagefault+0x131>
        // set writtable & set not shareable
        *pte |= PTE_W;
        *pte &= ~PTE_SH;
80107182:	80 e4 fe             	and    $0xfe,%ah
80107185:	83 c8 02             	or     $0x2,%eax
80107188:	89 06                	mov    %eax,(%esi)
8010718a:	8b 43 04             	mov    0x4(%ebx),%eax
8010718d:	05 00 00 00 80       	add    $0x80000000,%eax
80107192:	0f 22 d8             	mov    %eax,%cr3
        release(&lock_share);
        lcr3(V2P(proc->pgdir));
    }
  }
...
801071a0:	68 57 7c 10 80       	push   $0x80107c57
801071a5:	e8 c6 91 ff ff       	call   80100370 <panic>
    panic("PageFault, addr == 0");
  }
  // Find page table entry (PTE)
  pte_t *pte = walkpgdir(proc->pgdir, (void* )addr, 0);
...
801071ad:	68 3c 7c 10 80       	push   $0x80107c3c
801071b2:	e8 b9 91 ff ff       	call   80100370 <panic>
  struct proc *proc = myproc();
  // get address with rcr2()
  addr = rcr2();
  //  Check if the address found by rcr2() method is not 0.
...
801071ba:	68 27 7c 10 80       	push   $0x80107c27
801071bf:	e8 ac 91 ff ff       	call   80100370 <panic>
     }
    }else{
        acquire(&lock_share);
        // copy to a new page
...
801071c7:	68 c8 7c 10 80       	push   $0x80107cc8
801071cc:	e8 9f 91 ff ff       	call   80100370 <panic>
        *pte |= PTE_W;
        *pte &= ~PTE_SH;
        lcr3(V2P(proc->pgdir));
        return;
...
801071d4:	68 98 7c 10 80       	push   $0x80107c98
801071d9:	e8 92 91 ff ff       	call   80100370 <panic>
